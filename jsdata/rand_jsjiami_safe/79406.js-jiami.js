      ...
      if (snail < dogfish)
      {
        while (-- dogfish)
        {
          ...
          if (snail === dogfish)
          {
            ...
            if (snail && dunlin['replace'](new RegExp("[OWyNXSRgzSyXdDWHBF=]", "g"), '') === snail)
            {
  ...
  hamster = function (antelope, goose) {
    var baboon; // _0x1b0b2c
    var bat; // _0x246d0d
    var bison; // _0x21eaaf
    
      antelope = ~ ~ '0x'.concat(antelope);
    baboon = raccoon[antelope];
    if (hamster['pbRbHE'] === undefined)
    {
      (function () {
        var tarsier; // _0x512b3a
        var cat; // _0x1046ba
        ...
        tarsier['atob'] || (tarsier['atob'] = function (weasel) {
          var beaver; // _0x42754a
          var komodo_dragon; // _0x54a4f2
          var armadillo; // _0x434bb3
          var woodpecker; // _0x1fc40e
          var quelea; // _0x323804
          var butterfly; // _0x3ba0dd
      ...
      bat = function (oyster, stingray) {
        var dragonfly; // _0x1befc0
        var finch; // _0x1824bc
        var meerkat; // _0x180d9a
        var alligator; // _0x4fd537
        var kookabura; // _0x16162f
        var human; // _0x912651
        var reindeer; // _0x52aadb
        var elk; // _0x1775e8
        var ape; // _0x377bf0
    ...
    bison = hamster['JRupCc'][antelope];
    if (bison === undefined)
    {
      if (hamster['BtAfAb'] === undefined)
      {
        hamster['BtAfAb'] = ! ! [];
      }
      baboon = hamster['iykNzQ'](baboon, goose);
      hamster['JRupCc'][antelope] = baboon;
    }
    else
    {
      baboon = bison;
  ...
  'use strict';
  Object[hamster('0', '1KcT')](exports, hamster('1', 'O^uV'), {
    "value" : ! ! []
  });
  chinchilla = hamster('2', 'AHOs');
  ibex = hamster('3', 'O^uV');
  boar = [hamster('4', 'O^uV'), ];
  llama = hamster('5', '8$^s');
  exports['definition'] = {
