const _0x3ad6 = ['POST', 'Error sending lead to RD Station ->', 'get', 'qtqLk', 'getLivechatRoomGuestInfo', 'visitor', 'email', 'address', 'data', 'nome', 'name', 'username', 'telefone', 'tags', 'keys', 'customFields', 'forEach', 'call', 'mOIDY', 'https://www.rdstation.com.br/api/1.3/conversions', 'error', 'VlIbp', 'livechat.closeRoom', 'MEDIUM', 'livechat-rd-station-close-room', 'add', 'priority', 'livechat-rd-station-save-info', '4LaenxA', '236908vXBdTT', '605111RtrrFx', '2063SrGZny', '427tiraej', '150314uGkQvZ', '1iwKlFt', '593107JeLxae', '602278dFfBno', '681813BTDnlj', '2CrrRVq', 'Livechat_RDStation_Token', 'rocketchat-livechat'];
...
(function (_0x108f1b, _0x15127d) {
    ...
    while (true) {
        try {
            ...
            if (_0x128675 === _0x15127d) break;else _0x108f1b.push(_0x108f1b.shift());
        } catch (_0x226e9a) {
...
function _0x411f(_0x3f2470, _0x271bdf) {
    return _0x411f = function (_0x523314, _0x1c206a) {
        _0x523314 = _0x523314 - 296;
        const _0x1e32cc = _0x3ad6[_0x523314];
...
function sendToRDStation(_0x359872) {
    ...
    if (!settings[_0x2ab8ec(0x137)](_0x5808d9[_0x2ab8ec(0x138)])) return _0x359872;

    const _0x3f8b88 = Livechat[_0x2ab8ec(0x139)](_0x359872);

    if (!_0x3f8b88[_0x2ab8ec(0x13a)][_0x2ab8ec(0x13b)]) return _0x359872;

    const _0x534bf0 = Array.isArray(_0x3f8b88[_0x2ab8ec(0x13a)][_0x2ab8ec(0x13b)]) ? _0x3f8b88[_0x2ab8ec(0x13a)][_0x2ab8ec(0x13b)][0][_0x2ab8ec(0x13c)] : _0x3f8b88[_0x2ab8ec(0x13a)][_0x2ab8ec(0x13b)];
