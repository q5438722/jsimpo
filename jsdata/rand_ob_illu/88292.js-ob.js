const _0x5b3d = ['toJSONValue', 'addType', 'TEaAr', 'name', 'dob', 'address', 'Person', 'fromJSONValue', 'content', 'STkmd', '800933SbvZlA', '1043895YSUMZO', '214523jIEsCb', '1932775TTSiRA', '1rXYVRE', '1561540DDgagI', '715352cwEUlj', '7256869MmMwJq', '1BPMKnS', 'city', 'state', 'typeName', 'Address', 'YSjob'];
...
(function (_0x3c00a6, _0xc29313) {
    ...
    while (true) {
        try {
            ...
            if (_0x2192ab === _0xc29313) break;else _0x3c00a6.push(_0x3c00a6.shift());
        } catch (_0x1192f7) {
...
class Address {
    ...
    [_0x5159b4(0x103)]() {
        const _0x3a360c = _0x5159b4;
        const _0x379d7f = { 'YSjob': _0x3a360c(0x104) };
...
class Person {
    ...
    ['typeName']() {
        const _0x2e63c6 = _0x5159b4;
        const _0x34bc75 = { 'TEaAr': 'Person' };
...
class Holder {
    ...
    ['typeName']() {
        const _0x1df78d = _0x5159b4;
        const _0x3279fa = { 'STkmd': 'Holder' };
...
function _0x1065(_0x14456c, _0x1165a5) {
    return _0x1065 = function (_0x4a8a49, _0x327349) {
        _0x4a8a49 = _0x4a8a49 - 248;
        const _0x5d19ab = _0x5b3d[_0x4a8a49];
