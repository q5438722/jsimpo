const _0x3ef4 = ['313IgNljS', '2SoEYYi', '178243BgigFG', '142261KfQTub', '369196TQlJls', '1vWVVHw', '1083773kCzEKn', 'moZZp', 'filter', 'error', 'value', 'parse', 'length', 'find', 'valueChanged', 'prompts', 'visible', '$emit', 'stringify', 'call', '$apollo', 'options', 'variables', 'function', 'readQuery', 'writeQuery', '193480UjZpEz', '173136CBShsU', '730EsaSBU'];

function _0x1805(_0x520f5e, _0x50bad5) {
    return _0x1805 = function (_0x18e46e, _0x3b565b) {
        _0x18e46e = _0x18e46e - 465;
        const _0x51ac63 = _0x3ef4[_0x18e46e];
...
(function (_0x3e6b99, _0x3c100b) {
    ...
    while (true) {
        try {
            ...
            if (_0x39badb === _0x3c100b) break;else _0x3e6b99.push(_0x3e6b99.shift());
        } catch (_0x1f0fa7) {
    ...
    return {
        'computed': {
            'configurationValid'() {
                ...
                return UDspOk[_0xb39340(0x1db)](this.visiblePrompts[_0xb39340(0x1dc)](p => p[_0xb39340(0x1dd)] || p[_0xb39340(0x1de)] === null || JSON[_0xb39340(0x1df)](p.value) === '')[_0xb39340(0x1e0)], 0);
            },
            'hasPromptsChanged'() {
            ...
            async 'answerPrompt'({
                ...
                await this.$apollo.mutate({
                    ...
                    'update': (store, {
                        ...
                        var vars = variables || this[_0x2fab9f(0x1e8)].queries[field][_0x2fab9f(0x1e9)][_0x2fab9f(0x1ea)] || undefined;
