...
const _0x5c95 = ['-table', 'notice', 'Creating Kinesis stream "', '"...', 'fhRDV', 'then', 'uLXsC', 'ClzCS', 'ZCvEZ', 'jICks', 'rGejb', 'Hello from Kinesis!', 'streamKinesis', 'VpzBx', 'gGLCQ', '/aws/lambda/', 'reduce', 'includes', 'sTOac', 'aonwA', 'include', 'DynamoDB Streams', 'XuQsb', 'INSERT', 'rjGyY', 'should invoke on dynamodb messages from the latest position', 'streamDynamoDb', 'toString', 'slice', 'Weglz', 'qqeKK', 'urXTH', '2aHztkx', '28867VSdZJU', '48508mQRfMU', '43427tsBtHE', '1DSkkmS', '131233maqomf', '76271vVCqMY', '2WUaMFX', '1nSrkKb', '32348vSIXLt', '4ykwHFC', '24581GlsEnq', 'chai', 'get', 'serverless:test', '../../fixtures/programmatic', '../../utils/dynamodb', '../../utils/integration', 'AWS - Stream Integration Test', 'Deleting Kinesis stream', 'should invoke on kinesis messages from the trim horizon', 'message', 'Hello from the Kinesis horizon!', 'dev', 'Kinesis Streams', 'timeout', 'PqPOr', 'lTKGq', 'NGdTw', 'setup', 'stream', 'serviceConfig', 'service', '-kinesis'];
...
(function (_0x16247f, _0x555bc1) {
    ...
    while (true) {
        try {
            ...
            if (_0x137dd9 === _0x555bc1) break;else _0x16247f.push(_0x16247f.shift());
        } catch (_0x32e65c) {
...
var { expect } = require(_0x5d8139(0x81));

const log = require('log')[_0x5d8139(0x82)](_0x5d8139(0x83));

const fixtures = require(_0x5d8139(0x84));

var { createKinesisStream, deleteKinesisStream, putKinesisRecord } = require('../../utils/kinesis');

var { putDynamoDbItem } = require(_0x5d8139(0x85));

var { confirmCloudWatchLogs } = require('../../utils/misc');

var { deployService, removeService } = require(_0x5d8139(0x86));

function _0x18ad(_0x8d459b, _0x2c1c0e) {
    return _0x18ad = function (_0x353c08, _0x2d7bd5) {
        _0x353c08 = _0x353c08 - 117;
        const _0x546cc4 = _0x5c95[_0x353c08];

        return _0x546cc4;
    }, _0x18ad(_0x8d459b, _0x2c1c0e);
}
describe(_0x5d8139(0x87), function () {
    const _0x10a27a = _0x5d8139;
    const _0x97afe8 = {
    ...
    this[_0x10a27a(0x8e)](_0x97afe8[_0x10a27a(0x8f)](_0x97afe8.PqPOr(1000, 60), 100));
    ...
    const _0x3e0ac6 = _0x97afe8.CXrjc;

    const _0x392efc = _0x97afe8[_0x10a27a(0x90)];

    _0x97afe8[_0x10a27a(0x91)](before, async () => {
        const _0xaf757a = _0x10a27a;

        const _0x8e0d9c = await fixtures[_0xaf757a(0x92)](_0xaf757a(0x93));
        ...
        it(_0x97afe8.KkhBT, () => {
            const _0x4763de = _0x37d5dd;

            const _0x2b46f1 = _0x4763de(0xa3);

            const _0x1b2834 = _0x3ff925[_0x4763de(0xa4)];
            ...
            return _0x3ff925[_0x4763de(0xa5)](confirmCloudWatchLogs, _0x4763de(0xa6) + _0x141e02 + '-' + _0x2b46f1, () => putKinesisRecord(_0x4e9309, _0x1b2834), { 'checkIsComplete': _0x3968e9 => _0x3968e9[_0x4763de(0xa7)]((_0x5d117c, _0x2de686) => _0x5d117c + _0x2de686[_0x4763de(0x8a)], '')[_0x4763de(0xa8)](_0x1b2834) })[_0x4763de(0x9c)](_0x5f3ce5 => {
                const _0x404497 = _0x4763de;

                const _0xb25dc9 = _0x5f3ce5[_0x404497(0xa7)]((_0x4db33b, _0x47840f) => _0x4db33b + _0x47840f[_0x404497(0x8a)], '');
        ...
        _0x97afe8[_0xbdd695(0xaf)](it, _0xbdd695(0xb0), () => {
            const _0xa2cc42 = _0xbdd695;

            const _0x563926 = _0xa2cc42(0xb1);

            const _0x52fa6b = { 'id': _0x97afe8.UOCgP };

            return confirmCloudWatchLogs('/aws/lambda/' + _0x141e02 + '-' + _0x563926, () => {
                const _0x15269e = _0xa2cc42;

                return _0x52fa6b['hello'] = 'from dynamo!' + Math.random()[_0x15269e(0xb2)](36)[_0x15269e(0xb3)](2), _0x185aee[_0x15269e(0xb4)](putDynamoDbItem, _0x2d3093, _0x52fa6b);
                ...
                const _0x4144be = _0xa2cc42;

                const _0x28f5c8 = _0x267ff1[_0x4144be(0xa7)]((_0x571619, _0x143590) => _0x571619 + _0x143590.message, '');
