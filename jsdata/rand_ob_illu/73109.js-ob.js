const _0x1f20 = ['173951YYSDme', '6usRQTj', '1249997RzVgTK', '1108321gzhfWF', 'express', 'Router', '../req-limiter', 'find', 'exports', '14456CMIXjd', '71NKGsoX', '5xowUDj', '79812ieMkGF', '927197WeYgeU', '1IIYSqx', '1177319sCMCrE'];
...
(function (_0x5b1ce3, _0x5509af) {
    ...
    while (true) {
        try {
            ...
            if (_0x2adebd === _0x5509af) break;else _0x5b1ce3.push(_0x5b1ce3.shift());
        } catch (_0x2cc111) {
...
const router = require(_0x46ff13(0xf2))[_0x46ff13(0xf3)]();

var { INFO } = require('../models');

var { reqLimiter } = require(_0x46ff13(0xf4));

function _0xcfce(_0xf31ee0, _0x301301) {
    return _0xcfce = function (_0x300b2f, _0x426884) {
        _0x300b2f = _0x300b2f - 231;
        const _0x382cda = _0x1f20[_0x300b2f];
