const _0x384f = ['IOeAJ', 'GOsKl', 'error', 'Hriyx', 'GET_DATA_ERROR', 'notification', '194237SqjfcP', '528427pXCeec', '10ANAPdG', '15794REpsAB', '52203ifLxXr', '1THiHAy', '566557QhGNtj', '1soAiBo', '1EDWSTp', '721516RxXWKp', '460hqNDVA', '2716cXtGWr', 'GET_DATA_SUCCEEDED', 'providers', 'GET', 'notification.error', 'PpHXp'];
...
(function (_0x512b40, _0x5dc455) {
    ...
    while (true) {
        try {
            ...
            if (_0x4d26a6 === _0x5dc455) break;else _0x512b40.push(_0x512b40.shift());
        } catch (_0x281234) {
...
const useAuthProviders = ({ ssoEnabled: _0x2557c7 }) => {
    ...
    var [_0x106146, _0x5af079] = _0x3e626f[_0xd1bec2(0x131)](useReducer, _0x35da16, initialState);
    ...
    const _0x7b4f8 = async () => {
        ...
        try {
            ...
            const _0x1850fd = getRequestUrl(_0x3e626f[_0xca207f(0x133)]);

            const _0x483b82 = await _0x3e626f[_0xca207f(0x131)](request, _0x1850fd, { 'method': _0x3e626f.dEPjI });
...
function _0x333c(_0x31ef09, _0x4a292e) {
    return _0x333c = function (_0x3665a9, _0x4a7ab9) {
        _0x3665a9 = _0x3665a9 - 289;
        const _0x28d938 = _0x384f[_0x3665a9];
