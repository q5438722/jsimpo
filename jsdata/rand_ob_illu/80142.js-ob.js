const _0x3ed4 = ['23KhuPlp', '13463NRBlBn', '__DC_STAT_UUID', 'rnnvE', 'CssJv', 'now', 'floor', 'random', 'setStorage', 'deviceId', 'safeArea', 'safeAreaInsets', 'left', 'windowWidth', 'right', 'FhPJK', 'windowHeight', 'bottom', 'devtools', 'ios', 'hIJbk', 'FvUsr', 'indexOf', 'platform', 'RNmza', 'mHFaf', '1MyWhFi', '302581JGfdRn', '217903NoUAgL', '1etIGnW', '1749626EpiKJr', '4CTDDkI', '220445fotQeQ', '1461562neMwat', '667462BPgjrs'];
...
(function (_0x1a0ec4, _0x44974d) {
    ...
    while (true) {
        try {
            ...
            if (_0xf96d18 === _0x44974d) break;else _0x1a0ec4.push(_0x1a0ec4.shift());
        } catch (_0x33fce0) {
...
function _0x1b9f(_0x47bbea, _0x554b25) {
    return _0x1b9f = function (_0x193827, _0x3427c0) {
        _0x193827 = _0x193827 - 264;
        const _0xd0d27b = _0x3ed4[_0x193827];
...
function addUuid(_0x59e5a5) {
    ...
    deviceId = deviceId || _0x94b995[_0x52d754(0x114)](getStorageSync, UUID_KEY), !deviceId && (deviceId = _0x94b995[_0x52d754(0x115)](Date[_0x52d754(0x116)](), '') + Math[_0x52d754(0x117)](Math[_0x52d754(0x118)]() * 10000000), __GLOBAL__[_0x52d754(0x119)]({
        'key': UUID_KEY,
        'data': deviceId
    })), _0x59e5a5[_0x52d754(0x11a)] = deviceId;
}
function addSafeAreaInsets(_0x333cba) {
    const _0x2c2ff6 = _0x47bcef;
    const _0x379394 = {
...
function normalizePlatform(_0x11b7aa) {
    ...
    var _0x439cf5 = _0x11b7aa.platform ? _0x11b7aa.platform.toLowerCase() : _0x41b7cd[_0x44f77f(0x125)];

    !~[_0x41b7cd.aEnIg, _0x41b7cd[_0x44f77f(0x126)]][_0x44f77f(0x127)](_0x439cf5) && (_0x439cf5 = _0x41b7cd.hIJbk), _0x11b7aa[_0x44f77f(0x128)] = _0x439cf5;
}
export default {
    'returnValue': function (_0x3772e1) {
        const _0x433c66 = _0x47bcef;
        const _0x40f7db = {
