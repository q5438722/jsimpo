const _0x49ae = ['9094DHYJrS', '20YVQBDl', '50593nYBaLh', '253585OvjBGP', '235737ODJZmO', '5714QJEbNo', '17iOrhwH', '3719sKpaZm', '73xfTaOa', 'group', 'note', 'heading', 'link', 'form', 'list', 'listitem', 'columnheader', 'cell', 'pdfPage', 'render', '_walk', '_setAttributes', 'aria-label', 'aria-owns', 'alt', 'SxsYK', 'cBzSE', 'Skiri', 'aria-level', 'createElement', 'MBrYZ', 'role', 'match', 'EsXJi', 'setAttribute', 'children', 'JOimg', 'ZaWvU', 'appendChild', 'createStructTreeLayerBuilder', '1086EhoZkS', '291BeOSaB'];
...
(function (_0x15d704, _0xf78b24) {
    ...
    while (true) {
        try {
            ...
            if (_0x500aef === _0xf78b24) break;else _0x15d704.push(_0x15d704.shift());
        } catch (_0x134fe4) {
...
function _0xc564(_0x4c673a, _0x1f3204) {
    return _0xc564 = function (_0x1f77b7, _0x3f48cb) {
        _0x1f77b7 = _0x1f77b7 - 112;
        const _0x4d7431 = _0x49ae[_0x1f77b7];
...
class StructTreeLayerBuilder {
    ...
    [_0x452f47(0x86)](_0x395a6c) {
        ...
        if (!_0x395a6c) return null;

        const _0x5920f7 = document[_0x5c265a(0x8f)](_0x3fe856.ksdqz);

        if (_0x3fe856[_0x5c265a(0x90)](_0x5c265a(0x91), _0x395a6c)) {
            var { role: _0x3f9fae } = _0x395a6c;

            const _0x2325b4 = _0x3f9fae[_0x5c265a(0x92)](HEADING_PATTERN);

            if (_0x2325b4) _0x5920f7.setAttribute(_0x3fe856.TYAjw, _0x3fe856.xPwBL), _0x5920f7.setAttribute(_0x3fe856[_0x5c265a(0x93)], _0x2325b4[1]);else PDF_ROLE_TO_HTML_ROLE[_0x3f9fae] && _0x5920f7[_0x5c265a(0x94)]('role', PDF_ROLE_TO_HTML_ROLE[_0x3f9fae]);
        }
        this[_0x5c265a(0x87)](_0x395a6c, _0x5920f7);
        if (_0x395a6c[_0x5c265a(0x95)]) {
            if (_0x3fe856[_0x5c265a(0x96)](_0x395a6c[_0x5c265a(0x95)].length, 1) && _0x3fe856[_0x5c265a(0x97)]('id', _0x395a6c[_0x5c265a(0x95)][0])) this[_0x5c265a(0x87)](_0x395a6c[_0x5c265a(0x95)][0], _0x5920f7);else for (const _0xd667be of _0x395a6c[_0x5c265a(0x95)]) {
