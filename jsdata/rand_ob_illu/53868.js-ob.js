...
(function (_0x22b01e, _0x3d286e) {
    ...
    while (true) {
        try {
            ...
            if (_0x7b9d36 === _0x3d286e) break;else _0x22b01e.push(_0x22b01e.shift());
        } catch (_0x4045a4) {
...
const assert = require(_0x55b203(0x1dc));

const http = require('http');

function _0x1398(_0x14851d, _0xe00bd4) {
    return _0x1398 = function (_0x3a9b9f, _0x9f7628) {
        _0x3a9b9f = _0x3a9b9f - 466;
        const _0x58f3e0 = _0x5d4e[_0x3a9b9f];
...
server[_0x55b203(0x1e2)](0, function () {
    const _0x4d1ee8 = _0x55b203;
    const _0x45628c = {
...
const agent = http[_0x55b203(0x1e4)]({ 'keepAlive': true });
...
function makeRequest(_0x39fe92) {
    ...
    if (_0x38ee97[_0x571a34(0x1e7)](_0x39fe92, 0)) {
    ...
    _0x1bec56.end(), _0x1bec56.on(_0x38ee97[_0x571a34(0x1eb)], function (_0x47193d) {
        ...
        _0x8a47a7[_0x4dc8c8(0x1ef)](_0x38ee97.uHheD), _0x8a47a7.on(_0x38ee97[_0x4dc8c8(0x1f0)], function (_0x1aec12) {
            ...
            assert[_0x59b38d(0x1de)](_0x2e0802, '/' + _0x39fe92), _0x38ee97[_0x59b38d(0x1f2)](setTimeout, function () {
                ...
                actualRequests++, _0x2515c8.vDpmf(makeRequest, _0x2515c8[_0x23ef2b(0x1f3)](_0x39fe92, 1));
            }, 1);
        });
    });
}
