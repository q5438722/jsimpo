...
function _0x196f(_0x37459d, _0x2a0ba3) {
    return _0x196f = function (_0x1564be, _0x3b09ba) {
        _0x1564be = _0x1564be - 194;
        const _0x1490d4 = _0x2b40[_0x1564be];
...
(function (_0x39a8d8, _0x280c23) {
    ...
    while (true) {
        try {
            ...
            if (_0x32ad7b === _0x280c23) break;else _0x39a8d8.push(_0x39a8d8.shift());
        } catch (_0x3ae5e0) {
...
var { pipe, set, pick, eq, omit, remove, get, uniq, isArray, map, curry, merge } = require(_0x5ee281(0xcc));

const permissionFields = ['id', _0x5ee281(0xcd), _0x5ee281(0xce), 'properties', _0x5ee281(0xcf), 'role'];
const sanitizedPermissionFields = ['id', 'action', _0x5ee281(0xce), _0x5ee281(0xd0), _0x5ee281(0xcf)];
...
const addCondition = curry((_0x1810af, _0x4d506f) => {
    const _0x4bb54e = _0x5ee281;
    const _0x1cfe5b = { 'XXTMv': 'conditions' };
    var { conditions: _0x28e0a9 } = _0x4d506f;

    const _0x52feda = Array[_0x4bb54e(0xd1)](_0x28e0a9) ? uniq(_0x28e0a9.concat(_0x1810af)) : [_0x1810af];

    return set(_0x1cfe5b.XXTMv, _0x52feda, _0x4d506f);
});
const removeCondition = curry((_0x1aa16f, _0x30c65a) => {
    const _0x5c22dc = _0x5ee281;
    const _0x44a9b0 = {
...
const getProperty = curry((_0x5b648b, _0x3bd27a) => get(_0x5ee281(0xd3) + _0x5b648b, _0x3bd27a));

const setProperty = (_0x1038f2, _0x3ec129, _0x3a387c) => {
    const _0x4d19b0 = _0x5ee281;
    const _0x65eef9 = {
...
const deleteProperty = (_0x185e42, _0x236c26) => omit(_0x5ee281(0xd3) + _0x185e42, _0x236c26);

const create = _0x31ada8 => {
    const _0x153262 = _0x5ee281;
    const _0x3d6ccb = {
...
const sanitizeConditions = curry((_0x29e279, _0x3e7262) => {
    const _0x3578b3 = _0x5ee281;

    if (!isArray(_0x3e7262[_0x3578b3(0xcf)])) return _0x3e7262;
...
const toPermission = _0x51c098 => isArray(_0x51c098) ? map(create, _0x51c098) : create(_0x51c098);
