...
const _0x1f3a = ['www.nodejs.org', 'connect', 'mustCall', 'unable to get local issuer certificate', 'message', 'dDssp', 'secureContext', 'createSecureContext', 'addCACert', 'end', '148225Gqlimn', '1mlDSji', '509452lYJvoK', '368312qihrcy', '151ZhKiBu', '1018prmkTE', '14849LtiLdT', '21wfILlg', '1GWwmgu', '405241nLXFpD', '492969YadKLv', '1mnvryf', 'skip', 'missing crypto', '../common/fixtures', 'keys', 'path', '.pem', 'readFileSync', 'srocj', 'ca1-cert'];
...
(function (_0x566b9e, _0x2454ad) {
    ...
    while (true) {
        try {
            ...
            if (_0x4e79dd === _0x2454ad) break;else _0x566b9e.push(_0x566b9e.shift());
        } catch (_0x2cef7f) {
...
const caCert = loadPEM(_0x4d611b(0x207));
const opts = {
...
tls[_0x4d611b(0x209)](opts, common[_0x4d611b(0x20a)](end)), opts['ca'] = caCert, tls[_0x4d611b(0x209)](opts, fail).on('error', common[_0x4d611b(0x20a)](_0x21815c => {
    const _0x33b65e = _0x4d611b;
    const _0x81a69d = { 'dsqgF': _0x33b65e(0x20b) };

    assert.strictEqual(_0x21815c[_0x33b65e(0x20c)], _0x81a69d.dsqgF);
}));
function fail() {
    const _0x3dad30 = _0x4d611b;
    const _0x77b372 = { 'dDssp': 'should fail to connect' };
