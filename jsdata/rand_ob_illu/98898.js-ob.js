...
const _0x5683 = ['YVHxy', 'ReagL', 'IiofS', 'route.request.header.Auth', 'MremV', 'arn:aws:auth', 'bdfGo', 'XCMlR', 'CUOOh', 'TcwwP', 'YteqM', 'Array', 'with', 'length', '#validate() using runServerless util', 'authName', 'function', 'qEstB', 'SOtIB', 'ROHNr', 'SplLU', 'sskMl', 'Resources', 'PakZX', 'getWebsocketsAuthorizerLogicalId', 'exist', 'RCPbC', 'Properties', '399371bQbpLi', '223359krnfpv', '25641LpKYxj', '751519UoJaqF', '295820tufWLS', '674895QIbmpI', '1810667RggdPj', '../../../../../../../../../../lib/plugins/aws/package/compile/events/websockets/index', '../../../../../../../../../../lib/Serverless', '../../../../../../../../../../lib/plugins/aws/provider', '../../../../../../../../../utils/run-serverless', '#validate()', 'aws', 'first', '$connect', 'auth', 'AWS::Partition', 'AWS::Region', 'AuthLambdaFunction', 'arn:', '/invocations', 'route.request.querystring.Auth', 'Arn', '$default', 'should add authorizer config when authorizer is specified as a string with arn', 'should add authorizer config when authorizer is specified as an object', 'should add routeResponse when routeResponseSelectionExpression is configured', 'should ignore non-websocket events', 'wVnQa', 'gxZmU', 'EfoYF', 'MMkKn', 'should support the simplified string syntax', 'serverless', 'validate', 'MzmJB', 'events', 'deep', 'equal', 'BKkMB', 'XiMOo', 'should support the extended object syntax', 'service', 'functions', 'wmEiS', 'gyizm', 'OBFSd', 'LrvBn', 'MXkDl', 'cEogJ', 'wnnQY', 'DIwGG', 'SHrQM', 'fEbbn', 'tXPBc', 'pqoaj', 'JfQWR', 'Ydgxj', 'zaNOD'];

function _0x2a97(_0x5f21cd, _0x5593b4) {
    return _0x2a97 = function (_0x3f53bd, _0xf633db) {
        _0x3f53bd = _0x3f53bd - 275;
        const _0x44c043 = _0x5683[_0x3f53bd];
...
(function (_0xb4afde, _0x56c83d) {
    ...
    while (true) {
        try {
            ...
            if (_0x141bc3 === _0x56c83d) break;else _0xb4afde.push(_0xb4afde.shift());
        } catch (_0x5a6073) {
...
const AwsCompileWebsocketsEvents = require(_0x51d245(0x11a));

const Serverless = require(_0x51d245(0x11b));

const AwsProvider = require(_0x51d245(0x11c));

const runServerless = require(_0x51d245(0x11d));

describe(_0x51d245(0x11e), () => {
    const _0x359391 = _0x51d245;
    const _0x3db5e1 = {
        'gxZmU': 'dev',
        'EfoYF': 'us-east-1',
    ...
    _0x3db5e1[_0x359391(0x12f)](beforeEach, () => {
        ...
        _0x3db5e1.wmEiS(expect, _0x3de08d[_0x4f8a6a(0x137)]).to[_0x4f8a6a(0x138)].equal([{
            ...
            'authorizer': {
                ...
                'uri': {
                    'Fn::Join': ['', [_0x4f8a6a(0x126), { 'Ref': _0x3db5e1[_0x4f8a6a(0x143)] }, _0x3db5e1[_0x4f8a6a(0x144)], { 'Ref': _0x3db5e1[_0x4f8a6a(0x145)] }, _0x3db5e1[_0x4f8a6a(0x146)], {
                        'Fn::GetAtt': [_0x3db5e1[_0x4f8a6a(0x147)], _0x4f8a6a(0x129)]
                    }, _0x4f8a6a(0x127)]]
                },
        ...
        _0x3db5e1[_0x5c7b22(0x14b)](expect, _0x11265d[_0x5c7b22(0x137)]).to[_0x5c7b22(0x138)][_0x5c7b22(0x139)]([{
            ...
            'authorizer': {
                ...
                'uri': {
                    'Fn::Join': ['', [_0x3db5e1[_0x5c7b22(0x14c)], { 'Ref': _0x3db5e1.MXkDl }, _0x3db5e1.cEogJ, { 'Ref': _0x3db5e1[_0x5c7b22(0x145)] }, _0x3db5e1[_0x5c7b22(0x146)], _0x3db5e1[_0x5c7b22(0x14d)], _0x3db5e1.bdfGo]]
                },
                ...
                'events': [{
                    'websocket': {
                        ...
                        'authorizer': {
                            ...
                            'identitySource': [_0x3db5e1[_0x5e86ae(0x148)], _0x3db5e1.MremV]
                        }
                    }
                }]
            }
        ...
        _0x3db5e1.HFVFt(expect, _0x39efff[_0x5e86ae(0x137)]).to[_0x5e86ae(0x138)][_0x5e86ae(0x139)]([{
            ...
            'authorizer': {
                ...
                'uri': {
                    'Fn::Join': ['', [_0x3db5e1[_0x5e86ae(0x14c)], { 'Ref': _0x5e86ae(0x123) }, _0x3db5e1[_0x5e86ae(0x144)], { 'Ref': _0x3db5e1[_0x5e86ae(0x145)] }, _0x3db5e1[_0x5e86ae(0x146)], {
                        'Fn::GetAtt': [_0x3db5e1.SHrQM, _0x3db5e1[_0x5e86ae(0x150)]]
                    }, _0x3db5e1.bdfGo]]
                },
                'identitySource': [_0x5e86ae(0x151), _0x3db5e1[_0x5e86ae(0x152)]],
            ...
            'first': {
                'events': [{
                    'websocket': {
                        ...
                        'authorizer': {
                            'arn': _0x3db5e1.zaNOD,
                            'identitySource': [_0x3db5e1.fEbbn, _0x529910(0x128)]
                        }
                    }
                }]
            }
        ...
        _0x3db5e1.HFVFt(expect, _0x3e58c8[_0x529910(0x137)]).to[_0x529910(0x138)].equal([{
            ...
            'authorizer': {
                ...
                'uri': {
                    'Fn::Join': ['', [_0x529910(0x126), { 'Ref': _0x3db5e1[_0x529910(0x143)] }, _0x3db5e1.cEogJ, { 'Ref': _0x3db5e1[_0x529910(0x145)] }, _0x3db5e1[_0x529910(0x146)], _0x529910(0x153), _0x3db5e1[_0x529910(0x154)]]]
                },
                'identitySource': [_0x3db5e1.fEbbn, _0x3db5e1[_0x529910(0x152)]],
                'permission': _0x3db5e1.zaNOD
            }
        }]);
        ...
        expect(_0x1b38d6[_0x260418(0x137)]).to.be.an(_0x260418(0x159))[_0x260418(0x15a)][_0x260418(0x15b)](0);
    });
}), describe(_0x51d245(0x15c), () => {
    const _0x37b0ba = _0x51d245;
    const _0x3595e6 = {
    ...
    _0x3595e6[_0x37b0ba(0x15f)](it, _0x3595e6.HMIcp, async () => {
        const _0x1ca9d0 = _0x37b0ba;

        const _0x2df432 = _0x3595e6[_0x1ca9d0(0x160)];
                        ...
                        'events': [{
                            'websocket': {
                                ...
                                'authorizer': {
                                    'name': _0x2df432,
                                    'arn': {
                                        'Fn::Join': [':', [_0x3595e6.VWEfL, 'arnName']]
                                    }
                                }
                            }
                        }]
        ...
        const _0x23c13f = _0x45c94f[_0x1ca9d0(0x164)];

        const _0x514e88 = _0x3cc315;
