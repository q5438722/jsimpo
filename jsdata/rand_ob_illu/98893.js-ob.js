...
(function (_0x2a2ad9, _0x1b3662) {
    ...
    while (true) {
        try {
            ...
            if (_0x5a78e4 === _0x1b3662) break;else _0x2a2ad9.push(_0x2a2ad9.shift());
        } catch (_0x31d3d7) {
...
const expect = require('chai')[_0x348e89(0x1de)];

const AwsCompileWebsocketsEvents = require(_0x348e89(0x1df));

const Serverless = require('../../../../../../../../../../lib/Serverless');

const AwsProvider = require(_0x348e89(0x1e0));

describe(_0x348e89(0x1e1), () => {
    const _0x193750 = _0x348e89;
    const _0x187ef2 = {
    ...
    _0x187ef2.DevgC(beforeEach, () => {
        const _0x31e9eb = _0x193750;

        const _0x5c4164 = new Serverless();
        ...
        _0x187ef2[_0x3d130f(0x1fd)](expect, _0x17abe3).to[_0x3d130f(0x1fe)][_0x3d130f(0x1ff)]({
            'FirstWebsocketsIntegration': {
                ...
                'Properties': {
                    ...
                    'IntegrationUri': {
                        'Fn::Join': ['', [_0x3d130f(0x201), { 'Ref': _0x187ef2[_0x3d130f(0x202)] }, _0x3d130f(0x1e9), { 'Ref': _0x187ef2[_0x3d130f(0x203)] }, _0x3d130f(0x1ea), {
                            'Fn::GetAtt': [_0x3d130f(0x204), _0x3d130f(0x1eb)]
                        }, _0x187ef2.tfgZi]]
                    }
                }
            },
            'SecondWebsocketsIntegration': {
                ...
                'Properties': {
                    ...
                    'IntegrationUri': {
                        'Fn::Join': ['', ['arn:', { 'Ref': _0x187ef2.ChZnD }, _0x187ef2[_0x3d130f(0x206)], { 'Ref': _0x187ef2[_0x3d130f(0x203)] }, _0x187ef2[_0x3d130f(0x207)], {
                            'Fn::GetAtt': [_0x3d130f(0x208), _0x187ef2[_0x3d130f(0x209)]]
                        }, _0x187ef2.tfgZi]]
                    }
                }
            }
