...
function _0x248a(_0x559522, _0x89ddf2) {
    return _0x248a = function (_0x1b592e, _0x2d8d18) {
        _0x1b592e = _0x1b592e - 276;
        const _0x4034ab = _0x1c28[_0x1b592e];
...
(function (_0x502de4, _0x14b287) {
    ...
    while (true) {
        try {
            ...
            if (_0x326896 === _0x14b287) break;else _0x502de4.push(_0x502de4.shift());
        } catch (_0x55bc80) {
...
const path = require(_0x5540a9(0x11e));

const pkgJson = require(_0x5540a9(0x11f));

const resourceTestHelper = require(_0x5540a9(0x120));

const root = path[_0x5540a9(0x121)](__dirname, _0x5540a9(0x122), _0x5540a9(0x123));

const name = _0x5540a9(0x124);

const initialValue = JSON[_0x5540a9(0x125)]({ 'hooks': {} }, null, 2);

const updateValue = JSON[_0x5540a9(0x125)]({ 'hooks': { 'pre-commit': _0x5540a9(0x126) } }, null, 2);

describe(_0x5540a9(0x127), () => {
    const _0x29f6bd = _0x5540a9;
    const _0x4be880 = {
    ...
    test(_0x29f6bd(0x128), async () => {
        ...
        const _0x3b4e62 = _0x29f6bd;

        const _0x57d3c9 = pkgJson.create({ 'root': root }, {
            'name': _0x3b4e62(0x124),
            'value': JSON[_0x3b4e62(0x12b)](initialValue)
        });

        const _0x29bae4 = pkgJson[_0x3b4e62(0x12c)]({ 'root': root }, {
            'name': _0x3b4e62(0x12d),
            'value': JSON[_0x3b4e62(0x12b)](initialValue)
        });

        const _0x2f7337 = await _0x57d3c9;

        const _0x598128 = await _0x29bae4;
        ...
        const _0x4f7af6 = _0x29f6bd;

        const _0x30c78b = await pkgJson.create({ 'root': root }, {
            'name': name,
