const _0x2c30 = ['eSOez', 'ntuRw', 'NoPermissionError', 'errors.middleware.auth.authorizationFailed', 'errors.middleware.auth.missingAdminUserOrIntegration', 'user', 'api_key', 'JSJkT', 'gIHmI', 'lxdvN', 'ZVHMi', 'exports', '27GUksAc', '1853IkmDec', '45023mDlbFr', '1rkbhkC', '3oLHdcC', '138036qZmhKG', '552501kEZZZr', '302750gdwWzX', '377373bpjfGM', '33628pDxnLo', 'errors.middleware.auth.missingContentMemberOrIntegration', 'member'];
const _0x120108 = _0xd50e;

function _0xd50e(_0x123aec, _0x29d9e) {
    return _0xd50e = function (_0x10bcce, _0x1eb7c0) {
        _0x10bcce = _0x10bcce - 360;
        const _0x1ca6fd = _0x2c30[_0x10bcce];
...
(function (_0x1d3de2, _0x421a3) {
    ...
    while (true) {
        try {
            ...
            if (_0x38a11b === _0x421a3) break;else _0x1d3de2.push(_0x1d3de2.shift());
        } catch (_0x430f46) {
...
const authorize = {
    'authorizeContentApi'(_0x4feafb, _0x159f78, _0x21c75f) {
        ...
        const _0xd41937 = _0x4feafb.api_key && _0x4feafb.api_key.id;

        const _0x52e0f9 = _0x4feafb[_0x193e04(0x173)];

        if (_0xd41937) return _0x21c75f();
        if (_0x52e0f9) return _0x74614f[_0x193e04(0x174)](_0x21c75f);
    ...
    'authorizeAdminApi'(_0x57b2f2, _0x4718e7, _0x270d7f) {
        ...
        const _0x2054c1 = _0x57b2f2[_0x35d7d7(0x179)] && _0x57b2f2[_0x35d7d7(0x179)].id;

        const _0x38df3f = _0x57b2f2[_0x35d7d7(0x17a)] && _0x57b2f2[_0x35d7d7(0x17a)].id;
