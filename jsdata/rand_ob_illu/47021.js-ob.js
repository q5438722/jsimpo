const _0x31d5 = ['../', 'out', 'Export Dyanmic Pages', '/regression/jeff-is-cool', 'NnBSW', 'mxfMV', 'DkXhc', 'suMwK', 'GmGXe', 'text', 'toBe', 'SlZwg', 'eval', 'window.__AS_PATHS', 'toEqual', 'close', '650761UYESKd', '70847RMGlsT', '428297GUEwES', '519919LKmHEe', '707877KcwwOh', '1VmcabQ', '103470SKZBWH', '993407oLmOKZ', '1NqHnQV'];
...
(function (_0x1a19df, _0x982950) {
    ...
    while (true) {
        try {
            ...
            if (_0x151a98 === _0x982950) break;else _0x1a19df.push(_0x1a19df.shift());
        } catch (_0x13abae) {
...
function _0x1b9d(_0x301c08, _0x4376f1) {
    return _0x1b9d = function (_0x583e7c, _0x2707b5) {
        _0x583e7c = _0x583e7c - 441;
        const _0x5ae38f = _0x31d5[_0x583e7c];
...
import { nextBuild, nextExport, startCleanStaticServer, stopApp, renderViaHTTP } from 'next-test-utils';
jest.setTimeout(60000);
const appDir = join(__dirname, _0x4e1f8e(0x1c2));
const outdir = join(appDir, _0x4e1f8e(0x1c3));

describe(_0x4e1f8e(0x1c4), () => {
    const _0x1ab956 = _0x4e1f8e;
    const _0x351ae7 = {
        ...
        'iXVPX': 'should of exported with correct asPath',
        'SlZwg': 'should hydrate with correct asPath'
    };
    ...
    _0x351ae7[_0x1ab956(0x1c6)](beforeAll, async () => {
        ...
        const _0x11d4e6 = _0x1ab956;

        const _0x5ae878 = await renderViaHTTP(_0x4cb789, _0x351ae7[_0x11d4e6(0x1c9)]);

        const _0x2cda21 = _0x48bbf1.load(_0x5ae878);
