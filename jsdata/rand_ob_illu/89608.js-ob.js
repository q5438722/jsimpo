...
function _0x515f(_0x1188ad, _0x5a461a) {
    return _0x515f = function (_0x5fc8a4, _0x24caba) {
        _0x5fc8a4 = _0x5fc8a4 - 214;
        const _0x44e024 = _0x330b[_0x5fc8a4];
...
(function (_0x1224b3, _0xe827ab) {
    ...
    while (true) {
        try {
            ...
            if (_0x31c389 === _0xe827ab) break;else _0x1224b3.push(_0x1224b3.shift());
        } catch (_0x41ff2b) {
...
const fs = require(_0x5088ce(0xe0));

const path = require('path');

const glob = require(_0x5088ce(0xe1));

const replaceHtmlCompilationHash = (_0x3a5083, _0x1e4e53) => {
    const _0x2c3e0f = _0x5088ce;

    const _0x41e57b = fs.readFileSync(_0x3a5083, _0x2c3e0f(0xe2));

    const _0x44f0c1 = /window\.webpackCompilationHash="\w*"/;

    const _0x1aa95f = 'window.webpackCompilationHash="' + _0x1e4e53 + '"';

    fs[_0x2c3e0f(0xe3)](_0x3a5083, _0x41e57b.replace(_0x44f0c1, _0x1aa95f), _0x2c3e0f(0xe2));
};

const replacePageDataCompilationHash = (_0x129f7a, _0x320a57) => {
    const _0x197a15 = _0x5088ce;

    const _0x14f658 = JSON[_0x197a15(0xe4)](fs.readFileSync(_0x129f7a, _0x197a15(0xe2)));

    _0x14f658['webpackCompilationHash'] = _0x320a57, fs[_0x197a15(0xe3)](_0x129f7a, JSON[_0x197a15(0xe5)](_0x14f658), _0x197a15(0xe2));
};

const overwriteWebpackCompilationHash = _0x34ca42 => {
    const _0xe6763e = _0x5088ce;
    const _0x4d6316 = {
    ...
    return glob[_0xe6763e(0xe6)](path.join(__dirname, '../../public/page-data/**/page-data.json')).forEach(_0x1f5377 => replacePageDataCompilationHash(_0x1f5377, _0x34ca42)), glob[_0xe6763e(0xe6)](path[_0xe6763e(0xe7)](__dirname, '../../public/**/*.html'))[_0xe6763e(0xe8)](_0x432d6c => {
        ...
        if (!_0x432d6c[_0x530d6b(0xe9)](/\/page-data\/[^/.]+\.html/)) _0x4d6316[_0x530d6b(0xea)](replaceHtmlCompilationHash, _0x432d6c, _0x34ca42);
    }), null;
};
