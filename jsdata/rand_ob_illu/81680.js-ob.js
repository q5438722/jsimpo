const _0x529b = ['../../../../../../../shared/settings-cache', 'get', 'timezone', 'created_at', 'updated_at', 'published_at', 'FJcti', 'hwsad', 'forEach', 'Bcbwn', 'exports', 'forPost', '68301vsotJi', '215513tArgxU', '709PCYxoh', '51OOvcwL', '145586gRVMoG', '42443lrvSwT', '2YykDLT', '50219kverfY', '3hjlpMi', '25867ZdMvIh', 'moment-timezone'];

function _0x2642(_0x80a635, _0x3d7c32) {
    return _0x2642 = function (_0x3824a8, _0x185fcc) {
        _0x3824a8 = _0x3824a8 - 306;
        const _0x547a94 = _0x529b[_0x3824a8];
...
(function (_0x505bae, _0x20595f) {
    ...
    while (true) {
        try {
            ...
            if (_0x23b554 === _0x20595f) break;else _0x505bae.push(_0x505bae.shift());
        } catch (_0x4fe92e) {
...
const moment = require(_0x11a52c(0x13c));

const settingsCache = require(_0x11a52c(0x13d));

const format = _0x40c85a => {
    const _0x162ec4 = _0x11a52c;

    return moment(_0x40c85a).tz(settingsCache[_0x162ec4(0x13e)](_0x162ec4(0x13f))).toISOString(true);
};

const forPost = _0x35696a => {
    const _0x5645a4 = _0x11a52c;
    const _0x4900c2 = {
    ...
    return [_0x4900c2[_0x5645a4(0x143)], _0x4900c2.vomIf, _0x4900c2[_0x5645a4(0x144)]][_0x5645a4(0x145)](_0x520137 => {
