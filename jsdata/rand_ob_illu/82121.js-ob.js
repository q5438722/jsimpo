...
function _0x2096(_0x4131c4, _0x46a07e) {
    return _0x2096 = function (_0x1e548e, _0x3d1023) {
        _0x1e548e = _0x1e548e - 222;
        const _0x39c5d3 = _0x3899[_0x1e548e];
...
(function (_0xcf313b, _0x3d1b2c) {
    ...
    while (true) {
        try {
            ...
            if (_0xbf2d08 === _0x3d1b2c) break;else _0xcf313b.push(_0xcf313b.shift());
        } catch (_0x3a4a76) {
...
const ObjectID = require(_0x1d5307(0xe5));

const logging = require(_0x1d5307(0xe6));

var { createTransactionalMigration } = require(_0x1d5307(0xe7));

const MIGRATION_USER = 1;

module['exports'] = createTransactionalMigration(async function up(_0x3c7d54) {
    const _0x7b9ef7 = _0x1d5307;
    const _0x3ae2fd = {
    ...
    const _0x4052ad = await _0x3ae2fd.TtcvC(_0x3c7d54, _0x3ae2fd.ROTNI)[_0x7b9ef7(0xec)](_0x3ae2fd[_0x7b9ef7(0xed)], '=', _0x7b9ef7(0xe9))[_0x7b9ef7(0xee)]();
    ...
    } else logging[_0x7b9ef7(0xfb)]('Skipped adding "email_verification_required" record to "settings" table. Record already exists!');
}, async function down(_0x1975f2) {
    const _0xa18fe4 = _0x1d5307;
    const _0x54f107 = {
