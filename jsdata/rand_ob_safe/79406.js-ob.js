"use strict";
  ...
  (function (dunlin, termite) {
    ...
    {
      try {
        rook = parseInt(squid(0xf9)) + - parseInt(squid(0xfa)) + - parseInt(squid(0xfb)) + - parseInt(squid(0xfc)) * parseInt(squid(0xfd)) + - parseInt(squid(0xfe)) + parseInt(squid(0xff)) + parseInt(squid(0x100));
        if (rook === termite)
          break;
        else
          dunlin['push'](dunlin['shift']());
      }
      catch (_0x55984d) {
        dunlin['push'](dunlin['shift']());
      }
  ...
  Object['defineProperty'](exports, hamster(0x101), {
    "value" : ! ! []
  });
  {
    chinchilla = hamster(0x102);
    ibex = hamster(0x103);
    boar = ['Font Awesome', ];
    llama = hamster(0x104);
    capybara = hamster(0x105);
  }
  exports[hamster(0x106)] = {
    "prefix" : chinchilla,
    "iconName" : ibex,
    "icon" : [0xf98, 0x200, boar, llama, capybara, ]
  }, 
  exports[hamster(0x107)] = exports[hamster(0x106)], 
  exports['prefix'] = chinchilla, 
  exports[hamster(0x108)] = ibex, 
  exports[hamster(0x109)] = 0xf98, 
  exports[hamster(0x10a)] = 0x200, 
  exports['ligatures'] = boar, 
  exports[hamster(0x10b)] = llama, 
  exports[hamster(0x10c)] = capybara;
