'use strict';
const _0x11dc = ["Number", "fhqwhgads", "284757kKVWlz", "7KCVJyw", "43291GxEucg", "188414JqMSbw", "1KsYIxW", "10189KnVCFl", "90224yNItXX", "4tvVIQJ", "96779Vybrpi", "624892HADNfB", "../common", "assert", "util", "from", "isDeepStrictEqual", "strictEqual", "prop", "2016", "test", "add", "reverse", "map", "set", "foo1", "foo2", "AssertionError", "slow", "String", "setPrototypeOf", "prototype", "true", "toStringTag", "defineProperty"];
const _0x5c0291 = _0x2dc5;
(function(data, val) {
  const toMonths = _0x2dc5;
  for (; !![];) {
    try {
      const nodeval = -parseInt(toMonths(212)) + -parseInt(toMonths(213)) * -parseInt(toMonths(214)) + -parseInt(toMonths(215)) + -parseInt(toMonths(216)) * parseInt(toMonths(217)) + parseInt(toMonths(218)) * -parseInt(toMonths(219)) + parseInt(toMonths(220)) + parseInt(toMonths(221));
      if (nodeval === val) {
        break;
      } else {
...
})(_0x11dc, -248159 * 1 + 282278 + -11 * -13303);
