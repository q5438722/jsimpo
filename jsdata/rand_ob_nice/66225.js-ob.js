'use strict';
var _0x408c = ["https://nodejs.org/dist", "x86", "arm64", "-headers", "SHASUMS256.txt", "opts", "parse", "SYkgA", "disturl", "version", "ZZEMd", "name", "replace", "wYqdH", "IMhVP", "major", "NODEJS_ORG_MIRROR", "oKJmr", "gpbFP", "headersUrl", "HuudA", "split", "libUrl", "ZgBSS", "gOLcP", "rbJSF", "satisfies", "resolve", "flxQd", "ztnMm", "RlBQe", ".tar.gz", "QFNhK", "rzILC", "AXRkY", "aGNxD", "relative", "RKHMA", "normalize", ".lib", "/win-", "test", "SHFEB", "YjtSi", "vuPxb", "nAUlq", "Xaraf", 
"ubXkU", "fcDNS", "FbAbG", "exports", "255228laBNUP", "2ahgoBB", "381371VvIlTV", "5SdJWfB", "136277Fwircb", "538511lwlmut", "1iJnqoP", "499600UlalgK", "691602GgzePv", "1505797NCJNUA", "semver", "path", "npmlog", ">= 3.0.0 || ~0.12.10 || ~0.10.42", "dist-url", "iojs", "node", "using dist-url"];
var _0x137568 = _0x1319;
(function(data, val) {
  var toMonths = _0x1319;
  for (; !![];) {
    try {
      var nodeval = -parseInt(toMonths(348)) + -parseInt(toMonths(349)) * parseInt(toMonths(350)) + -parseInt(toMonths(351)) * parseInt(toMonths(352)) + parseInt(toMonths(353)) * -parseInt(toMonths(354)) + parseInt(toMonths(355)) + parseInt(toMonths(356)) + parseInt(toMonths(357));
      if (nodeval === val) {
        break;
      } else {
...
})(_0x408c, 605556 + 481875 + 22 * -28559);
...
function _0x1319(totalExpectedResults, entrySelector) {
  return _0x1319 = function(hashOrKey, value) {
    hashOrKey = hashOrKey - (-125 * 37 + -6716 + 1 * 11689);
    var _0x1d701d = _0x408c[hashOrKey];
    return _0x1d701d;
  }, _0x1319(totalExpectedResults, entrySelector);
}
