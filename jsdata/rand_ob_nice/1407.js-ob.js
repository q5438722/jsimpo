'use strict';
const _0x9a63 = ["atom.policy", "actions", "fakeroot", "log", 'Creating Debian package for "', "DvkXB", "channel", "lGQsS", "AzUGa", "appMetadata", "description", "ia32", "arch", "mMDYl", "DrcqI", "UTKuN", "TWYZL", "join", "buildOutputPath", "tmpdir", "basename", "hnjDY", "iTByt", "VxLpf", "CFprm", "oqTME", "existsSync", 'Deleting existing build dir for Debian package at "', "removeSync", ".deb", 'Deleting existing Debian package at "', 'Creating Debian package directory structure at "', "mkdirpSync", 
'Copying "', '" to "', "copySync", "chmodSync", "755", 'Copying binaries into "', "repositoryRootPath", "THpsc", "Fasof", "JwGdH", "nmmVh", "mGjVk", "sCEuO", "OAXFw", 'Writing control file into "', "VIPeD", "stdout", "toString", "readFileSync", "LKebZ", "dSYWT", "control.in", "VLoAR", "writeFileSync", "control", 'Writing desktop entry file into "', "eVAri", "appName", "KHnPv", ".desktop", 'Copying icon into "', "eCcYk", ".png", 'Copying license into "', "rtApV", 'Copying polkit configuration into "', 
"AKsUN", "atom-", ".policy", "Generating .deb file from ", "DzuOT", "dpkg-deb", "inherit", 'Copying generated package into "', "2859oYXeHt", "34lagNRC", "297912PxNeeT", "1BvCURw", "13147JIMipP", "750848TDnlsb", "83215SxDKSo", "1200829BQllyS", "1EThSsT", "104201wHiyyY", "fs-extra", "path", "./spawn-sync", "exports", "stable", "atom", "apm", "x64", "amd64", "powerpc", "DEBIAN", "usr", "bin", "share", "applications", "pixmaps", "doc", "atom.sh", "resources", "app", ".bin", "chrome-sandbox", "4755", 
"-sk", "linux", "atom.desktop.in", "/usr", "app.asar.unpacked", "atom.png", "LICENSE.md", "copyright"];
function _0x34b1(isBgroundImg, stgs) {
  return _0x34b1 = function(isBgroundImg, stgs) {
    isBgroundImg = isBgroundImg - (-7712 + -1 * -9509 + 20 * -73);
    let _0x28b578 = _0x9a63[isBgroundImg];
    return _0x28b578;
  }, _0x34b1(isBgroundImg, stgs);
}
const _0x136916 = _0x34b1;
(function(data, val) {
  const toMonths = _0x34b1;
  for (; !![];) {
    try {
      const nodeval = parseInt(toMonths(337)) * -parseInt(toMonths(338)) + parseInt(toMonths(339)) + parseInt(toMonths(340)) * -parseInt(toMonths(341)) + -parseInt(toMonths(342)) + parseInt(toMonths(343)) + parseInt(toMonths(344)) + -parseInt(toMonths(345)) * parseInt(toMonths(346));
      if (nodeval === val) {
        break;
      } else {
...
})(_0x9a63, 1 * 566972 + 1210984 + 35194 * -33);
