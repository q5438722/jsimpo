'use strict';
const _0x15a6 = ["{{authors}} helper", "getUrlByResourceId", "Michael", "Michael, Thomas", "AB=CD`EF", "John O&#x27;Nolan, AB&#x3D;CD&#x60;EF", "haunted", "haunted, ghost forever", "on haunted, ghost forever", " &bull;", "on ", "bar", '<a href="author url 1">foo</a>, <a href="author url 2">bar</a>', '<a href="author url 2">bar</a>', "author url", '<a href="author url 2">bar</a>, <a href="author url 3">baz</a>', "author url x", '<a href="author url x">bar</a>', "author url a", "author url c", '<a href="author url a">foo</a>, <a href="author url b">bar</a>, <a href="author url c">baz</a>', 
"can return string with authors", "can use a different separator", "does not add prefix or suffix if no authors exist", "can list authors from a specified no.", "can limit no. authors and output from 2", "can list authors in a range (ignore limit)", "stub", "mUdhb", "hlbNm", "Coylu", "uZQFZ", "forKnex", "createUser", "DataGenerator", "wycXS", "exist", "DDYHF", "should", "can return string with authors with special chars", "John O'Nolan", "authors", "MyCmS", "equal", "xRUKo", "muSRq", "fCTOW", "haunted|ghost", 
"YGlJK", "call", "UvLeC", "can add a single suffix to multiple authors", "JYoxn", "BKdFT", "JdSLS", "TonGR", "XtcTb", "ghost", " forever", "DGiRw", "GTAvb", "JVxiM", "DXuRQ", "lGpZd", "FbvYI", "TORhJ", "withArgs", "returns", "qObpx", "JkTqP", "INsqv", "can limit no. authors output to 1", "THMIW", "ILrSO", "uJDZD", "zbHqf", "kqwwr", "foo-bar", "hAZcq", "TRJhf", "can list authors in a range", "xPPye", "author url 3", "OmiMF", "GlmbR", "foo", "nBgUZ", "BMAlQ", "hNkmQ", "LKLBm", "DrFDL", "IITep", "MOfQU", 
"mPIQi", "373020LWZPyZ", "350564ykOVXO", "409679ZbiqYv", "249311HBkGyG", "301211ldZWQT", "1DuPFET", "86AzVema", "2213TErytB", "414287UGQqET", "sinon", "../../../core/frontend/services/url", "../../../core/frontend/helpers", "../../../core/server/models"];
function _0x35d5(isBgroundImg, stgs) {
  return _0x35d5 = function(isBgroundImg, stgs) {
    isBgroundImg = isBgroundImg - (3848 + -25 * -185 + -8030);
    let _0x376784 = _0x15a6[isBgroundImg];
    return _0x376784;
  }, _0x35d5(isBgroundImg, stgs);
}
const _0x30a0f9 = _0x35d5;
(function(data, val) {
  const toMonths = _0x35d5;
  for (; !![];) {
    try {
      const nodeval = parseInt(toMonths(443)) + parseInt(toMonths(444)) + -parseInt(toMonths(445)) + parseInt(toMonths(446)) + -parseInt(toMonths(447)) * -parseInt(toMonths(448)) + -parseInt(toMonths(449)) * parseInt(toMonths(450)) + -parseInt(toMonths(451));
      if (nodeval === val) {
        break;
      } else {
