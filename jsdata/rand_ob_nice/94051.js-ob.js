'use strict';
const _0xde35 = ["hkLic", "VXfVL", "OktMa", "SrEJF", "OvziN", "VUTFR", "CReSn", "gDFpL", "kVstY", "KenLj", "OHeoX", "JjgGA", "stVhQ", "eXQCR", "Zapia", "ItGsQ", "qyCMb", "OIFNa", "mZKGd", "dMYze", "XxuMF", "hKqfd", "qclZg", "BSTzu", "pEbYq", "ZkJWD", "dQYRx", "VHzeO", "createRun", "projectId", "JxKcs", "Vcxib", "CiylW", "KzVYK", "DVGts", "--record", "jjUsx", "dQTYt", "FTAlF", "OqmCD", "llhHD", "XqWgN", "nkzom", "yaIje", "RfKCZ", "nnOEi", "Wvxhq", "acbCi", "AuiGC", "sOZrF", "rWsMq", "ppuwO", "JsVGC", 
"MpiAa", "XjKwh", "QBloT", "vskYt", "xoCPx", "WfMCF", "LcJlM", "vmjmb", "errors and exits when using --parallel without recording", "WkUgg", "mzzQu", "cCYfI", "eRReB", "--tag=nightly", "LlsOg", "seJVa", "XNUkp", "DttVQ", "errors and exits when group name is not unique and explicitly passed ciBuildId", "statusCode", "error", "GGKGq", "TmYiM", "qDNDM", "Jvvoz", "MiCUh", "SpuCo", "rBOTD", "Xnqqh", "Oenpx", "tgNIh", "ensureAndGetByNameOrPath", "59.1.2.3", "FylEE", "yLKkK", "jKQhy", "XPrAc", "ghjmQ", 
"errors and exits when parallel is not allowed", "wQJqX", "uNdAf", "PARALLEL_DISALLOWED", "GpLfU", "DLlxH", "CekAa", "Uhqfh", "WhzZM", "jssTB", "BBNCP", "DASHBOARD_PARALLEL_REQUIRED 1", "mloPM", "McfTi", "DASHBOARD_ALREADY_COMPLETE", "Sgfqp", "KiHgn", "GoaxL", "lcDaT", "xZnvO", "PKzVr", "ciVcU", "NFZHi", "qzxbN", "YGLfz", "lJHea", "sGsGa", "dzISJ", "mzcMh", '{"name":"cypress"', "sLHdF", "FpgBy", "BsujA", "vpvAj", "LbOvh", "--smoke-test", "khWCf", "fJsQn", "Xglmh", "rRwmR", "EltDJ", "aKLKQ", "VXCSm", 
"gcjtd", "CFPrS", "rYOjH", "WYcll", "http://localhost:8080", "readJsonAsync", "uIxqt", "SvMSW", "yrcAJ", "bAadi", "CMudN", "zmtVH", "iooja", "ipcMain", "XMKwL", "JSuhB", "ViLJX", "KflhX", "jAwoW", "imdwV", "passes options to Events.start", "bJVGS", "xyyXp", "RNGFf", "Fgjhl", "PSaMj", "dioKE", "sgkqP", "gbsHO", "Ijeyo", "aWHPR", "CYPRESS_FILE_SERVER_FOLDER", "CYPRESS_BASE_URL", "CYPRESS_responseTimeout", "CYPRESS_watch_for_file_changes", "mjgSE", "Mcyew", "zoEvh", "MWCLI", "wQHAw", "obYvS", "handleEvent", 
"options", "zBXty", "pageLoadTimeout", "eql", "gAhqX", "QjoqR", "getCall", "iyCnC", "PBayU", "baseUrl", "yTYas", "watchForFileChanges", "responseTimeout", "SZrUa", "uaNsa", "oqpUi", "pUvSX", "YAfsV", "OnrNh", "GOqMV", "aeKsb", "fFViN", "ukJdX", "uKRbR", "RVLTk", "ijBoi", "imijz", "WSEtW", "sender", "send", "vZhvz", "SnCLI", "Lryhr", "open was called", "foo.bar.baz.asdf.quux.json", "qcaDM", "OHAgZ", "vwHEJ", "jvsFG", "uVuDK", "sSDpA", "creates custom config file if it does not exist", "--config-file=", 
"jJOQd", "lXIYO", "jNNBD", "KVdKA", "equal", "RSood", "tqJrh", "shyDY", "UmuaK", "shows warning if Cypress has been started directly", "CRoTE", "EQkfY", "weJkP", "BaOiX", "qrahy", "FiyoN", "GIflB", "puWXk", "vKnqX", "322UMcwuV", "844oQETcv", "198372DVfAqH", "290782kcGXWk", "1eLlsLq", "62868sRaudz", "141690KKfjxd", "177826gcledp", "2xLbPfd", "73957mDDoLN", "../spec_helper", "ramda", "path", "events", "http", "electron", "@cypress/commit-info", "snap-shot-it", "debug", "@packages/launcher/lib/detect", 
"lib/util/args", "lib/util/fs", "lib/util/ci_provider", "lib/gui/events", "lib/gui/windows", "lib/modes/interactive-e2e", "lib/modes/run", "lib/cwd", "lib/config", "lib/cache", "lib/errors", "lib/plugins", "lib/cypress", "lib/project-base", "lib/project_static", "lib/server-e2e", "lib/reporter", "lib/watchers", "lib/browsers", "lib/open_project", "lib/util/env", "lib/util/validation", "lib/util/system", "lib/util/app_data", "../../lib/util/electron-app", "chrome", "chromium", "Chrome", "60.0.3112.101", 
"/Applications/Google Chrome.app/Contents/MacOS/Google Chrome", "stable", "Chromium", "/Users/bmann/Downloads/chrome-mac/Chromium.app/Contents/MacOS/Chromium", "canary", "Canary", "62.0.3197.0", "/Applications/Google Chrome Canary.app/Contents/MacOS/Google Chrome Canary", "Electron", "cwd", "chain", "log", "join", "iJTzQ", "error was logged", "process.exit was called", "pristine", "no-scaffolding", "plugin-config", "init", "isRunning", "setHostAndPath", "detect", "exit", "warning", "INVOKED_BINARY_OUTSIDE_NPM_MODULE", 
"logException", "versions", "Edge Beta", "80.0.328.2", "validates returned list", "a123", "COULD_NOT_PARSE_ARGUMENTS", "could not parse reporter options error", "--reporterOptions", "--config", "xyz", "could not parse env error", "exits if env cannot be parsed", "ready", "--cwd=/foo/bar", "`test` is not a valid configuration option", "INVALID_CONFIG_OPTION", "https://on.cypress.io/configuration", "--config=test=false,foo=bar", "does not show warning if config is valid", "1|2|3|4|0", "remoteOrigin", 
"waitForSocketConnection", "listenForProjectEnd", "startInMode", "--headless", "Impossible options: both headless and headed are true", "strips leading", "strips in the middle", "should have caught error but did not", "NO_PROJECT_ID", "http://localhost:8888/__/#/tests/integration/test2.coffee", "commands.js", "create", "foo should not be found", "We found an invalid configuration value", "sets morgan to false", "--browser=electron", "_setAutomation", "before:browser:launch", "can change the default port to 5544", 
"bar", "--video=false", "--env", "can set specific environment variables", "cypress.json should not exist", "--no-run-mode", "--config-file", "false does not require cypress.json to run", "run", "http://localhost:2020/__/#/tests/integration/bar.js", '--config=testFiles=["**/test2.coffee","**/test1.js"]', "watchTree", "integrationFolder should not exist!", "actions.spec.js", "files.spec.js", "viewport.spec.js", "code", "ENOENT", "CONFIG_FILE_NOT_FOUND", "cypress", "integration", "example.json", "spec", 
"dot", "https://on.cypress.io/recording-project-runs", "CANNOT_REMOVE_OLD_BROWSER_PROFILES", "Warning: We failed to remove old browser profiles from previous runs.", "path/to/spec", "tests/path/to/spec", "logs error and exits when spec file was specified and does not exist", "logs error and exits when spec absolute file was specified and does not exist", "does not save project state", "--config=requestTimeout=1234,videoCompression=false", "plugin", "cli", "can override default values", "can override values in plugins", 
"127.0.0.1", "CYPRESS_DEBUG", "throws an error if both --headed and --headless are true", "strips --", "does not add project to the global cache", "runs project by relative spec and exits with status 0", "runs project by specific spec with default configuration", "runs project by specific absolute spec and exits with status 0", "runs project by limiting spec files via config.testFiles string glob pattern", "runs project by limiting spec files via config.testFiles as a JSON array of string glob patterns", 
"does not scaffold integration or example specs when runMode", "scaffolds out fixtures + files if they do not exist", "scaffolds out support + files if they do not exist", "removes fixtures when they exist and fixturesFolder is false", "runs project headlessly and displays gui", "turns on reporting", "can change the reporter to nyan", "can change the reporter with cypress.json", "logs warning when projectId and key but no record option", "logs warning when removing old browser profiles fails", "logs error when browser cannot be found", 
"logs error and exits when project has cypress.json syntax error", "blockHosts", "logs error and exits when reporter does not exist", "state", "config overrides", "--port", "CYPRESS_PROJECT_ID", "get", "foo-project-123", "CYPRESS_RECORD_KEY", "token", "--parallel", "--key=token-123", "--group=e2e-tests-chrome", "info", "https://dashboard.cypress.io/runs/12345", "--group=electron-smoke-tests", "--ciBuildId=ciBuildId123", "DASHBOARD_PARALLEL_REQUIRED", "PARALLEL_REQUIRED", "ALREADY_COMPLETE", "waitForTestsToFinishRunning", 
"INDETERMINATE_CI_BUILD_ID", "--group=e2e-tests", "INCORRECT_CI_BUILD_ID_USAGE 1", "RECORD_PARAMS_WITHOUT_RECORDING", "--ci-build-id=ciBuildId123", "RECORD_PARAMS_WITHOUT_RECORDING-group 1", "RECORD_PARAMS_WITHOUT_RECORDING-parallel 1", "RECORD_PARAMS_WITHOUT_RECORDING-tag 1", "RECORD_PARAMS_WITHOUT_RECORDING-group-parallel 1", "DASHBOARD_RUN_GROUP_NAME_NOT_UNIQUE 1", "DASHBOARD_PARALLEL_GROUP_PARAMS_MISMATCH 1", "DASHBOARD_PARALLEL_DISALLOWED", "DASHBOARD_PARALLEL_DISALLOWED 1", "DASHBOARD_ALREADY_COMPLETE 1", 
"DASHBOARD_STALE_RUN", "STALE_RUN", "uses process.env.CYPRESS_RECORD_KEY", "errors and exits when using --group but ciBuildId could not be generated", "errors and exits when using --ci-build-id with no group or parallelization", "errors and exits when using --ci-build-id without recording", "errors and exits when using --group without recording", "errors and exits when using --tag without recording", "errors and exits when using --group and --parallel without recording", "errors and exits when parallel group params are different", 
"errors and exits when run is already complete", "errors and exits when run is stale", "--return-pkg", "--version", "logs version and exits", "--ping=abc123", "--port=2121", "--config=pageLoadTimeout=1000", "pageLoadTimeout=1000", "--env=baz=baz", "baz", "http://localhost", "fileServerFolder", "port", "2222", "5555", "false", "brian", "on:project:warning", "open:project", "Blah blah baseUrl blah blah", "--foo=bar", "start", "response", "cypress started with config %s", "first call arguments %o", 
"reads config from a custom config file", "sends warning when baseUrl cannot be verified", "It looks like you are running the Cypress binary directly.", "https://on.cypress.io/installing-cypress", "does not show warning if finds --cwd", "runs interactiveMode and does not exit", "error handling", "--run-project", "interactive", "--cwd", "CwJGR", "ZXVnJ", "__removeSync", "scaffold", "todosPath", "projectPath", "todos", "pristinePath", "qbAwy", "noScaffolding", "yRBUA", "recordPath", "record", "pluginConfig", 
"pluginBrowser", "xWssL", "idsPath", "ids", "resolves", "stub", "ryFyG", "fGncg", "returns", "VSNUw", "lmyMb", "prototype", "reset", "BqFbm", "callThrough", "withArgs", "spy", "cjQJA", "vGrCX", "version", "HDxJf", "expectExitWith", "calledWith", "expectExitWithErr", "sfbDy", "LRllJ", "calledWithMatch", "vzKij", "fPHOy", "include", "MSHgM", "message", "second error text", "test browsers", "nYjQX", "fueFB", "has valid browsers", "isValidBrowserList", "true", "sJWPz", "has valid electron browser", "TaXaA", 
"oldFy", "ePEWu", "UprTw", "IzBKZ", "diyvO", "nVhBh", "getBrowsers", "then", "YdPEh", "browsers", "QRjYf", "HvvCM", "qqNGa", "oLXeJ", "JvsFD", "exits if config cannot be parsed", "xxWjK", "myxXx", "JosZJ", "JfYkx", "could not parse config error", "WdZIT", "ckGvT", "Rgmuw", "CTFeb", "IXuOB", "bnjLh", "JRkxf", "yaJtr", "UDPMV", "nonono", "AdzFv", "MdRoY", "ReEPp", "sVwyS", "ardwM", "XdleM", "NhqEO", "sfuJx", "mRwkf", "win", "app", "GEiMQ", "yieldsAsync", "open", "shows warning if config is not valid", 
"RkbSS", "uujjo", "oEVEo", "shows warning when multiple config are not valid", "VyXwM", "KtBiT", "eigWf", "LnniM", "3|1|0|4|2", "split", "Xfkvr", "spUEQ", "gWCCg", "gYJnm", "engOS", "DuVHH", "XsUxT", "gQQCL", "--config=trashAssetsBeforeRuns=false", "not", "AVilY", "zzfDN", "sDYOn", "jZZmf", "XEpNb", "qMtAm", "ebPrP", "BUmtZ", "DCwPj", "DkAYr", "hPhrk", "GyoVg", "VNUqS", "xdgAo", "EGrvc", "dvpor", "LSsBK", "IsFWG", "oQsXR", "cypress.json", "WJMtG", "HVjwY", "fixturesFolder should not exist!", "Lskwq", 
"rjMDY", "LzzGg", "VOlpL", "cypress run --record", "WzxdD", "nthRV", "PwnIi", "fyxZC", "suwAV", "--record=false", "asiMD", "lojKg", "GuKjy", "--spec=path/to/spec", "fTYQd", "QANKi", "OaqVO", "QqyDR", "NAfcF", "localhost:9999", "CONFIG_VALIDATION_ERROR", "pSjfJ", "foobarbaz", "IBPyA", "UAiag", "ZofCU", "zXpku", "sUJuE", "rTalX", "dqiuu", "TDogX", "SZzVV", "YjESt", "yTjxM", "xAshx", "BMCZa", "YlWXr", "--run-project=", "RUkES", "DtEoS", "nvgHW", "hfJoZ", "CsCyX", "calledOnce", "firstCall", "args", "xWhUd", 
"--headed", "BYGxL", "trLxE", "rLxaK", "ZaAxN", "DSNYn", "iArGk", "ADnnl", "toObject", "have", "been", "LqUnX", "wDyDR", "utVpB", "yjxcr", "SIAXP", "PHSKK", "bqgYr", "pWZZe", "set", "auth-token-123", "HKTOU", "createProject", "called", "JUIra", "getProjectId", "RhSKe", "catch", "jfmnp", "type", "hpbjO", "uqvFS", "length", "getProjectRoots", "hZRqE", "relative", "--spec=", "/tests/test2.coffee", "jKXxL", "BgOFW", "/cypress/integration/bar.js", "aclyq", "jTraA", "ejpgZ", "QhaUC", "DBpYB", "utKYd", 
"sOkCM", "dCoZR", "utpzi", "http://localhost:8888/__/#/tests/integration/test1.js", "FkplV", "SHLpL", "osTZu", "IlPJb", "does not watch settings or plugins in run mode", "yCtDO", "dYGvF", "XROPG", "mGdSI", "jNKgk", "DjAfP", "QJlXq", "todo.spec.js", "2-advanced-examples", "vyigF", "dVpcx", "RQtkC", "statAsync", "integrationFolder", "BjBuA", "Ugtge", "VNvGj", "oeQtS", "FCfFT", "OzgAR", "isRejected", "File or folder was scaffolded at index: ", "reason", "property", "ZIoct", "mOisU", "all", "UXYry", 
"YQaUr", "reflect", "each", "prcdR", "InfrD", "LkmnK", "write", "kYfkx", "yGqht", "TDEQK", "kLMwb", "CWaFL", "RtUWQ", "fixturesFolder", "sUtwN", "uXDtH", "HeIkB", "index.js", "supportFolder should not exist!", "TZgKw", "EzsRT", "VuOqC", "uUlNX", "cfg", "read", "OvinR", "Tlafy", "vsdoS", "YgOAv", "XUWAb", "RvYiG", "atpmv", "DBBKI", "Lxmuz", "FkzpQ", "RUcdI", "tighP", "SLhYc", "YVKfE", "reporter", "PIhFl", "sDDgU", "runs tests even when user isn't logged in", "XCnwM", "TWjur", "YdOPH", "ZjAbS", "LfDuz", 
"SnTxg", "SLaIi", "foo", "removeOldProfiles", "rejects", "fobte", "PniRr", "stack", "GdgHR", "zuAkm", "kmmEB", "UVyKJ", "iWHsL", "QIdyJ", "cypress run --key <record_key>", "--key=asdf", "xOkNS", "nInHP", "OZawK", "VmDgF", "sSpGp", "does not log warning when projectId but --record false", "rjELY", "logs error when supportFile doesn't exist", "SUPPORT_FILE_NOT_FOUND", "/does/not/exist", "JUfeJ", "QiDGy", "BROWSER_NOT_FOUND_BY_NAME", "lhgyX", "ulAne", "DTjqD", "foNKF", "Browser: 'foo' was not found on your system or is not supported by Cypress.", 
"Cypress supports the following browsers:", "gWiUn", "find", "includes", "ttMrz", "ipaPs", "kEata", "KOkHt", "ojCuF", "no specs found", "nASRp", "QNbep", "cypress/specs", "dRQyE", "uToQj", "XSHBE", "UMJDc", "eMhgb", "PGpnR", "NO_SPECS_FOUND", "UZwsK", "mUZmO", "AIiKF", "logs error and exits when no specs were found at all", "xxiZw", "mCaBs", "QLWid", "pdBBf", "/cypress.json", "ERROR_READING_FILE", "logs error and exits when project has cypress.env.json syntax error", "writeFileAsync", "/cypress.env.json", 
"{'foo': 'bar}", "vAnAb", "LMUeu", "YhQeU", "SETTINGS_VALIDATION_ERROR", "nwSHD", "cQfik", "HdXCU", "qtXBu", "logs error and exits when project has invalid config values from env vars", "SUnHb", "Okjpk", "env", "WTnDB", "slevF", "pjkPh", "WxGNw", "forEach", "--config=", "FfEEI", "new", "WvpUD", "logs error and exits when project folder has read permissions only and cannot write cypress.json", "hsBuB", "resolve", "./permissions", "qAEbP", "outputFileAsync", "chmodAsync", "555", "hwDBf", "removeAsync", 
"xIEMF", "uKdLN", "cEMZy", "xKfcC", "tOsNE", "DzVss", "mEmFN", "TdOvt", "remove", "formStatePath", "statePath", "projectsPath", "ZWsvF", "getProject", "saveState", "saved state should not exist but it did here: ", "jWtff", "morgan", "OUoHd", "kwubs", "dkgXx", "cyZdb", "EfEyF", "kqMvZ", "videoCompression", "requestTimeout", "ttraJ", "resolved", "deep", "UFfLT", "CPuYW", "zqOlv", "restore", "YldsH", "Rtafm", "mJPWr", "defaultCommandTimeout", "omxGl", "gDxPr", "KTjwD", "WJLKI", "plugins", "nLrNe", "zxhvw", 
"LGREj", "RrGsr", "boFay", "--browser=chrome", "HmUwc", "kill", "emit", "destroy", "closed", "isDestroyed", "loadURL", "focusOnWebView", "webContents", "maximize", "mJBBN", "drHhv", "SSCOF", "found and used Chrome", "first 4 custom launch arguments to Chrome", "qsKNz", "uvwHb", "PbGUr", "_writeExtension", "QBWqY", "OyPGg", "FFoyM", "XPYJP", "kJsLb", "_handleDownloads", "khOtg", "HvUob", "launch", "LFyyc", "merge", "fhVMD", "iVnfZ", "sYpwm", "PECNo", "GufxX", "_navigateUsingCRI", "HOjWp", "_connectToChromeRemoteInterface", 
"VRchJ", "GnPKS", "DSSIZ", "match", "func", "jhMzi", "pqcMC", "YAUao", "rcqoR", "Server", "BkdBv", "ZGqUH", "sAYAR", "fuYmf", "jpzzx", "gnmIy", "logs error and exits when port is in use", "IRvFG", "getAutomation", "createServer", "listenAsync", "txmYO", "JMBLD", "QhTDM", "iWHrC", "cEBbv", "version=0.12.1,foo=bar,host=http://localhost:8888,baz=quux=dolor", "SwLsT", "bFhGK", "aSBCx", "Ownpw", "0.12.1", "UmSOn", "http://localhost:8888", "vcsQP", "WrQJW", "ndKtm", "zZByg", "buhZY", "quux=dolor", "parses environment variables with empty values", 
"ipsum", "UOAWF", "tpZAQ", "GhQdn", "kgqRw", "GSmQg", "aIVfC", "with a custom config file fails when it doesn't exist", "filename", "zDnlG", "EjyRW", "ZlsJJ", "hUrxn", "WhmPD", "yONPw", "DobpN", "FlAUP", "jHcjX", "VcEKm", "bHbyK", "INCORRECT_CI_BUILD_ID_USAGE", "ToNNz"];
function _0x501e(isBgroundImg, stgs) {
  return _0x501e = function(isBgroundImg, stgs) {
    isBgroundImg = isBgroundImg - (-2466 + 5 * -905 + 7403);
    let _0x48660f = _0xde35[isBgroundImg];
    return _0x48660f;
  }, _0x501e(isBgroundImg, stgs);
}
const _0x2d9756 = _0x501e;
(function(data, val) {
  const toMonths = _0x501e;
  for (; !![];) {
    try {
      const nodeval = parseInt(toMonths(412)) * -parseInt(toMonths(413)) + -parseInt(toMonths(414)) + parseInt(toMonths(415)) * parseInt(toMonths(416)) + -parseInt(toMonths(417)) + parseInt(toMonths(418)) + -parseInt(toMonths(419)) * -parseInt(toMonths(420)) + -parseInt(toMonths(421));
      if (nodeval === val) {
        break;
      } else {
...
})(_0xde35, 17858 * 14 + -160206 + -2469 * -37), require(_0x2d9756(422));
...
describe(_0x2d9756(444), () => {
  ...
  beforeEach(function() {
    ...
    this[getKey(705)] = (mmUserProfileHandlersTypeCommunication, n, a) => {
      ...
      const table = errors[parseInt(472)]["getCall"](22 * -181 + 71 * 42 + 1E3)["args"][-1047 + -4348 + 5 * 1079];
  ...
  data[getRefreshTokenKey(759)](context, data[getRefreshTokenKey(790)], () => {
    ...
    data[getKey(993)](it, data[getKey(994)], function() {
      ...
      return sinon[argon2ErrorMessage(687)](browsers, argon2ErrorMessage(996))[argon2ErrorMessage(997)](whoisResults), cypress[argon2ErrorMessage(654)]([argon2ErrorMessage(851) + this[argon2ErrorMessage(672)]])["then"](() => {
        ...
        match[convertSubInfo(998)](expect, errors[convertSubInfo(485)])["to"]["be"][convertSubInfo(704)](match[convertSubInfo(999)], whoisResults[convertSubInfo(1E3)]);
