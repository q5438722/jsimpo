'use strict';
var _0x5c8a = ["907033vVnhud", "1RcpYOH", "1113765hVgFoK", "176621fySJfk", "4AYCmYR", ".toggle-all", ".new-todo", "add", "all", ".todo-list", "visible", ".todoapp", "#stats-template", "clearCompleted", "toggleAllComplete", "2|1|4|0|3", "split", "MkysB", "some", "call", "querySelectorAll", "YrFrb", "WKpWN", ".footer", "JOpiG", "bjUUn", "change:completed", "filter", "selected", "gdypo", "xIvLy", "IsROo", "cEJtc", "JvDQs", "npqPd", "View", "extend", "GSkTJ", "sNHZX", "tZEhj", "createOnEnter", "evZtw", 
"kVDGF", "allCheckbox", "item", "input", "xoomk", "QbviI", "main", ".main", "listenTo", "todos", "CbKvC", "addOne", "addAll", "LFUOG", "filterOne", "EOjvJ", "filterAll", "fetch", "completed", "length", "edcHi", "TodoFilter", "zQVbv", "footer", "innerHTML", "statsTemplate", ".filters li a", "classList", "remove", "qyymG", "checked", "TodoView", "querySelector", "appendChild", "render", "eGJQa", "trigger", "fdRXO", "forEach", "value", "trim", "nextOrder", "IpNXb", "create", "newAttributes", "destroy", 
"style", "display", "1450866JKDQpA", "1NwpNNI", "1399642QHZFCl", "271292igIfhG", "1493302BUdlXL"];
function _0x28a8(totalExpectedResults, entrySelector) {
  return _0x28a8 = function(hashOrKey, value) {
    hashOrKey = hashOrKey - (-1 * 2809 + -2413 + -1 * -5389);
    var _0x3dc1c8 = _0x5c8a[hashOrKey];
    return _0x3dc1c8;
  }, _0x28a8(totalExpectedResults, entrySelector);
}
(function(data, val) {
  var toMonths = _0x28a8;
  for (; !![];) {
    try {
      var nodeval = -parseInt(toMonths(167)) + parseInt(toMonths(168)) * parseInt(toMonths(169)) + parseInt(toMonths(170)) + parseInt(toMonths(171)) + parseInt(toMonths(172)) + parseInt(toMonths(173)) * -parseInt(toMonths(174)) + parseInt(toMonths(175)) * -parseInt(toMonths(176));
      if (nodeval === val) {
        break;
      } else {
...
})(_0x5c8a, 1 * 549877 + 266458 + 11 * -1471);
var app = app || {};
(function() {
  var index = _0x28a8;
  var a = {
