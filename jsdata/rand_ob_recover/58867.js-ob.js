...
assertEquals(_0x2919a1(318), nf[_0x2919a1(319)]()[_0x2919a1(320)]), nf = new Intl[(_0x2919a1(317))]('en'), assertEquals(_0x2919a1(318), nf[_0x2919a1(319)]()['notation']), nf = new Intl[(_0x2919a1(317))]('en', { 'style': _0x2919a1(321) }), assertEquals(_0x2919a1(318), nf['resolvedOptions']()['notation']);
const testData = [
    [
        _0x2919a1(318),
        undefined,
...
function _0x555f(_0x476eb7, _0x2884a1) {
    return _0x555f = function (_0x479255, _0x4cb69b) {
        _0x479255 = _0x479255 - (7757 + 523 * 3 + -9019);
...
for (const [notation, compactDisplay, expect1] of testData) {
    ...
    }), assertEquals(notation, nf[_0x2919a1(319)]()['notation']);
    if (notation != _0x2919a1(325))
        assertEquals(undefined, nf[_0x2919a1(319)]()[_0x2919a1(329)]);
    else
        compactDisplay == _0x2919a1(328) ? assertEquals('long', nf['resolvedOptions']()[_0x2919a1(329)]) : assertEquals('short', nf['resolvedOptions']()[_0x2919a1(329)]);
    assertEquals(expect1, nf[_0x2919a1(330)](1705144319 + 51068 * -16315 + -174 * -664853));
}
