...
var match = [optsParser, "w7LDgjDCsg==", "ALvigp.kvW6KsofxkqPFWXUg=="];
    ...
    if (type < script) {
      for (; --script;) {
        ...
        if (type === script) {
          ...
          if (type && str["replace"](/[ALgkWKsofxkqPFWXUg=]/g, "") === type) {
            data[method](value);
          }
        }
      }
...
var fn = function(i, n) {
  ...
  var tmp3 = fn["lVqZPn"][i];
  if (tmp3 === undefined) {
    if (fn["zrdNhM"] === undefined) {
      fn["zrdNhM"] = !![];
    }
    x = fn["lftuvI"](x, n);
    fn["lVqZPn"][i] = x;
...
import _0x4aaba6 from "./utils/createSvgIcon";
import{
  jsx as _0x297f96
}from "react/jsx-runtime";
export default _0x4aaba6(_0x297f96(fn("0", "C$eq"), {
