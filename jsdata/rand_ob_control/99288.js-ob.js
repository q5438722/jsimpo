                ...
                'Rules': {
                    ...
                    'items': {
                        ...
                        'anyOf': [
                            ...
                            'Transition',
                            'Transitions'
                        ]['map'](_0x5a53a7 => ({ 'required': [_0x5a53a7] })),
                        'additionalProperties': ![]
                    }
                }
            },
                            ...
                            'Destination': {
                                ...
                                'properties': {
                                    'AccessControlTranslation': {
                                        'type': 'object',
                                        'properties': { 'Owner': { 'const': 'Destination' } },
                                        'required': ['Owner'],
                                        'additionalProperties': ![]
                                    },
                                    'Account': {
                                    ...
                                    'EncryptionConfiguration': {
                                        'type': 'object',
                                        'properties': { 'ReplicaKmsKeyID': { 'type': 'string' } },
                                ...
                                'required': ['Bucket'],
                                'additionalProperties': ![],
                                'dependencies': { 'AccessControlTranslation': ['Account'] }
                            },
                            'Filter': {
                                'type': 'object',
                                'properties': {
