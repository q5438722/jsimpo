...
(async function testTypeProfile() {
    ...
    let {
        result: {scriptId: _0x5a5484}
    } = await Protocol['Runtime']['compileScript']({
        'expression': source,
        'sourceURL': arguments['callee']['name'],
        'persistScript': !![]
    });
    Protocol['Runtime']['runScript']({ 'scriptId': _0x5a5484 }), await Protocol['Profiler']['startTypeProfile']();
    let _0x27a2d4 = await Protocol['Profiler']['takeTypeProfile']();
    await session['logTypeProfile'](_0x27a2d4['result']['result'][-0xdff + 0x1d96 + -0xd * 0x133], source), Protocol['Profiler']['stopTypeProfile'](), Protocol['Profiler']['disable'](), await Protocol['Runtime']['disable'](), InspectorTest['completeTest']();
}());
