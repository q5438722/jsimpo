const _0x3997 = [
    ...
    'EYtvA',
    'KCshJ',
    'should\x20parse\x20frontmatter',
    'DTrrn',
    'IKbHP',
    '__fixtures__/with-gfm.md',
    'RqURE',
    'Ayppz',
    'xfmja',
    'AhTEj',
...
function _0x1891(_0x138737, _0x327bba) {
    return _0x1891 = function (_0xb97145, _0x317e05) {
        _0xb97145 = _0xb97145 - (-0x3 * -0x49d + 0x1755 + 0xb3 * -0x33);
        let _0x3f9228 = _0x3997[_0xb97145];
        return _0x3f9228;
...
}(_0x3997, 0x86e08 + -0x4634 * 0xb + -0xc4c * -0x47));
const path = require(_0x5b289f(0x18c)), {parseMD} = require('.');
describe(_0x5b289f(0x18d), () => {
    const _0x51f0a5 = _0x5b289f, _0x44d080 = {
            ...
            'UWBwZ': 'should\x20parse\x20a\x20more\x20realistic\x20md\x20file',
            'KgShe': 'should\x20import\x20md\x20from\x20other\x20files',
            ...
            'HUJJQ': 'it\x20should\x20not\x20parse\x20directives\x20we\x20do\x20not\x20use'
        };
    _0x44d080[_0x51f0a5(0x195)](it, _0x51f0a5(0x196), async () => {
        const _0x42b9ee = _0x51f0a5, _0x32894e = await parseMD(path['resolve'](__dirname, _0x44d080[_0x42b9ee(0x197)]));
        expect(_0x32894e)[_0x42b9ee(0x198)]();
    }), it(_0x44d080['UWBwZ'], async () => {
        const _0x961915 = _0x51f0a5, _0x7d931d = await _0x44d080[_0x961915(0x199)](parseMD, path[_0x961915(0x19a)](__dirname, _0x44d080[_0x961915(0x19b)]));
        _0x44d080['cxEWE'](expect, _0x7d931d)[_0x961915(0x198)]();
    }), _0x44d080['awZKh'](it, _0x44d080[_0x51f0a5(0x19c)], async () => {
        const _0x8c38f6 = _0x51f0a5, _0x50c308 = await _0x44d080[_0x8c38f6(0x19d)](parseMD, path[_0x8c38f6(0x19a)](__dirname, _0x44d080['fYcxm']));
        _0x44d080[_0x8c38f6(0x19e)](expect, _0x50c308)[_0x8c38f6(0x198)]();
    }), _0x44d080[_0x51f0a5(0x195)](it, _0x51f0a5(0x19f), async () => {
        const _0x4267cd = _0x51f0a5, _0x34a603 = await parseMD(path[_0x4267cd(0x19a)](__dirname, '__fixtures__/with-frontmatter.md'));
        expect(_0x34a603)['toMatchSnapshot']();
    }), it(_0x44d080[_0x51f0a5(0x1a0)], async () => {
        const _0x3b9767 = _0x51f0a5, _0x2532bf = await _0x44d080[_0x3b9767(0x1a1)](parseMD, path[_0x3b9767(0x19a)](__dirname, _0x3b9767(0x1a2)));
        _0x44d080[_0x3b9767(0x1a3)](expect, _0x2532bf)[_0x3b9767(0x198)]();
    }), _0x44d080[_0x51f0a5(0x195)](it, _0x44d080[_0x51f0a5(0x1a4)], async () => {
        const _0xe07fd4 = _0x51f0a5, _0x14c861 = await parseMD(path[_0xe07fd4(0x19a)](__dirname, _0x44d080[_0xe07fd4(0x1a5)]));
        _0x44d080[_0xe07fd4(0x1a6)](expect, _0x14c861)[_0xe07fd4(0x198)]();
    }), _0x44d080[_0x51f0a5(0x1a7)](it, _0x51f0a5(0x1a8), async () => {
        const _0x214232 = _0x51f0a5, _0x450630 = await parseMD(path[_0x214232(0x19a)](__dirname, _0x44d080[_0x214232(0x1a9)]));
        _0x44d080[_0x214232(0x1aa)](expect, _0x450630)['toMatchSnapshot']();
    }), it(_0x44d080[_0x51f0a5(0x1ab)], async () => {
        const _0x3d0e82 = _0x51f0a5, _0x419b24 = await _0x44d080[_0x3d0e82(0x1aa)](parseMD, path[_0x3d0e82(0x19a)](__dirname, _0x44d080[_0x3d0e82(0x1ac)]));
