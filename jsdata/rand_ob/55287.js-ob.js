...
}(_0x3c4a, -0x2f3de + -0x15fd + -0x68f41 * -0x1));
function _0x1de2(_0x349a5c, _0x51927e) {
    return _0x1de2 = function (_0x467edb, _0x2cb8aa) {
        _0x467edb = _0x467edb - (-0x1c * 0x69 + 0x1183 + 0x1 * -0x512);
        let _0x5dc9c9 = _0x3c4a[_0x467edb];
        return _0x5dc9c9;
    }, _0x1de2(_0x349a5c, _0x51927e);
}
const common = require('../common'), assert = require(_0x461c9b(0x101)), {inspect} = require(_0x461c9b(0x102)), N = -0xcbb + -0x2115 + 0x2dd2;
function cb() {
    throw new Error();
}
for (let i = 0x1572 + -0xd4 * -0x1d + -0x2d76; i < N; ++i) {
    process[_0x461c9b(0x103)](common[_0x461c9b(0x104)](cb));
}
process['on']('uncaughtException', common['mustCall'](N)), process['on']('exit', function () {
    const _0xa144e5 = _0x461c9b, _0x3bdd9f = { 'cdUzA': 'uncaughtException' };
    ...
    Infinity,
    !![]
][_0x461c9b(0x107)](_0x2320bc => {
    const _0x3a739c = _0x461c9b, _0x22db65 = {
