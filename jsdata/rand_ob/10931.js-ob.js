const _0x3816 = [
    'creates\x20an\x20array\x20of\x20boolean\x20corresponding\x20to\x20the\x20permission\x20state',
    'mockImplementation',
    'resolve',
    'QNmxd',
...
}(_0x3816, -0x36977 + 0x3365 * -0x25 + 0xf8e42));
...
function _0x1af3(_0x55e5b5, _0x59dc07) {
    return _0x1af3 = function (_0x55fe54, _0x3a6f75) {
        _0x55fe54 = _0x55fe54 - (-0x30 * 0x60 + -0x1dce + 0x1 * 0x307d);
        let _0x319f51 = _0x3816[_0x55fe54];
        return _0x319f51;
...
jest[_0x305f4c(0xba)]('strapi-helper-plugin'), describe(_0x305f4c(0xbb), () => {
    const _0x5f2ba0 = _0x305f4c, _0x4e864b = {
            ...
            'uZxdg': 'Content-Types\x20Builder',
    ...
    _0x4e864b['FIUMm'](beforeEach, () => {
        ...
        hasPermissions[_0x3e422e(0xc5)](() => Promise[_0x3e422e(0xc6)](!![]));
    }), afterEach(() => {
        jest['resetAllMocks']();
    }), _0x4e864b['bOoew'](it, _0x4e864b[_0x5f2ba0(0xc7)], async () => {
        const _0x329535 = _0x5f2ba0, _0x8bc53a = [
                {
                    'id': 0x1ca,
            ...
            ], _0x1508b2 = await _0x4e864b['gqmVS'](_0x5d12c6, _0x8bc53a, _0x6dc280);
