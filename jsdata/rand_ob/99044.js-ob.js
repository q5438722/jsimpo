...
function _0x1bb6(_0x2f7192, _0x4ce7ed) {
    return _0x1bb6 = function (_0x55850f, _0x1422fc) {
        _0x55850f = _0x55850f - (-0x17e7 + -0x2228 + -0x5 * -0xbdd);
        let _0x5613f7 = _0x46b3[_0x55850f];
        return _0x5613f7;
...
}(_0x46b3, 0x1 * 0x1c5391 + -0x166584 + -0x1d * -0x5244));
const fs = require('fs'), path = require(_0xb4aadd(0x14e)), {expect} = require(_0xb4aadd(0x14f)), fse = require('fs-extra'), {execSync} = require(_0xb4aadd(0x150)), serverlessExec = require(_0xb4aadd(0x151)), {getTmpDirPath} = require(_0xb4aadd(0x152)), fixturePaths = {
...
describe(_0xb4aadd(0x157), () => {
    const _0x170c05 = _0xb4aadd, _0x8bb0ab = {
            ...
            'ZDrhY': 'handles\x20package\x20individually\x20with\x20include/excludes\x20correctly',
    ...
    _0x8bb0ab[_0x170c05(0x162)](beforeEach, () => {
        ...
        fse[_0x1b3067(0x166)](fixturePaths[_0x1b3067(0x179)], _0x11f4b9), _0x8bb0ab['tdACD'](execSync, serverlessExec + '\x20package', { 'cwd': _0x11f4b9 });
