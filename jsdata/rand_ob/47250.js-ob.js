...
}(_0x270e, -0x36aa8 + -0x9d * 0xb1d + 0x140467));
import { join } from 'path';
function _0x179c(_0x2f973b, _0x548efb) {
    return _0x179c = function (_0x12b3f0, _0x1b466d) {
        _0x12b3f0 = _0x12b3f0 - (-0xa23 + 0x1ee2 + -0x1354 * 0x1);
        let _0x2e0173 = _0x270e[_0x12b3f0];
        return _0x2e0173;
...
jest[_0x752bd8(0x175)]((0x206 + 0xb26 * 0x2 + 0x3 * -0x6ce) * (0x8f3 + -0x2 * -0xee2 + -0x267b) * (-0x5e * 0x39 + -0x2 * -0x3a1 + 0xdae));
const appDir = join(__dirname, _0x752bd8(0x176));
let appPort, app, server;
jest[_0x752bd8(0x175)]((-0x8 * 0x1 + -0x10 * -0x179 + 0x2 * -0x9d0) * (-0x25 * -0x4 + 0x18c5 + -0x191d) * (-0x214a + 0x108d * 0x1 + 0x10bf));
const context = {};
function runTests() {
    const _0x2bcc6a = _0x752bd8, _0x335585 = {
            ...
            'HOxDo': 'should\x20not\x20throw\x20if\x20request\x20body\x20is\x20already\x20parsed\x20in\x20custom\x20middleware',
            'oFLWf': 'should\x20not\x20throw\x20if\x20request\x27s\x20content-type\x20is\x20invalid'
        };
    _0x335585[_0x2bcc6a(0x179)](it, _0x335585[_0x2bcc6a(0x17a)], async () => {
        ...
        _0x335585[_0x2ca9fe(0x181)](expect, _0x14083b)[_0x2ca9fe(0x185)](-0xf86 * 0x2 + -0x108d + -0x3061 * -0x1), _0x335585[_0x2ca9fe(0x186)](killApp, server);
    });
}
async function makeRequest() {
    const _0x414e64 = _0x752bd8, _0x222bf7 = {
        ...
        }, _0xc61a4b = await _0x222bf7[_0x414e64(0x188)](fetchViaHTTP, appPort, _0x222bf7[_0x414e64(0x189)], null, {
...
async function makeRequestWithInvalidContentType() {
    const _0x13a839 = _0x752bd8, _0xc79634 = {
            ...
            'HbQKA': 'Nextjs'
        }, _0x1e6b18 = await _0xc79634[_0x13a839(0x191)](fetchViaHTTP, appPort, _0xc79634[_0x13a839(0x192)], null, {
...
const startServer = async (_0x5ebb37 = {}, _0x58424d) => {
    const _0x3f3d6e = _0x752bd8, _0x35de9d = {
        ...
        }, _0x3c121f = _0x35de9d['qChpn'](join, appDir, _0x35de9d[_0x3f3d6e(0x195)]);
