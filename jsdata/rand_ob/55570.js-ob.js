...
}(_0x3f44, 0x4 * -0x2729e + 0x62b26 + 0xcc20a));
const common = require('../common');
if (!common['hasCrypto'])
    common[_0x327eb7(0x171)](_0x327eb7(0x172));
const assert = require(_0x327eb7(0x173)), crypto = require(_0x327eb7(0x174)), domain = require(_0x327eb7(0x175)), test = _0x132d73 => {
        const _0x2ca184 = _0x327eb7, _0x33fb36 = {
                'wRUNb': 'BAM',
                'jqUxj': _0x2ca184(0x176)
            }, _0x241e10 = new Error(_0x33fb36[_0x2ca184(0x177)]), _0x45b9a4 = domain[_0x2ca184(0x178)]();
...
function _0x16dd(_0x1b8fe0, _0x66c075) {
    return _0x16dd = function (_0x33063e, _0x3e8e5b) {
        _0x33063e = _0x33063e - (-0x97 * -0x3b + -0x1 * 0x265a + 0x4f3);
        let _0x3080c8 = _0x3f44[_0x33063e];
        return _0x3080c8;
    }, _0x16dd(_0x1b8fe0, _0x66c075);
}
test(function (_0x5b7718) {
    const _0x4d17f2 = _0x327eb7, _0x28eca1 = { 'frBEj': 'password' };
    crypto[_0x4d17f2(0x17d)](_0x28eca1[_0x4d17f2(0x17e)], _0x4d17f2(0x17f), -0xa19 + -0x8e + 0xaa8, -0x1150 + -0x1c79 + -0x1 * -0x2dd1, _0x5b7718);
}), test(function (_0x3de0e7) {
    crypto['randomBytes'](0xfc8 * -0x1 + -0x20b2 + 0x309a, _0x3de0e7);
});
