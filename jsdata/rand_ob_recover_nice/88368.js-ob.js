...
function _0x10f9(recursionLevel, primaryTxHex) {
  return _0x10f9 = function(level, primaryTxHex) {
    level = level - (-8186 + 1237 + -3637 * -2);
    var rowsOfColumns = _0xae64[level];
    return rowsOfColumns;
  }, _0x10f9(recursionLevel, primaryTxHex);
}
