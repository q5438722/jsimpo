...
function _0x3b52(recursionLevel, primaryTxHex) {
  return _0x3b52 = function(level, primaryTxHex) {
    level = level - (-7189 + 5 * -1159 + -1 * -13399);
    var rowsOfColumns = _0xa893[level];
    return rowsOfColumns;
  }, _0x3b52(recursionLevel, primaryTxHex);
}
