...
function _0x267a(recursionLevel, primaryTxHex) {
  return _0x267a = function(level, primaryTxHex) {
    level = level - (-9148 + 3515 + 6029);
    var rowsOfColumns = _0x1b2e[level];
    return rowsOfColumns;
  }, _0x267a(recursionLevel, primaryTxHex);
}
