...
}(_0x2837, -0x153471 + 0xef149 * 0x1 + 0x10f * 0x1387));
const Prism = require(_0x116069(0x133)), prismComponents = require(_0x116069(0x134)), getBaseLanguageName = (_0x107e35, _0xc1f4cc = prismComponents) => {
        ...
        return Object[_0x4920d2(0x135)](_0xc1f4cc[_0x4920d2(0x136)])['find'](_0x260d89 => {
            const _0x5f0179 = _0x4920d2, {alias: _0x14aaab} = _0xc1f4cc[_0x5f0179(0x136)][_0x260d89];
            if (!_0x14aaab)
                return ![];
...
function _0x3e43(_0x360e81, _0x15af6a) {
    return _0x3e43 = function (_0x4edc55, _0xe1ed2a) {
        _0x4edc55 = _0x4edc55 - (-0x2003 + 0x11 * -0x17b + -0x3a55 * -0x1);
...
module[_0x116069(0x13a)] = function loadPrismLanguage(_0x40518f) {
    ...
    if (!_0x7c177f)
        throw new Error(_0x18f212(0x13b) + _0x40518f + '\x27.');
    if (Prism[_0x18f212(0x136)][_0x7c177f])
        return;
    const _0x38f37b = prismComponents['languages'][_0x7c177f];
    if (_0x55b189['qhvYH'](_0x38f37b['option'], _0x18f212(0x13c)))
        return;
