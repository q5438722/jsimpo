...
describe("{{authors}} helper", function() {
  ...
  it("can return string with authors", function() {
    ...
    should.exist(r);
    String(r).should.equal("Michael, Thomas");
  });
  it("can return string with authors with special chars", function() {
    ...
    should.exist(r);
    String(r).should.equal("John O&#x27;Nolan, AB&#x3D;CD&#x60;EF");
  });
  it("can use a different separator", function() {
    ...
    should.exist(r);
    String(r).should.equal("haunted|ghost");
  });
  it("can add a single prefix to multiple authors", function() {
    ...
    should.exist(r);
    String(r).should.equal("on haunted, ghost");
  });
  it("can add a single suffix to multiple authors", function() {
    ...
    should.exist(r);
    String(r).should.equal("haunted, ghost forever");
  });
  it("can add a prefix and suffix to multiple authors", function() {
    ...
    should.exist(r);
    String(r).should.equal("on haunted, ghost forever");
  });
  it("can add a prefix and suffix with HTML", function() {
    ...
    should.exist(r);
    String(r).should.equal("&hellip; haunted, ghost &bull;");
  });
  it("does not add prefix or suffix if no authors exist", function() {
    const e = helpers.authors.call({}, {
      hash : {
        prefix : "on ",
        suffix : " forever",
        autolink : "false"
  ...
  it("can autolink authors to author pages", function() {
    ...
    should.exist(r);
    String(r).should.equal('<a href="author url 1">foo</a>, <a href="author url 2">bar</a>');
  });
  it("can limit no. authors output to 1", function() {
    ...
    should.exist(r);
    String(r).should.equal('<a href="author url 1">foo</a>');
  });
  it("can list authors from a specified no.", function() {
    ...
    should.exist(r);
    String(r).should.equal('<a href="author url 2">bar</a>');
  });
  it("can list authors to a specified no.", function() {
    ...
    should.exist(r);
    String(r).should.equal('<a href="author url">foo</a>');
  });
  it("can list authors in a range", function() {
    ...
    should.exist(r);
    String(r).should.equal('<a href="author url 2">bar</a>, <a href="author url 3">baz</a>');
  });
  it("can limit no. authors and output from 2", function() {
    ...
    should.exist(r);
    String(r).should.equal('<a href="author url x">bar</a>');
  });
  it("can list authors in a range (ignore limit)", function() {
    ...
    should.exist(r);
    String(r).should.equal('<a href="author url a">foo</a>, <a href="author url b">bar</a>, <a href="author url c">baz</a>');
  });
});
