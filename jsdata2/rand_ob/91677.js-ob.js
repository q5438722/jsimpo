...
}(_0x58ab, 0x21e13 + -0xf * -0x1afe9 + 0x19a7 * -0x8b));
const Prism = require(_0x3d11b6(0x19a)), prismComponents = require('prismjs/components'), getBaseLanguageName = (_0x1cb20b, _0x56b721 = prismComponents) => {
        const _0x452709 = _0x3d11b6;
        if (_0x56b721[_0x452709(0x19b)][_0x1cb20b])
            return _0x1cb20b;
...
function _0x5deb(_0x26ac5a, _0x355e55) {
    return _0x5deb = function (_0x51bcd2, _0x13fe0d) {
        _0x51bcd2 = _0x51bcd2 - (0x1f9c * -0x1 + -0x8ab * 0x1 + 0x29d6);
...
module[_0x3d11b6(0x19f)] = function loadPrismLanguage(_0x2171f3) {
    const _0x50d114 = _0x3d11b6, _0x2773c9 = {
        ...
        }, _0xcb6911 = _0x2773c9[_0x50d114(0x1a0)](getBaseLanguageName, _0x2171f3);
    if (!_0xcb6911)
        throw new Error(_0x50d114(0x1a1) + _0x2171f3 + '\x27.');
    if (Prism[_0x50d114(0x19b)][_0xcb6911])
        return;
    const _0x2f3d6f = prismComponents['languages'][_0xcb6911];
    if (_0x2773c9[_0x50d114(0x1a2)](_0x2f3d6f[_0x50d114(0x1a3)], _0x50d114(0x1a4)))
        return;
