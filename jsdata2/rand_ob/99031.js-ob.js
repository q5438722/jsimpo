...
}(_0x5473, -0xef458 + -0xf500a + 0x71 * 0x5e57));
function _0x3d82(_0x1f1b8c, _0x4c1825) {
    return _0x3d82 = function (_0x322d7e, _0x167147) {
        _0x322d7e = _0x322d7e - (0x6c0 + 0x1 * 0x423 + -0xa03);
        let _0x17ffb2 = _0x5473[_0x322d7e];
        return _0x17ffb2;
    }, _0x3d82(_0x1f1b8c, _0x4c1825);
}
const {expect} = require(_0x24c3a1(0xeb)), awsRequest = require('@serverless/test/aws-request'), fixtures = require('../../fixtures/programmatic'), {confirmCloudWatchLogs} = require(_0x24c3a1(0xec)), {deployService, removeService} = require('../../utils/integration');
describe('Function\x20destinations\x20Integration\x20Test', function () {
    ...
    this[_0x367589(0xf1)](_0x51a92f[_0x367589(0xf2)](_0x51a92f[_0x367589(0xf2)](0x1 * 0x223d + -0x4ca + -0xd * 0x1f7, -0x115 * -0x2 + 0x1c41 + -0x1 * 0x1e2f), 0xb * 0x362 + 0x36e + -0x2890));
    let _0x349b0b, _0x1976e4;
    const _0x2a1be9 = _0x51a92f[_0x367589(0xf3)];
    _0x51a92f[_0x367589(0xf4)](before, async () => {
        const _0x298102 = _0x367589, _0x280621 = await fixtures[_0x298102(0xf5)](_0x51a92f[_0x298102(0xf6)]);
        ...
        expect(_0x51a92f['GOncY'](_0x260073[_0x3b5243(0x101)], -0x23 * 0x91 + 0x1d78 + -0x9a5))['to'][_0x3b5243(0x102)](!![]);
    }));
});
