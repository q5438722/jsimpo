...
}(_0x42ed, 0x37 * -0x146c + 0x511 * 0x187 + 0x1 * 0x672cf));
function _0x2bdb(_0x1e8adf, _0xe70066) {
    return _0x2bdb = function (_0x3620c6, _0x1e3142) {
        _0x3620c6 = _0x3620c6 - (-0x1 * 0x1b5b + -0x10a9 + 0x2d61 * 0x1);
        let _0x36d0b9 = _0x42ed[_0x3620c6];
        return _0x36d0b9;
    }, _0x2bdb(_0x1e8adf, _0xe70066);
}
const path = require('path'), child = require(_0x353f34(0x169));
it('Builds\x20cache-dir\x20with\x20minimal\x20config', _0x1c2bdd => {
    const _0x146e8a = _0x353f34, _0x151e2f = {
            ...
            path[_0x146e8a(0x16a)](__dirname, '..'),
            '--config-file',
            path[_0x146e8a(0x16a)](__dirname, _0x146e8a(0x16b)),
            '--ignore',
            _0x146e8a(0x16c)
        ], _0x360920 = child['spawn'](process[_0x146e8a(0x16d)], _0x32cdc8);
    let _0x53fdb7 = '', _0x1884d3 = '';
