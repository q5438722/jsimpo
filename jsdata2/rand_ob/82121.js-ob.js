...
function _0x365e(_0xb4ceb1, _0x4cbca1) {
    return _0x365e = function (_0x3856a1, _0xf54233) {
        _0x3856a1 = _0x3856a1 - (0x4 * -0xe1 + -0x1 * 0x1279 + 0xbce * 0x2);
        let _0x4c16a6 = _0x35f6[_0x3856a1];
        return _0x4c16a6;
...
}(_0x35f6, -0x244f7 * -0x5 + -0x9aeae + 0x5b2ae));
const ObjectID = require(_0x20b76a(0x1aa)), logging = require(_0x20b76a(0x1ab)), {createTransactionalMigration} = require(_0x20b76a(0x1ac)), MIGRATION_USER = 0x61 * -0x4f + 0x2167 + -0x377;
module[_0x20b76a(0x1ad)] = createTransactionalMigration(async function up(_0x3f801a) {
    const _0x307ae4 = _0x20b76a, _0x83048d = {
        ...
        }, _0x30e29a = await _0x83048d[_0x307ae4(0x1b5)](_0x3f801a, _0x83048d[_0x307ae4(0x1b6)])['where'](_0x83048d[_0x307ae4(0x1b7)], '=', _0x83048d[_0x307ae4(0x1b8)])[_0x307ae4(0x1b9)]();
    if (!_0x30e29a) {
        ...
        logging['warn'](_0x83048d[_0x307ae4(0x1c3)]);
