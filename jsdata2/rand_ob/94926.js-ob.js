...
function _0x200e(_0x31d18c, _0x22d4ac) {
    return _0x200e = function (_0x46625c, _0x4e1860) {
        _0x46625c = _0x46625c - (-0x2 * 0xf6b + -0x182c + 0x386f);
        let _0x18fe65 = _0x5211[_0x46625c];
        return _0x18fe65;
...
}(_0x5211, -0x4096 * 0xb + 0x1c4a7 * 0x1 + -0x55d * -0x79));
const debug = require(_0x395698(0x175))(_0x395698(0x176)), getNextJsBaseWebpackConfig = require(_0x395698(0x177))['default'];
async function getNextWebpackConfig(_0x5c439f) {
    ...
    try {
        ...
        if (_0x1bbdfd[_0x5498bc(0x17d)](_0xc3da7a['code'], _0x1bbdfd[_0x5498bc(0x17e)]))
            _0x44707a = _0x1bbdfd[_0x5498bc(0x17f)](require, _0x5498bc(0x180))[_0x5498bc(0x17c)];
        else
            throw _0xc3da7a;
    }
    const _0x40df09 = await _0x1bbdfd[_0x5498bc(0x181)](_0x44707a, _0x1bbdfd[_0x5498bc(0x182)], _0x5c439f[_0x5498bc(0x183)]), _0x3905ce = await _0x1bbdfd['tqXxU'](getNextJsBaseWebpackConfig, _0x5c439f[_0x5498bc(0x183)], {
...
module[_0x395698(0x187)] = async function findNextWebpackConfig(_0x2db638) {
    ...
    return webpackConfigCache = await _0x57fa0f['ZKsBF'](getNextWebpackConfig, _0x2db638), _0x57fa0f[_0x3c43ef(0x188)](debug, 'created\x20and\x20cached\x20webpack\x20preprocessor\x20based\x20on\x20next.config.js', webpackConfigCache), webpackConfigCache;
};
