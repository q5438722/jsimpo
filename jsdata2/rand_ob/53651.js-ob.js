...
}(_0x3c9b, 0x5fb33 * -0x3 + 0x17fa2c + 0x79398));
function _0x29c1(_0x4cb365, _0x31ff3c) {
    return _0x29c1 = function (_0x3e1f75, _0xe0b042) {
        _0x3e1f75 = _0x3e1f75 - (-0x1 * -0x728 + -0x3f2 + -0x190);
        let _0x92c8bf = _0x3c9b[_0x3e1f75];
        return _0x92c8bf;
    }, _0x29c1(_0x4cb365, _0x31ff3c);
}
const common = require('../common'), assert = require(_0x2b5ff6(0x1b1)), exec = require(_0x2b5ff6(0x1b2))['exec'], fixtures = require(_0x2b5ff6(0x1b3));
function errExec(_0x41fb4d, _0x295573) {
    const _0x366432 = _0x2b5ff6, _0xec3571 = '\x22' + process[_0x366432(0x1b4)][-0x1741 + 0x18d6 + 0x51 * -0x5] + '\x22\x20\x22' + fixtures[_0x366432(0x1b5)](_0x41fb4d) + '\x22';
    return exec(_0xec3571, (_0x2cc751, _0x5bd77f, _0x4fb202) => {
        const _0x2e55ea = _0x366432;
        assert['ok'](_0x2cc751), assert['ok'](_0x4fb202[_0x2e55ea(0x1b6)]('\x0a')[_0x2e55ea(0x1b7)]), _0x295573(_0x2cc751, _0x5bd77f, _0x4fb202);
    });
}
