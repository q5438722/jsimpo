...
function _0x1033(_0x45e5d3, _0x31a585) {
    return _0x1033 = function (_0xdac0d6, _0x596fa0) {
        _0xdac0d6 = _0xdac0d6 - (-0x5b3 * 0x4 + 0x1135 + -0x17 * -0x49);
        let _0x4b1189 = _0x3eee[_0xdac0d6];
        return _0x4b1189;
...
}(_0x3eee, -0x29 * 0x8c94 + 0x16a85 + 0x208816));
require('../common');
const assert = require('assert'), fork = require(_0x1a090d(0x104))[_0x1a090d(0x105)];
if (process[_0x1a090d(0x106)][0x3 * 0xaa2 + -0x2 * -0x9cb + -0x337a] === _0x1a090d(0x107))
    process[_0x1a090d(0x108)]('1'), setTimeout(function () {
        const _0xa81a1b = _0x1a090d;
        process[_0xa81a1b(0x108)]('2');
    }, 0x12b2 * -0x1 + -0x29 * -0x11 + 0x10c1), process['on']('disconnect', function () {
        const _0x313fe0 = _0x1a090d;
        process['stdout'][_0x313fe0(0x109)]('3');
    });
else {
    const child = fork(__filename, [_0x1a090d(0x107)], { 'silent': !![] }), ipc = [];
    let stdout = '';
