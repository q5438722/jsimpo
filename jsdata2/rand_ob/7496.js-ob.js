...
function _0x3456(_0x580dc9, _0xa77199) {
    return _0x3456 = function (_0x3c9b06, _0x582d33) {
        _0x3c9b06 = _0x3c9b06 - (0x1ac5 + -0x4 * 0x73 + -0x1848);
        let _0x234afd = _0x44ba[_0x3c9b06];
        return _0x234afd;
...
}(_0x44ba, 0x124f04 + 0x98d28 + -0xe0cf9));
...
export default function ({field, query, variables = null, updateQuery = null, update = null}) {
    const _0x28770d = _0x3456, fHwhtk = {
            'rOOBk': function (x, y) {
                return x === y;
            },
    ...
    return {
        'computed': {
            'configurationValid'() {
                ...
                return fHwhtk['rOOBk'](this[_0x1fad15(0xbc)][_0x1fad15(0xbd)](p => p['error'] || p[_0x1fad15(0xbe)] === null || JSON[_0x1fad15(0xbf)](p[_0x1fad15(0xbe)]) === '')[_0x1fad15(0xc0)], 0x260e + 0x11cc + -0x37da);
            },
            'hasPromptsChanged'() {
        ...
        'methods': {
            async 'answerPrompt'({
                ...
                const _0x53d009 = _0x28770d, vsSVuX = {
                        'fMsWa': function (x, y) {
                ...
                await this[_0x53d009(0xc8)][_0x53d009(0xc9)]({
                    ...
                    'update': (store, {
                        ...
                        let vars = variables || this[_0x26876b(0xc8)][_0x26876b(0xcc)][field][_0x26876b(0xcd)][_0x26876b(0xce)] || undefined;
