const _0x1229 = [
    ...
    '119723ZMUSQw',
    '@tryghost/debug',
    'frontend:services:settings:index'
];
const _0x20374d = _0x4c40;
function _0x4c40(_0x1b93ed, _0x33fc34) {
    return _0x4c40 = function (_0x349419, _0x2438fb) {
        _0x349419 = _0x349419 - (-0x565 + 0x7ca * 0x5 + -0x1fe7);
        let _0x151dcd = _0x1229[_0x349419];
        return _0x151dcd;
...
}(_0x1229, -0x1 * -0x160e1e + 0xf * 0xb93 + 0x1 * -0x80b31));
const _ = require('lodash'), crypto = require('crypto'), debug = require(_0x20374d(0x1b2))(_0x20374d(0x1b3)), SettingsLoader = require(_0x20374d(0x1b4)), ensureSettingsFiles = require(_0x20374d(0x1b5)), errors = require(_0x20374d(0x1b6)), defaultHashes = { 'routes': _0x20374d(0x1b7) }, calculateHash = _0x4fb552 => {
...
module[_0x20374d(0x1bf)] = {
    'init': function () {
        const _0x3cd397 = _0x20374d, _0x261dbc = {
            ...
            }, _0x16265b = this[_0x3cd397(0x1c1)]();
    ...
    'knownSettings': function knownSettings() {
        const _0x4a8075 = _0x20374d, _0x2e47df = { 'cyzvb': _0x4a8075(0x1c4) };
    ...
    'get': function get(_0x64cb10) {
        const _0x2d5df5 = _0x20374d, _0x57a4b8 = {
            ...
            }, _0x187955 = this[_0x2d5df5(0x1c1)]();
        if (!_0x64cb10 || _0x57a4b8['vHQfp'](_[_0x2d5df5(0x1c6)](_0x187955, _0x64cb10), -0x19bf + 0x33f + 0xf0 * 0x18))
            throw new errors['IncorrectUsageError']({
                'message': 'Requested\x20setting\x20is\x20not\x20supported:\x20\x27' + _0x64cb10 + '\x27.',
                'help': 'Please\x20use\x20only\x20the\x20supported\x20settings:\x20' + _0x187955 + '.'
            });
        return SettingsLoader(_0x64cb10);
    },
    'getAll': function getAll() {
        const _0x1b908d = _0x20374d, _0x565904 = this[_0x1b908d(0x1c1)](), _0x1f3529 = {};
    ...
    'getCurrentHash': async _0x1c2908 => {
        const _0x439426 = _0x20374d, _0x566cf3 = await SettingsLoader[_0x439426(0x1c7)](_0x1c2908);
