const _0x460a = [
    ...
    'lib/util/file',
    'file.json',
    'Must\x20specify\x20path\x20to\x20file\x20when\x20creating\x20new\x20FileUtil()',
    'ensure',
    'items',
    'bar',
    'foo',
    ...
    'resolves\x20value\x20for\x20key\x20when\x20one\x20is\x20set',
    ...
    'resolves\x20empty\x20object\x20when\x20it\x20can\x27t\x20get\x20lock\x20on\x20file\x20on\x20initial\x20read',
    ...
    'updates\x20file\x20on\x20disk',
    'locks\x20file\x20while\x20writing',
...
}(_0x460a, -0x3238f + 0x8c789 * 0x1 + -0x5a119 * -0x1), require(_0x54382e(0x93)));
const os = require('os'), path = require(_0x54382e(0x94)), Promise = require(_0x54382e(0x95)), lockFile = Promise[_0x54382e(0x96)](require('lockfile')), {fs} = require(root + _0x54382e(0x97)), env = require(root + _0x54382e(0x98)), exit = require(root + _0x54382e(0x99)), FileUtil = require(root + _0x54382e(0x9a));
function _0x3434(_0x13f464, _0x5c7b58) {
    return _0x3434 = function (_0x40ae05, _0x5b561c) {
        _0x40ae05 = _0x40ae05 - (0x1 * 0x150b + -0x862 * 0x2 + -0x1 * 0x3bf);
        let _0x1577e9 = _0x460a[_0x40ae05];
        return _0x1577e9;
    }, _0x3434(_0x13f464, _0x5c7b58);
}
describe(_0x54382e(0x9a), () => {
    const _0x4e98d7 = _0x54382e, _0x12b76f = {
            ...
            'JizMf': 'ensures\x20returned\x20promise\x20completely\x20resolves\x20before\x20moving\x20on\x20with\x20queue',
            ...
            'oAUTU': 'resolves\x20value\x20for\x20path\x20when\x20one\x20is\x20set',
            'wyOBr': function (_0x38a83f, _0x21ee00, _0x144097) {
                return _0x38a83f(_0x21ee00, _0x144097);
            },
            'AFVuC': 'resolves\x20default\x20value\x20if\x20given\x20key\x20is\x20undefined',
            'ieytt': _0x4e98d7(0xa8),
            'sOIzO': function (_0x1cc59e, _0x43cd8f, _0x17b8b0) {
                return _0x1cc59e(_0x43cd8f, _0x17b8b0);
            },
            'cGRPq': 'resolves\x20null\x20if\x20value\x20is\x20null',
            ...
            'BVeRY': 'times\x20out\x20and\x20carries\x20on\x20if\x20unlocking\x20times\x20out',
            ...
            'NIimb': 'throws\x20if\x201st\x20argument\x20is\x20not\x20a\x20string\x20or\x20plain\x20object',
            'afCuv': 'sets\x20value\x20for\x20given\x20key',
            'ZYfig': 'sets\x20value\x20for\x20given\x20path',
            ...
            'NkhdI': 'unlocks\x20file\x20even\x20if\x20writing\x20fails',
            ...
            'itogq': 'throws\x20if\x20path\x20is\x20not\x20specified',
            'AGdMC': 'unlocks\x20file\x20on\x20exit',
    ...
    beforeEach(function () {
        ...
        const _0x4650c4 = _0x4e98d7, _0x50b260 = _0x12b76f[_0x4650c4(0xca)]['split']('|');
        let _0x2bf3d1 = 0x17 * -0x8a + -0x1 * 0x1ea9 + -0x97 * -0x49;
        while (!![]) {
        ...
        const _0x4741d8 = _0x4e98d7, _0x1f0b66 = {
        ...
        beforeEach(function () {
            ...
            const _0x5e9606 = _0x4741d8, _0x3d865d = { 'bOyJK': _0x12b76f[_0x5e9606(0xd1)] };
            return Promise['all']([
                this[_0x5e9606(0xd3)][_0x5e9606(0xd6)](_0x3e4ba3 => {
                ...
                this[_0x5e9606(0xd3)][_0x5e9606(0xd6)](_0x45a729 => {
                    const _0x5c61d8 = _0x5e9606, _0x466bb2 = {
                ...
                const _0x244658 = _0x5e9606, _0x363231 = {
                ...
                return this['fileUtil'][_0x244658(0xd6)](_0x388d11 => {
                    ...
                    return _0x388d11['get'](_0x3d865d['bOyJK'])[_0x49beea(0xd8)](_0x262ca4 => {
                        ...
                        _0x363231[_0x5a76f1(0xdd)](expect, _0x262ca4)['to'][_0x5a76f1(0xde)]([
                            'foo',
                            _0x363231[_0x5a76f1(0xdf)],
                            _0x5a76f1(0xe0)
                        ]);
                    });
                });
        ...
        const _0x38e8a0 = _0x4e98d7, _0x215ab0 = {
        ...
        _0x12b76f[_0x38e8a0(0xe8)](beforeEach, function () {
            ...
            const _0x4ce385 = _0x38e8a0, _0x10ee2c = {
            ...
            const _0x3252e6 = _0x38e8a0, _0xc761eb = {
            ...
            const _0xaddcdf = _0x38e8a0, _0x40a203 = {
            ...
            const _0x37bfff = _0x38e8a0, _0x444fad = {
            ...
            return sinon[_0x478b32(0xcd)](fs, _0x215ab0[_0x478b32(0x109)])[_0x478b32(0x10a)]({}), Promise[_0x478b32(0x10b)]([
                this[_0x478b32(0xd3)][_0x478b32(0xd7)](),
                this[_0x478b32(0xd3)]['get'](),
                this[_0x478b32(0xd3)][_0x478b32(0xd7)]()
            ])[_0x478b32(0xd8)](() => {
            ...
            const _0xcd00ba = _0x38e8a0, _0x442a74 = {
            ...
            const _0x5917b4 = _0x38e8a0, _0x18c784 = {
            ...
            const _0x4554b7 = _0x38e8a0, _0x4b6ff1 = {
            ...
            return sinon['stub'](lockFile, _0x215ab0[_0x21dff9(0x104)])[_0x21dff9(0x10a)](), sinon['stub'](lockFile, 'unlockAsync')[_0x21dff9(0x117)](() => {
                ...
                return Promise[_0xb73c42(0x118)](-0x1 * 0x5226ec5a + -0x9a12f39 + -0x18b * -0x621d19);
            }), sinon[_0x21dff9(0xcd)](fs, _0x215ab0[_0x21dff9(0x109)])[_0x21dff9(0x10a)]({}), sinon[_0x21dff9(0xcd)](env, _0x21dff9(0xd7))[_0x21dff9(0x119)](_0x215ab0[_0x21dff9(0x11a)])[_0x21dff9(0x11b)](0x2c8 * 0x3 + 0x373 + -0xb67), this[_0x21dff9(0xd3)][_0x21dff9(0xd7)]();
        });
    }), _0x12b76f[_0x4e98d7(0x11c)](context, _0x4e98d7(0x11d), () => {
        const _0x2968e1 = _0x4e98d7, _0x4e09cf = {
                ...
                'VdNGk': 'Expected\x20`key`\x20to\x20be\x20of\x20type\x20`string`\x20or\x20`object`,\x20got\x20`array`',
        ...
        _0x12b76f['BDkGs'](beforeEach, function () {
            ...
            _0x4e09cf[_0x816a53(0x126)](expect, () => {
                ...
                return this[_0x234b0b(0xd3)][_0x234b0b(0xdb)](0x435 * -0x1 + 0x2 * -0x3e6 + 0x35 * 0x3a);
            ...
            const _0x4b4a5b = _0x2968e1, _0x3a1b46 = {
            ...
            const _0x1e67c1 = _0x2968e1, _0x4ad8ed = {
            ...
            const _0x8c5e2a = _0x2968e1, _0x1e7ca4 = {
        ...
        const _0x13666b = _0x4e98d7, _0x5e2bc0 = {
        ...
        }), it('removes\x20the\x20file', function () {
