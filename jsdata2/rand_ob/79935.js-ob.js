...
}(_0x583c, -0xe * 0x6175 + -0x3b * -0xb19 + 0x2 * 0x33771));
const fs = require('fs'), path = require(_0x596951(0xba)), {getJson} = require(_0x596951(0xbb));
function _0x56c7(_0x4c09a8, _0x55ae6b) {
    return _0x56c7 = function (_0x2099c3, _0x53289e) {
        _0x2099c3 = _0x2099c3 - (0xc2d * 0x1 + 0x7 * -0x2df + -0x89b * -0x1);
...
function parseThemeByJsonStr(_0x2da51e, _0x213c4b, _0x20f40d) {
    ...
    if (_0x206856[_0x411e5f(0xbc)](_0x2da51e['indexOf']('@'), -(0x3 * -0xbf7 + 0xc5a + 0x178c)))
        return _0x2da51e;
...
module[_0x596951(0xc7)] = {
    ...
    'initTheme'() {
        ...
        if (!_0x36fc8c[_0x3955bf(0xc8)](hasTheme))
            return;
        if (_0x36fc8c[_0x3955bf(0xc9)](darkmode))
            return;
        try {
            const _0x44890b = _0x36fc8c[_0x3955bf(0xca)](getJson, _0x36fc8c[_0x3955bf(0xcb)], !![]);
    ...
    'parseTheme'(_0x27d4de) {
        const _0x31546d = _0x596951, _0xb5a441 = {
            ...
            }, _0x360b12 = global[_0x31546d(0xc5)]['defaultTheme'];
        if (!_0x360b12)
            return _0x27d4de;
        const _0x3f3800 = Object['keys'](_0x360b12);
        if (!_0x3f3800[_0x31546d(0xd0)])
            return _0x27d4de;
        if (_0xb5a441[_0x31546d(0xd1)](typeof _0x27d4de, _0xb5a441[_0x31546d(0xd2)]))
            return _0xb5a441[_0x31546d(0xd3)](parseThemeByJsonStr, _0x27d4de, _0x3f3800, _0x360b12);
