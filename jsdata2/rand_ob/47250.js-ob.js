...
}(_0x49c7, 0x14e6d1 + -0x140bdb + 0xa75c6));
...
function _0xa7bf(_0x59264d, _0x5341ea) {
    return _0xa7bf = function (_0x51142a, _0xd93ec7) {
        _0x51142a = _0x51142a - (-0x6dc * -0x2 + 0x1 * -0x2155 + 0x14e2);
        let _0x1f5de0 = _0x49c7[_0x51142a];
        return _0x1f5de0;
    }, _0xa7bf(_0x59264d, _0x5341ea);
}
import _0x4cd534 from 'clone';
import _0x6c93b from 'get-port';
jest['setTimeout']((-0x1 * 0x126b + 0x1fc1 + -0x96e * 0x1) * (0x882 + -0x1700 + 0xeba) * (-0x663 * 0x1 + -0x1 * -0x15d + 0x508));
const appDir = join(__dirname, _0x2d60a1(0x14e));
let appPort, app, server;
jest[_0x2d60a1(0x14f)]((-0x1564 + -0x2f * -0x91 + -0x153) * (-0x2 * 0xd0f + -0x1 * 0x595 + 0x1fef) * (0x24fb + 0x138f + -0x3888));
const context = {};
function runTests() {
    const _0x1d9887 = _0x2d60a1, _0x315578 = {
    ...
    _0x315578[_0x1d9887(0x154)](it, _0x315578[_0x1d9887(0x155)], async () => {
        ...
        _0x315578[_0x4d7d4e(0x160)](expect, _0x3667ce)['toBe'](0x1 * 0xe7d + -0xf * -0x10d + -0x1d78), killApp(server);
    });
}
async function makeRequest() {
    const _0x126a97 = _0x2d60a1, _0x255e34 = {
            ...
            'Ngslk': 'POST',
            'OZgMY': 'application/json;\x20charset=utf-8',
            'tMChp': _0x126a97(0x150)
        }, _0x25dcef = await _0x255e34[_0x126a97(0x162)](fetchViaHTTP, appPort, _0x255e34[_0x126a97(0x163)], null, {
...
async function makeRequestWithInvalidContentType() {
    const _0x34474f = _0x2d60a1, _0x3e5b19 = {
            'tCnjb': _0x34474f(0x161),
            'Bafwy': _0x34474f(0x167),
            'jiZeX': _0x34474f(0x150)
        }, _0x3e48cb = await fetchViaHTTP(appPort, _0x3e5b19[_0x34474f(0x168)], null, {
...
const startServer = async (_0x30cbc6 = {}, _0x4c748a) => {
    const _0x10f8b7 = _0x2d60a1, _0x539d0f = {
        ...
        }, _0x13cc51 = join(appDir, _0x539d0f[_0x10f8b7(0x16e)]);
