...
}(_0x153b, 0x1b0bd3 + 0xb54ff + -0x1834be));
import { createRegExpFeaturePlugin } from '@babel/helper-create-regexp-features-plugin';
function _0x2bab(_0x308952, _0x5cc4a3) {
    return _0x2bab = function (_0x51f380, _0x5037e1) {
        _0x51f380 = _0x51f380 - (-0xb98 + 0x4f5 + 0x814);
        let _0x35c747 = _0x153b[_0x51f380];
        return _0x35c747;
...
export default function (core, options) {
    ...
    if (typeof runtime !== _0x40478f(0x17b))
        throw new Error(_0x40478f(0x17c));
