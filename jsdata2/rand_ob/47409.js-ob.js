const _0xd8a0 = [
    ...
    '13374tDKcud',
    'setTimeout',
    'node-fetch-keep-alive',
    '/api/json',
    'keep-alive',
    '/blog/first',
    '/ssr',
    'should\x20send\x20keep-alive\x20for\x20json\x20API',
...
}(_0xd8a0, 0xa3035 * 0x1 + -0x8acb4 + 0x486f8));
...
jest[_0x526f3e(0x163)]((0x5a * 0x32 + -0xa74 + 0x2 * -0x19c) * (-0xb18 + -0x47 * 0x13 + 0x25f * 0x7) * (-0x820 + 0x3 * -0x32f + 0x11ae));
const appDir = join(__dirname, '../');
function _0x2476(_0x380102, _0x2f2037) {
    return _0x2476 = function (_0xdc8b, _0x4293dd) {
        _0xdc8b = _0xdc8b - (-0x85b + -0x20d3 + 0x2a84);
        let _0x34b793 = _0xd8a0[_0xdc8b];
        return _0x34b793;
    }, _0x2476(_0x380102, _0x2f2037);
}
let appPort, app, mockServer;
describe(_0x526f3e(0x164), () => {
    const _0x41f432 = _0x526f3e, _0x5c9676 = {
    ...
    describe(_0x5c9676[_0x41f432(0x16e)], () => {
        const _0x1f225d = _0x41f432, _0x259cf0 = {
        ...
        _0x5c9676[_0x1f225d(0x16f)](beforeAll, async () => {
            ...
            mockServer = createServer((_0x30e83a, _0x565b9b) => {
                const _0x4085a1 = _0x2476, {connection: _0x4bb0a8} = _0x30e83a[_0x4085a1(0x170)];
                _0x565b9b[_0x4085a1(0x171)](JSON['stringify']({ 'connection': _0x4bb0a8 }));
            }), mockServer[_0x567c90(0x172)](0x1487a + -0xc2ae + -0x1 * -0x2615), appPort = await _0x259cf0[_0x567c90(0x173)](findPort), app = await _0x259cf0[_0x567c90(0x174)](launchApp, appDir, appPort);
        }), afterAll(async () => {
        ...
        beforeAll(async () => {
            ...
            mockServer = _0x5c9676['ehXJG'](createServer, (_0x5dded3, _0x4e2690) => {
                const _0x19d9a8 = _0x2476, {connection: _0x2dbf8f} = _0x5dded3[_0x19d9a8(0x170)];
                _0x4e2690[_0x19d9a8(0x171)](JSON[_0x19d9a8(0x177)]({ 'connection': _0x2dbf8f }));
            }), mockServer[_0x2691c4(0x172)](0x129e * -0x11 + 0x1a1 * 0x11 + 0x1ccae * 0x1);
            const {
                stdout: _0x1c2120,
                stderr: _0x3b20b9
            ...
            if (_0x1c2120)
                console[_0x2691c4(0x178)](_0x1c2120);
            if (_0x3b20b9)
                console['error'](_0x3b20b9);
    ...
    function _0x2cfebf() {
        const _0x2b999f = _0x41f432, _0x3a0665 = {
        ...
        _0x5c9676[_0x2b999f(0x181)](it, _0x5c9676[_0x2b999f(0x182)], async () => {
            const _0x5aafe0 = _0x2b999f, _0x19dbcb = await _0x3a0665['GrPiM'](fetchViaHTTP, appPort, _0x3a0665['jpaTh']), _0x4082c8 = await _0x19dbcb['json']();
            expect(_0x4082c8)[_0x5aafe0(0x183)]({ 'connection': _0x3a0665[_0x5aafe0(0x184)] });
        }), _0x5c9676['jSqww'](it, _0x2b999f(0x185), async () => {
            const _0x4bd501 = _0x2b999f, _0x4cfd0b = await _0x3a0665[_0x4bd501(0x186)](_0x359954, appPort, _0x4bd501(0x187)), _0x93f6bf = await _0x4cfd0b['elementById']('props')[_0x4bd501(0x188)](), _0x5717c5 = JSON[_0x4bd501(0x189)](_0x93f6bf);
            ...
            const _0x384d6a = _0x2b999f, _0x3a6ba9 = await _0x3a0665[_0x384d6a(0x186)](_0x359954, appPort, _0x3a0665['ncARn']), _0xac1437 = await _0x3a6ba9['elementById'](_0x3a0665[_0x384d6a(0x18c)])[_0x384d6a(0x188)](), _0x13a9c3 = JSON[_0x384d6a(0x189)](_0xac1437);
            ...
            const _0x1ca578 = _0x2b999f, _0x450a55 = await _0x3a0665[_0x1ca578(0x186)](_0x359954, appPort, _0x3a0665[_0x1ca578(0x190)]), _0x5581b2 = await _0x450a55['elementById'](_0x3a0665[_0x1ca578(0x18c)])['text'](), _0x3b630b = JSON[_0x1ca578(0x189)](_0x5581b2);
