const _0x42fe = ['try', 'var', 'new', 'this', 'super', 'export', 'true', 'false', 'instanceof', 'typeof', 'void', 'delete', '21677qrrDcI', '438509KQznDe', '1USccNy', '1KZsgwZ', '503777CNuwZC', '443001pWGcZs', '48142POBDxk', '10SxnLPF', '153208mYRIPI', '481369iemTiy', '6|0|3|5|4|8|7|1|2|9', 'split', 'keyword', 'postfix', 'binop', 'beforeExpr', 'isLoop', 'startsExpr', 'label', 'isAssign', 'updateContext', 'num', 'regexp', 'string', 'name', 'eof', 'template', 'invalidTemplate', '!/~', '</>/<=/>=', 'break', 'case', 'catch', 'continue', 'debugger', 'default', 'else', 'for', 'function', 'switch'];
...
(function (_0x45e5f1, _0x57a61f) {
    ...
    while (true) {
        try {
            ...
            if (_0x18b6d1 === _0x57a61f) break;else _0x45e5f1.push(_0x45e5f1.shift());
        } catch (_0x3db247) {
...
function _0x1882(_0x90b6e8, _0x1e680b) {
    return _0x1882 = function (_0x3a80b1, _0x211330) {
        _0x3a80b1 = _0x3a80b1 - 350;
        const _0x5cb2a9 = _0x42fe[_0x3a80b1];
...
export class TokenType {
    constructor(_0x468c5a, _0x67bde4 = {}) {
        const _0x29af86 = _0x1882;
        const _0x371ad0 = { 'lsLsZ': _0x29af86(0x168) };

        const _0x60ca72 = _0x371ad0.lsLsZ[_0x29af86(0x169)]('|');
...
export const types = {
    ...
    'bitwiseAND': binop('&', 5),
    'equality': binop('==/!=/===/!==', 6),
    'relational': binop(_0x26616b(0x17b), 7),
    'bitShift': binop('<</>>/>>>', 8),
    ...
    '_finally': kw('finally'),
    '_for': kw(_0x26616b(0x183), { 'isLoop': true }),
