const _0x30de = ['rBGIB', 'restore', 'oPiQC', 'xXCEF', 'equal', 'ZcHqm', 'registry', 'calledWith', '132716cGFKPS', '1lyCGKE', '58000dYqwoO', '53659nZxFTL', '13bDUZWW', '290lhiicm', '3525lyBXIH', '24ruGJvl', '5699qxWOwu', '414272rykNUA', '1633257zGVrkP', 'should', 'sinon', '../../../core/frontend/services/routing', '../../../core/frontend/meta/rss-url', 'getRssUrl', '/rss/', 'should return rss url', 'stub', 'BMGvV', 'returns', 'wtxrJ'];
...
(function (_0x486a6f, _0x18c138) {
    ...
    while (true) {
        try {
            ...
            if (_0x43ad35 === _0x18c138) break;else _0x486a6f.push(_0x486a6f.shift());
        } catch (_0x5d100a) {
...
const should = require(_0x5787c1(0xdf));

const sinon = require(_0x5787c1(0xe0));

const routing = require(_0x5787c1(0xe1));

const getRssUrl = require(_0x5787c1(0xe2));

function _0x1e65(_0x251d54, _0x557c17) {
    return _0x1e65 = function (_0x160e06, _0x1da783) {
        _0x160e06 = _0x160e06 - 212;
        const _0x31051f = _0x30de[_0x160e06];

        return _0x31051f;
    }, _0x1e65(_0x251d54, _0x557c17);
}
describe(_0x5787c1(0xe3), function () {
    const _0x454594 = _0x5787c1;
    const _0x125c13 = {
        'BMGvV': 'getRssUrl',
    ...
    _0x125c13.KATvl(beforeEach, function () {
        ...
        const _0x3d4fd0 = _0x454594;

        const _0x59e9de = _0x125c13.fucTT(getRssUrl, { 'secure': false });

        should[_0x3d4fd0(0xee)](_0x59e9de, _0x125c13[_0x3d4fd0(0xe9)]);
    }), _0x125c13[_0x454594(0xec)](it, 'forwards absolute/secure flags', function () {
        const _0x3ca5e3 = _0x454594;

        const _0x3d2f8d = _0x125c13[_0x3ca5e3(0xef)](getRssUrl, { 'secure': false }, true);
