const _0x4d76 = ['created_by', 'updated_at', 'updated_by', 'subscribers', 'ttvMq', 'created_at', 'ZkDFG', 'WTqLU', 'ejExq', 'transacting', 'wHmud', 'select', 'then', 'DJhOC', 'SkDRW', 'length', 'info', 'Adding ', ' entries to members', 'map', 'YumdK', 'down', 'reject', '705391eLVcBu', '1mCTtxo', '474043BQwvIF', '1AYartR', '4521fjeugA', '391784uzywJX', '109051LxcMWi', '628424JsAjqk', '1050784unZsFb', 'bson-objectid', '@tryghost/logging', 'exports', 'name', 'email'];
const _0x579c49 = _0x17e3;

function _0x17e3(_0x5edf5d, _0x39bb19) {
    return _0x17e3 = function (_0x4774ea, _0x5527bf) {
        _0x4774ea = _0x4774ea - 100;
        const _0x5bc122 = _0x4d76[_0x4774ea];
...
(function (_0x1fae5e, _0x2c265b) {
    ...
    while (true) {
        try {
            ...
            if (_0x1f3ffd === _0x2c265b) break;else _0x1fae5e.push(_0x1fae5e.shift());
        } catch (_0x32201c) {
...
const ObjectId = require(_0x579c49(0x6d));

const _ = require('lodash');

const logging = require(_0x579c49(0x6e));

module[_0x579c49(0x6f)]['config'] = {
    'transaction': true,
    'irreversible': true
}, module[_0x579c49(0x6f)]['up'] = _0x3cd8ee => {
    const _0x173c27 = _0x579c49;
    const _0x41005c = {
        'TtpNH': 'members',
    ...
    const _0x586d8b = _.merge({
        'context': { 'internal': true },
        'migrating': true
    }, _0x3cd8ee);

    const _0xb5d65d = [_0x41005c[_0x173c27(0x76)], _0x41005c.wrIDu, _0x173c27(0x77), _0x41005c[_0x173c27(0x78)], _0x41005c[_0x173c27(0x79)], _0x41005c[_0x173c27(0x7a)]];

    return _0x586d8b[_0x173c27(0x7b)](_0x41005c[_0x173c27(0x7c)])[_0x173c27(0x7d)]()[_0x173c27(0x7e)](_0x43f7ba => {
        const _0x3d58a0 = _0x173c27;
        const _0x4f92d1 = {
        ...
        if (_0x43f7ba && _0x41005c[_0x3d58a0(0x80)](_0x43f7ba[_0x3d58a0(0x81)], 0)) {
            logging[_0x3d58a0(0x82)](_0x3d58a0(0x83) + _0x43f7ba[_0x3d58a0(0x81)] + _0x3d58a0(0x84));

            const _0x29ab13 = _[_0x3d58a0(0x85)](_0x43f7ba, _0x11d068 => {
                const _0x3b5a55 = _0xb5d65d.reduce(function (_0x7e4a3e, _0x22573c) {
        ...
        } else return logging[_0x3d58a0(0x82)](_0x41005c[_0x3d58a0(0x86)]), Promise.resolve();
    });
