...
const _0x1065 = ['../../../../../../../../../../lib/plugins/aws/provider', '../../../../../../../../../utils/run-serverless', 'us-east-1', 'first', '$connect', 'auth', ':apigateway:', ':lambda:path/2015-03-31/functions/', 'AuthLambdaFunction', 'Arn', '/invocations', 'route.request.header.Auth', 'arn:aws:auth', 'AWS::Partition', 'route.request.querystring.Auth', '$default', 'Array', 'should support the simplified string syntax', 'should support the extended object syntax', 'should add authorizer config when authorizer is specified as an object', 'should ignore non-websocket events', 'Yexmu', 'setProvider', 'cJaZa', 'serverless', 'service', 'validate', 'CifTT', 'events', 'deep', 'equal', 'bnBXI', 'vmfGC', 'XXsUO', 'functions', 'oLvAc', 'efgQt', 'rfVwJ', 'arn:', 'Goaud', 'PSJPG', 'xIrCJ', 'ixyGk', 'PWyFu', 'BPgyN', 'NJXQW', 'AWS::Region', 'rsJJx', 'osimB', 'hNqNp', 'TtBVK', 'yifcK', 'should add authorizer config when authorizer is specified as an object with arn', 'UCBwG', 'taUYY', 'JJFIf', 'ZDlWf', 'djoHa', 'with', '#validate() using runServerless util', 'function', 'arn', 'arnName', 'should use provided authorizer name when name field is supplied', 'YPQVH', 'cetND', 'index.handler', 'fZiZZ', 'Resources', 'OtVUq', 'getWebsocketsAuthorizerLogicalId', 'exist', 'Properties', 'Name', '120432IQuUKE', '5YuRMeY', '158993pkuLIu', '285159WUZBuW', '32345OPFNOM', '5WIBQoo', '47353KKHlLZ', '17IoXUce', '41835TsuLOB', '4HusUIc', '39549rORsgf', 'chai', 'expect', '../../../../../../../../../../lib/Serverless'];
const _0x388c49 = _0x19dc;

function _0x19dc(_0x4ab1d0, _0x4e7f1f) {
    return _0x19dc = function (_0x260d33, _0x54de71) {
        _0x260d33 = _0x260d33 - 499;
        const _0x4aa8ed = _0x1065[_0x260d33];
...
(function (_0x3e0780, _0xe3bc17) {
    ...
    while (true) {
        try {
            ...
            if (_0x5099fa === _0xe3bc17) break;else _0x3e0780.push(_0x3e0780.shift());
        } catch (_0x35659d) {
...
const expect = require(_0x388c49(0x1fe))[_0x388c49(0x1ff)];

const AwsCompileWebsocketsEvents = require('../../../../../../../../../../lib/plugins/aws/package/compile/events/websockets/index');

const Serverless = require(_0x388c49(0x200));

const AwsProvider = require(_0x388c49(0x201));

const runServerless = require(_0x388c49(0x202));

describe('#validate()', () => {
    const _0x1c1375 = _0x388c49;
    const _0x5ee39c = {
    ...
    _0x5ee39c.UCBwG(beforeEach, () => {
        ...
        _0x5ee39c.GkSCX(expect, _0x19545f[_0x2e6519(0x21d)]).to[_0x2e6519(0x21e)][_0x2e6519(0x21f)]([{
            ...
            'authorizer': {
                'name': 'auth',
                'uri': {
                    'Fn::Join': ['', [_0x2e6519(0x227), { 'Ref': 'AWS::Partition' }, _0x5ee39c[_0x2e6519(0x228)], { 'Ref': _0x5ee39c[_0x2e6519(0x229)] }, _0x5ee39c.taUYY, {
                        'Fn::GetAtt': [_0x5ee39c[_0x2e6519(0x22a)], _0x5ee39c.yifcK]
        ...
        expect(_0x302dcb[_0x2b0123(0x21d)]).to.deep.equal([{
            ...
            'authorizer': {
                ...
                'uri': {
                    'Fn::Join': ['', [_0x5ee39c.TtBVK, { 'Ref': _0x5ee39c[_0x2b0123(0x22e)] }, _0x5ee39c[_0x2b0123(0x228)], { 'Ref': _0x2b0123(0x22f) }, _0x5ee39c.taUYY, 'arn:aws:auth', _0x5ee39c[_0x2b0123(0x22b)]]]
                },
                ...
                'events': [{
                    'websocket': {
                        ...
                        'authorizer': {
                            ...
                            'identitySource': [_0x5ee39c[_0x2deb20(0x230)], _0x5ee39c[_0x2deb20(0x232)]]
                        }
                    }
                }]
            }
        ...
        expect(_0x4e8cb8[_0x2deb20(0x21d)]).to.deep[_0x2deb20(0x21f)]([{
            ...
            'authorizer': {
                'name': _0x5ee39c[_0x2deb20(0x226)],
                'uri': {
                    'Fn::Join': ['', [_0x5ee39c[_0x2deb20(0x233)], { 'Ref': _0x5ee39c[_0x2deb20(0x22e)] }, _0x5ee39c.Goaud, { 'Ref': _0x5ee39c[_0x2deb20(0x229)] }, _0x5ee39c.taUYY, {
                        'Fn::GetAtt': [_0x5ee39c.xIrCJ, _0x5ee39c[_0x2deb20(0x234)]]
                ...
                'events': [{
                    'websocket': {
                        ...
                        'authorizer': {
                            ...
                            'identitySource': [_0x5ee39c[_0x350ab9(0x230)], _0x5ee39c.hNqNp]
                        }
                    }
                }]
            }
        ...
        _0x5ee39c[_0x350ab9(0x236)](expect, _0x8de1c6.events).to[_0x350ab9(0x21e)][_0x350ab9(0x21f)]([{
            ...
            'authorizer': {
                ...
                'uri': {
                    'Fn::Join': ['', [_0x350ab9(0x227), { 'Ref': _0x5ee39c.NJXQW }, _0x5ee39c.Goaud, { 'Ref': _0x350ab9(0x22f) }, _0x5ee39c[_0x350ab9(0x237)], _0x5ee39c[_0x350ab9(0x22d)], _0x350ab9(0x20b)]]
                },
                'identitySource': [_0x350ab9(0x20c), _0x5ee39c[_0x350ab9(0x232)]],
        ...
        _0x5ee39c[_0x3c0ffb(0x236)](expect, _0xe0aa8[_0x3c0ffb(0x21d)]).to.be.an(_0x5ee39c[_0x3c0ffb(0x23a)])[_0x3c0ffb(0x23b)].length(0);
    });
}), describe(_0x388c49(0x23c), () => {
    const _0x2a8662 = _0x388c49;
    const _0x5619eb = {
        'rNmdr': 'authName',
    ...
    it(_0x5619eb[_0x2a8662(0x241)], async () => {
        const _0x533c3b = _0x2a8662;
        const _0x461d3d = _0x5619eb.rNmdr;
        var {
                        ...
                        'events': [{
                            'websocket': {
                                ...
                                'authorizer': {
                                    'name': _0x461d3d,
                                    'arn': {
                                        'Fn::Join': [':', [_0x5619eb[_0x533c3b(0x244)], _0x5619eb.COtdh]]
                                    }
                                }
                            }
                        }]
        ...
        const _0x260509 = _0xccf9f8[_0x533c3b(0x245)];

        const _0x482ab2 = _0x5b69fe;
