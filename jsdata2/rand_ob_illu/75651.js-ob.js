const _0x52b9 = ['Livechat_webhook_on_chat_queued', 'Livechat_webhook_on_offline_msg', 'ToMtx', 'sqKfL', 'UNSeh', 'mVpaF', 'tgjLL', 'wBgTV', 'CJhuc', 'lVZnH', 'NWiWJ', 'Livechat_webhook_on_forward', 'ozXvv', 'Livechat_webhook_on_visitor_message', 'dYOtJ', '15956NKgJnK', '47LMforb', '821293qLJnyY', '1302252GyczVg', '691701HafBYI', '18061djuWKc', '13uIiidQ', '250260FWxTFw', '144nqdDys', '11958aIPmdN', 'view-livechat-manager', 'Livechat_secret_token', 'Livechat_webhook_on_start', 'Livechat_webhook_on_chat_taken'];
...
(function (_0xd68a07, _0xfa1b83) {
    ...
    while (true) {
        try {
            ...
            if (_0x30460a === _0xfa1b83) break;else _0xd68a07.push(_0xd68a07.shift());
        } catch (_0x183d67) {
...
function _0x3be1(_0x276769, _0x4daeab) {
    return _0x3be1 = function (_0x149765, _0x5d5250) {
        _0x149765 = _0x149765 - 224;
        const _0x31761c = _0x52b9[_0x149765];
...
export async function findIntegrationSettings({ userId: _0x47dcbe }) {
    ...
    if (!(await _0x351e65[_0x5a63aa(0xf0)](hasPermissionAsync, _0x47dcbe, _0x351e65[_0x5a63aa(0xf1)]))) throw new Error(_0x351e65[_0x5a63aa(0xf2)]);

    const _0x45a76a = await Settings.findByIds([_0x351e65[_0x5a63aa(0xf3)], _0x351e65[_0x5a63aa(0xf4)], _0x351e65[_0x5a63aa(0xf5)], _0x351e65[_0x5a63aa(0xf6)], _0x351e65[_0x5a63aa(0xf7)], _0x351e65[_0x5a63aa(0xf8)], _0x5a63aa(0xf9), _0x351e65[_0x5a63aa(0xfa)], _0x5a63aa(0xfb), _0x351e65[_0x5a63aa(0xfc)]]).toArray();
