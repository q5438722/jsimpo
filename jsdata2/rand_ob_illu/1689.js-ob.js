const _0x22b6 = ['__VUE_DEVTOOLS_GLOBAL_HOOK__', 'vuex:action', 'vuex:init', 'vuex:travel-to-state', '_devtoolHook', 'emit', 'ohVeU', 'QXkEO', 'vuex:mutation', 'subscribeAction', 'tpOId', '352949rOYgmw', '212378TEYshx', '168213XDheLG', '28311PYRmmg', '2MBsEYM', '128283HwvxBy', '3NkhYnt', '424502nZeSVr', '707225bouDWH', 'undefined'];

function _0x39a5(_0x480fc1, _0x55f367) {
    return _0x39a5 = function (_0x269e09, _0x1adaed) {
        _0x269e09 = _0x269e09 - 356;
        const _0x23debb = _0x22b6[_0x269e09];
...
(function (_0x37f551, _0x3df8fd) {
    ...
    while (true) {
        try {
            ...
            if (_0x1b0005 === _0x3df8fd) break;else _0x37f551.push(_0x37f551.shift());
        } catch (_0x1441ef) {
            _0x37f551.push(_0x37f551.shift());
        }
    }
})(_0x22b6, 238366);
const target = typeof window !== _0x3d0df3(0x16d) ? window : typeof global !== 'undefined' ? global : {};

const devtoolHook = target[_0x3d0df3(0x16e)];

export default function devtoolPlugin(_0x17ea58) {
    const _0x58cc9d = _0x3d0df3;
    const _0x58685c = {
    ...
    }, { 'prepend': true }), _0x17ea58[_0x58cc9d(0x177)]((_0x34922f, _0x3167e5) => {
