...
const _0x16cc = ['oSYhG', 'log', 'Qacss', 'assertLog', 'LwBxj', 'task that finishes before deadline', 'rwHFK', 'fireSetImmediate', 'JFIGE', 'uPhKS', 'BXVAb', 'eGoWb', 'vKaYG', 'unstable_shouldYield', 'advanceTime', 'Yield at ', 'JgCTv', 'Task', 'mCCtT', 'LkBwl', 'GKpFj', '2|4|3|0|1', 'EHGbX', 'LDAbH', 'jECGZ', 'split', 'QLgpP', 'xmFBm', 'throws when a task errors then continues in a new event', 'CERSI', 'Xcxin', 'VgVPN', 'TdtCa', 'lOukm', 'toThrow', 'KeZFy', 'lKOSD', 'XBhKB', 'cBdXG', 'does not crash if setImmediate is undefined', 'pZAiW', 'wdxrL', 'DlsSi', 'not', '2FkOAHy', '200723rHpPsf', '144560Hxyswf', '504229pITpYd', '1OlhpxM', '274210mTnplJ', '43826mJKuxp', '6GSuQKA', '89006YaMPdb', '2JhjLYc', '990426kCNOML', 'SchedulerDOMSetImmediate', 'scheduler', 'Test exited without clearing log.', 'Message event already scheduled', 'Set Immediate', 'setImmediate Callback', 'Should not throw', 'Continuation', '3|4|0|2|1', 'Yay', 'task with continuation', 'multiple tasks', 'multiple tasks with a yield in between', 'cancels tasks', 'vYJnB', 'resetModules', 'unmock', 'performance', 'GfhNY', 'unstable_scheduleCallback', 'unstable_UserBlockingPriority', 'uLsny', 'isLogEmpty', 'MPjew', 'tKaJk', 'CKMrD', 'yCxkj', 'Set Timer', 'clearTimeout', 'MessageChannel', 'pPQBq', 'XxgDk', 'yhPsK', 'length', 'Log is not empty. Call assertLog before continuing.', 'No setImmediate was scheduled', 'Zvgwi', 'rziGY', 'push', 'toEqual', 'Qtzfb', 'does not use setImmediate override', 'setImmediate'];
...
(function (_0x327f6a, _0xd9221) {
    ...
    while (true) {
        try {
            ...
            if (_0x56e67b === _0xd9221) break;else _0x327f6a.push(_0x327f6a.shift());
        } catch (_0x5a2a9c) {
...
function _0x28bd(_0x635097, _0x5370fa) {
    return _0x28bd = function (_0x295717, _0x4b6b13) {
        _0x295717 = _0x295717 - 231;
        const _0x5bb39e = _0x16cc[_0x295717];

        return _0x5bb39e;
    }, _0x28bd(_0x635097, _0x5370fa);
}
describe(_0xfac560(0xf2), () => {
    const _0x5608f9 = _0xfac560;
    const _0x4a6a18 = {
    ...
    _0x4a6a18[_0x5608f9(0x100)](beforeEach, () => {
        ...
        if (!runtime[_0x346075(0x108)]()) throw _0x4a6a18[_0x346075(0x109)](Error, _0x4a6a18[_0x346075(0x10a)]);
    });
    function _0x11f77c() {
        const _0x4e9fdd = _0x5608f9;
        const _0x396997 = {
        ...
        global[_0x4e9fdd(0x103)] = {
            ...
            const _0x28db5d = _0x4e9fdd;

            const _0x1ce84d = _0x1dbec1++;

            return _0x5b2cfe(_0x28db5d(0x10d)), _0x1ce84d;
        }, global[_0x4e9fdd(0x10e)] = _0x1e84fb => {}, global[_0x4e9fdd(0x10f)] = function () {
        ...
        global['setImmediate'] = function (_0x228bfa) {
            ...
            if (_0x3273f0) throw _0x396997.McEEr(Error, _0x396997[_0x33b40c(0x111)]);
            _0x5b2cfe(_0x396997[_0x33b40c(0x112)]), _0x3273f0 = _0x228bfa;
        };
        function _0x966950() {
            const _0x1394e1 = _0x4e9fdd;

            if (_0x4a6a18.jmvlH(_0x3b3649[_0x1394e1(0x113)], 0)) throw Error(_0x1394e1(0x114));
        }
        ...
        function _0x511ecc() {
            ...
            const _0x1394e1 = _0x4e9fdd;
            if (_0x4a6a18.jmvlH(_0x3b3649[_0x1394e1(0x113)], 0)) throw Error(_0x1394e1(0x114));
            if (!_0x3273f0) throw Error(_0x185bca(0x115));
        ...
        function _0x4cef01() {
            return _0x3b3649.length === 0;
        }
        function _0x291e57(_0x4f3853) {
            const _0x3e8e72 = _0x4e9fdd;
            const _0x1f6650 = _0x3b3649;
    ...
    _0x4a6a18[_0x5608f9(0x11a)](it, _0x5608f9(0x11b), () => {
        ...
        }), runtime[_0x3de2fc(0x120)]([_0x4a6a18[_0x3de2fc(0x10c)]]), runtime.fireSetImmediate(), runtime.assertLog([_0x4a6a18[_0x3de2fc(0x121)], 'Task']);
    }), _0x4a6a18[_0x5608f9(0x11a)](it, _0x5608f9(0x122), () => {
        const _0x5eaef3 = _0x5608f9;
        const _0x5cd99c = { 'onOfE': _0x4a6a18[_0x5eaef3(0x123)] };
        ...
        }), runtime[_0x5eaef3(0x120)]([_0x4a6a18.yCxkj]), runtime[_0x5eaef3(0x124)](), runtime[_0x5eaef3(0x120)](['setImmediate Callback', _0x4a6a18.rwHFK]);
    }), _0x4a6a18[_0x5608f9(0x125)](it, _0x4a6a18[_0x5608f9(0x126)], () => {
        const _0x4e4ab8 = _0x5608f9;
        const _0x3d0b8b = {
        ...
        _0x4a6a18[_0x4e4ab8(0x127)](scheduleCallback, NormalPriority, () => {
            const _0x51322c = _0x4e4ab8;
            const _0x2a4364 = { 'JgCTv': _0x3d0b8b[_0x51322c(0x128)] };

            runtime.log(_0x3d0b8b[_0x51322c(0x129)]);
            while (!Scheduler[_0x51322c(0x12a)]()) {
                runtime[_0x51322c(0x12b)](1);
            }
        ...
        }), runtime.assertLog([_0x4a6a18[_0x4e4ab8(0x10c)]]), runtime[_0x4e4ab8(0x124)](), runtime[_0x4e4ab8(0x120)]([_0x4a6a18[_0x4e4ab8(0x121)], _0x4e4ab8(0x12e), _0x4a6a18[_0x4e4ab8(0x12f)], _0x4a6a18[_0x4e4ab8(0x10c)]]), runtime[_0x4e4ab8(0x124)](), runtime[_0x4e4ab8(0x120)]([_0x4a6a18[_0x4e4ab8(0x121)], _0x4a6a18[_0x4e4ab8(0x130)]]);
    }), _0x4a6a18.EHGbX(it, _0x4a6a18[_0x5608f9(0x131)], () => {
        const _0x14cdcd = _0x5608f9;

        const _0x1173ce = _0x14cdcd(0x132).split('|');
        ...
        while (true) {
            switch (_0x1173ce[_0x268fdf++]) {
                case '0':
                    ...
                    continue;
                case '1':
                    runtime[_0x14cdcd(0x120)]([_0x4a6a18.LwBxj, 'A', 'B']);
                    continue;
                case '2':
        ...
        const _0x5e43f5 = _0x5608f9;

        const _0x34bbdc = _0x4a6a18[_0x5e43f5(0x135)][_0x5e43f5(0x136)]('|');
        ...
        while (true) {
            switch (_0x34bbdc[_0x714bab++]) {
                case '0':
                    ...
                    continue;
                case '1':
                    runtime[_0x5e43f5(0x120)]([_0x4a6a18[_0x5e43f5(0x121)], 'B', 'A']);
                    continue;
                case '2':
        ...
        scheduleCallback(NormalPriority, () => {
            ...
            runtime[_0xef6020(0x11e)]('A'), runtime.advanceTime(4999);
        }), _0x4a6a18[_0x48f153(0x138)](scheduleCallback, NormalPriority, () => {
            const _0x80b47e = _0x48f153;

            runtime[_0x80b47e(0x11e)]('B');
        }), runtime[_0x48f153(0x120)]([_0x4a6a18[_0x48f153(0x10c)]]), runtime[_0x48f153(0x124)](), runtime.assertLog([_0x4a6a18[_0x48f153(0x121)], 'A', _0x4a6a18[_0x48f153(0x10c)]]), runtime[_0x48f153(0x124)](), runtime.assertLog([_0x4a6a18[_0x48f153(0x121)], 'B']);
    }), _0x4a6a18.lKOSD(it, _0x4a6a18.zqTtX, () => {
        const _0x5c844d = _0x5608f9;
        const _0x4aafe2 = { 'QkBdV': _0x4a6a18[_0x5c844d(0x123)] };

        const _0x118285 = _0x4a6a18.xmFBm(scheduleCallback, NormalPriority, () => {
        ...
        }), runtime[_0x1e9983(0x120)]([_0x4a6a18.yCxkj]), _0x4a6a18[_0x1e9983(0x100)](expect, () => runtime[_0x1e9983(0x124)]())[_0x1e9983(0x13f)]('Oops!'), runtime[_0x1e9983(0x120)]([_0x4a6a18.LwBxj, _0x4a6a18.CERSI, _0x1e9983(0xf6)]), runtime[_0x1e9983(0x124)](), runtime[_0x1e9983(0x120)]([_0x4a6a18[_0x1e9983(0x121)], _0x4a6a18[_0x1e9983(0x140)]]);
    }), _0x4a6a18[_0x5608f9(0x141)](it, _0x4a6a18.jDlLd, () => {
        const _0x3b951e = _0x5608f9;

        const _0x1942e2 = '1|2|6|0|3|4|7|5'[_0x3b951e(0x136)]('|');
        ...
        while (true) {
            switch (_0x1942e2[_0x4c1856++]) {
                case '0':
                    runtime.assertLog([_0x4a6a18[_0x3b951e(0x121)], 'A']);
                    continue;
                case '1':
                ...
                case '4':
                    ...
                    continue;
                case '5':
                    runtime.assertLog([_0x3b951e(0xf7), 'B']);
                    continue;
                case '6':
        ...
        const _0x12ec53 = _0x5608f9;

        const _0x356274 = _0x4a6a18[_0x12ec53(0x11a)](scheduleCallback, NormalPriority, () => {
        ...
        runtime[_0x12ec53(0x120)]([_0x4a6a18[_0x12ec53(0x10c)]]), _0x4a6a18[_0x12ec53(0x100)](cancelCallback, _0x356274), runtime.fireSetImmediate(), runtime[_0x12ec53(0x120)]([_0x12ec53(0xf7)]), scheduleCallback(NormalPriority, () => {
            runtime.log('B');
        }), runtime[_0x12ec53(0x120)]([_0x12ec53(0xf6)]), runtime[_0x12ec53(0x124)](), runtime[_0x12ec53(0x120)]([_0x4a6a18[_0x12ec53(0x121)], 'B']);
    });
}), it(_0xfac560(0x144), () => {
    const _0x585a69 = _0xfac560;
    const _0x4a3f03 = {
