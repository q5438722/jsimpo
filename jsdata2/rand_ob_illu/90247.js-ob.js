const _0x5a0e = ['#ff8b50', '#5FB3B3', '#fc929e', '#79b6f2', '#FAC863', '#6699CC', 'dark', 'white', 'keyword', 'comment', 'primitive', 'boolean', 'tag', 'string', 'char', 'className', '57642Jovdzn', '9TyvITx', '9HUXkSR', '43987IIAMfc', '19645mBzgrD', '769626bCELdV', '280754AGsVZk', '137598pvIlCC', '1523318GAuEbI', '#282c34', '#ffffff', '#D8DEE9', '#c5a5c5', '#14161a', '#8dc891'];
...
(function (_0xb1fcc9, _0x37c637) {
  ...
  while (true) {
    try {
      ...
      if (_0x505494 === _0x37c637) break;else _0xb1fcc9.push(_0xb1fcc9.shift());
    } catch (_0x235bf7) {
...
function _0x10eb(_0x56cf02, _0x24c476) {
  return _0x10eb = function (_0x1fa977, _0x2018b6) {
    _0x1fa977 = _0x1fa977 - 497;
    const _0x23e261 = _0x5a0e[_0x1fa977];
