...
const _0x5052 = ['dirname', 'yoVeo', 'OUkKX', 'generated.js', 'generator', 'SDhKC', 'vDHNl', 'PIkkF', 'prototype', '_addGeneratedMap', 'addSourceContent', '_addExistingMap', 'wfgMh', 'sources', 'length', 'sourcesContent', 'forEach', 'addMappings', 'source', 'addFile', '1|2|3|0|4', 'line', 'column', 'split', 'zjJaI', 'hasOwnProperty', 'sourceFile', 'base64', 'create', 'mapFileCommentRegex', '315299hyHGiR', '2474GlkGOw', '114016OstRJJ', '27743BMBUWc', '1CpmULP', '1DoCpsT', '212083LbXsYg', '223944EeafaG', '4867hjHcio', '28fTqUCL', 'path', 'lodash.memoize', 'inline-source-map', './lib/path-is-absolute', './lib/mappings-from-map', '2|5|3|1|0|4', 'Phqgh', 'GDsKK', 'ngilS', 'test', 'replace', 'join'];
const _0x9c4319 = _0x2d03;

(function (_0x4aaf25, _0x448e56) {
    const _0x8b06f3 = _0x2d03;

    while (true) {
        try {
            const _0x262395 = -parseInt(_0x8b06f3(0x163)) + parseInt(_0x8b06f3(0x164)) + -parseInt(_0x8b06f3(0x165)) + -parseInt(_0x8b06f3(0x166)) * -parseInt(_0x8b06f3(0x167)) + parseInt(_0x8b06f3(0x168)) * parseInt(_0x8b06f3(0x169)) + parseInt(_0x8b06f3(0x16a)) + -parseInt(_0x8b06f3(0x16b)) * -parseInt(_0x8b06f3(0x16c));

            if (_0x262395 === _0x448e56) break;else _0x4aaf25.push(_0x4aaf25.shift());
        } catch (_0x21a115) {
...
const path = require(_0x9c4319(0x16d));

const convert = require('convert-source-map');

const memoize = require(_0x9c4319(0x16e));

const createGenerator = require(_0x9c4319(0x16f));

const pathIsAbsolute = require(_0x9c4319(0x170));

const mappingsFromMap = require(_0x9c4319(0x171));

const protocolRx = /^[a-z]+:\/\//;
const rebaseRelativePath = memoize(function (_0x7317b0, _0x568350, _0x3cf7c) {
    const _0x27ec95 = _0x9c4319;
    const _0x4f4375 = {
    ...
    const _0x2ff107 = _0x4f4375[_0x27ec95(0x173)].split('|');
    ...
    while (true) {
        switch (_0x2ff107[_0x266b1c++]) {
            case '0':
                if (_0x4f4375[_0x27ec95(0x174)](_0x7317b0, _0x39908d) || _0x4f4375[_0x27ec95(0x175)](pathIsAbsolute, _0x39908d) || protocolRx[_0x27ec95(0x176)](_0x39908d)) return _0x39908d;
                continue;
            case '1':
                _0x7317b0 = _0x7317b0.replace(/\\/g, '/');
                continue;
            case '2':
                if (!_0x3cf7c) return _0x3cf7c;
                continue;
            case '3':
...
function _0x2d03(_0x295b45, _0x412e34) {
    return _0x2d03 = function (_0x588a1e, _0x35ce0f) {
        _0x588a1e = _0x588a1e - 355;
        const _0x448aee = _0x5052[_0x588a1e];

        return _0x448aee;
    }, _0x2d03(_0x295b45, _0x412e34);
}
function resolveMap(_0x20db82) {
    const _0x19c1f3 = convert.fromSource(_0x20db82);

    return _0x19c1f3 ? _0x19c1f3.toObject() : null;
}
function hasInlinedSource(_0x270c25) {
    return _0x270c25.sourcesContent && !!_0x270c25.sourcesContent[0];
}
function Combiner(_0x262312, _0x15cf61) {
    const _0x188f5b = _0x9c4319;
    const _0x4e73ba = {
...
Combiner[_0x9c4319(0x181)][_0x9c4319(0x182)] = function (_0x1783f5, _0x4c0369, _0x272007) {
    ...
    const _0x27c1fa = _0x503e58[_0x5c725b(0x185)](mappingsFromMap, _0xafca83);

    for (var _0x4ddf86 = 0, _0x5b7f9d = _0xafca83[_0x5c725b(0x186)][_0x5c725b(0x187)]; _0x4ddf86 < _0x5b7f9d; _0x4ddf86++) {
        if (!_0xafca83[_0x5c725b(0x188)]) continue;
    ...
    const _0x465016 = _0x2abec7.lgpFH[_0x50fa81(0x190)]('|');
    ...
    while (true) {
        switch (_0x465016[_0x20e9f6++]) {
            case '0':
                const _0x39aaf3 = _0x2abec7[_0x50fa81(0x191)](resolveMap, _0x9b2db0[_0x50fa81(0x18b)]);
            ...
            case '1':
                ...
                continue;
            case '2':
                if (!_0x16fe49[_0x50fa81(0x192)](_0x2abec7.rayfX)) _0x16fe49[_0x50fa81(0x18e)] = 0;
                continue;
            case '3':
                if (!_0x16fe49[_0x50fa81(0x192)](_0x2abec7.lLcbc)) _0x16fe49[_0x50fa81(0x18f)] = 0;
                continue;
            case '4':
    ...
    const _0x4dca52 = _0x9c4319;

    if (!_0x3eafa0[_0x4dca52(0x177)]) return _0x3eafa0;
