const _0x3629 = ['AOqSJ', 'registerRouter', 'bVgXN', 'use', 'checkIsPrivate', 'filterPrivateRoutes', '9SGYaQu', '98391PiUbRG', '702492ArzxgD', '4998GsmmeV', '62QbGKET', '708810cUJEBT', '927146vTCWTw', '1kznHhG', '605638sRVeXs', '1FRszXw', '1230868yGrlBI', '../../../shared/url-utils', '@tryghost/logging', '@tryghost/errors', './lib/middleware', './lib/router', 'private', 'errors.config.urlCannotContainPrivateSubdir.error', 'getSubdir', 'split', 'pop', 'error', 'GhostError', 'hijtj', 'errors.config.urlCannotContainPrivateSubdir.description', 'exports'];
const _0x26ca91 = _0x4584;

function _0x4584(_0x23fe1f, _0xa94956) {
    return _0x4584 = function (_0x2d257d, _0x7aff07) {
        _0x2d257d = _0x2d257d - 182;
        const _0x20c32e = _0x3629[_0x2d257d];
...
(function (_0x876d47, _0x1d222f) {
    ...
    while (true) {
        try {
            ...
            if (_0x19a9bf === _0x1d222f) break;else _0x876d47.push(_0x876d47.shift());
        } catch (_0x21deb3) {
...
var { i18n } = require('../../services/proxy');

const urlUtils = require(_0x26ca91(0xc1));

const logging = require(_0x26ca91(0xc2));

const errors = require(_0x26ca91(0xc3));

const middleware = require(_0x26ca91(0xc4));

const router = require(_0x26ca91(0xc5));

const registerHelpers = require('./lib/helpers');

const PRIVATE_KEYWORD = _0x26ca91(0xc6);

const checkSubdir = function checkSubdir() {
    const _0x4c0af5 = _0x26ca91;
    const _0x350e8c = {
...
module[_0x26ca91(0xcf)] = {
    'activate': function activate(_0x949ef4) {
        ...
        const _0x9babef = '/' + PRIVATE_KEYWORD + '/';
