...
const _0x50ed = ['1hNKysk', '1331080VMWcka', '1IcaGRs', '67040siiuxr', '2393595FgezEN', 'path', 'fs-extra', '../utils/fs', 'join', 'fixtures/individually', 'fixtures/artifact', 'Integration test - Packaging - CloudFormation', '.serverless/cloudformation-template-update-stack.json', 'AWS::Lambda::Function', 'ServerlessDeploymentBucket', 'aws-nodejs-dev-hello', 'nodejs12.x', 'IamRoleLambdaExecution', 'aws-nodejs-us-east-1-custom-name', 'package artifact directive works', 'tmeQx', 'NLsne', 'ncafQ', 'YpwUu', ' package', 'parse', 'readFileSync', 'uhCLw', 'Resources', 'HelloLambdaFunction', 'Properties', 'Code', 'S3Key', 'GIQlC', 'deep', 'equal', 'exkZK', 'PDneM', 'Arn', 'oFUDx', 'IlzpZ', 'creates the correct default function resource in cfn template', 'regular', 'kyvNO', 'jYuBi', 'copySync', 'AeQik', 'MNPym', 'Hello2LambdaFunction', 'ikwFn', 'CMTue', 'CustomDashnameLambdaFunction', 'FunctionName', 'bomzL', '755468iSGibF', '1272916nDfpws', '635728LTawsN', '1kSSdCs', '772498klOwfk'];
...
(function (_0x540a62, _0x30e2f8) {
    ...
    while (true) {
        try {
            ...
            if (_0x4f3568 === _0x30e2f8) break;else _0x540a62.push(_0x540a62.shift());
        } catch (_0x3784a6) {
...
function _0x4aa8(_0x5495d5, _0x12424d) {
    return _0x4aa8 = function (_0x3de62b, _0x300d17) {
        _0x3de62b = _0x3de62b - 109;
        const _0x319db8 = _0x50ed[_0x3de62b];
...
const path = require(_0x17af96(0x77));

var { expect } = require('chai');

const fse = require(_0x17af96(0x78));

var { execSync } = require('../utils/childProcess');

const serverlessExec = require('../serverlessBinary');

var { getTmpDirPath } = require(_0x17af96(0x79));
...
describe(_0x17af96(0x7d), () => {
    ...
    _0x379788[_0x186647(0x86)](beforeEach, () => {
        ...
        _0x379788.GIQlC(expect, _0x2bfa39[_0x166196(0x8e)][_0x166196(0x8f)][_0x166196(0x90)][_0x166196(0x91)][_0x166196(0x92)]).to.match(/serverless\/aws-nodejs\/dev\/[^]*\/artifact.zip/), delete _0x2bfa39[_0x166196(0x8e)][_0x166196(0x8f)].Properties[_0x166196(0x91)][_0x166196(0x92)], _0x379788[_0x166196(0x93)](expect, _0x2bfa39.Resources[_0x166196(0x8f)]).to[_0x166196(0x94)][_0x166196(0x95)]({
            ...
            'Properties': {
                ...
                'MemorySize': 0x400,
                'Role': {
                    'Fn::GetAtt': ['IamRoleLambdaExecution', _0x166196(0x98)]
                },
        ...
        fse.copySync(fixturePaths[_0x5a663c(0x9c)], _0x9d8895), _0x379788[_0x5a663c(0x89)](execSync, serverlessExec + ' package', { 'cwd': _0x9d8895 });
    ...
    }), _0x379788[_0x186647(0x9e)](it, 'handles package individually with include/excludes correctly', () => {
        const _0x2243dd = _0x186647;

        fse[_0x2243dd(0x9f)](fixturePaths.individually, _0x9d8895), _0x379788[_0x2243dd(0xa0)](execSync, serverlessExec + ' package', { 'cwd': _0x9d8895 });
        ...
        _0x379788.hPuQf(expect, _0x3821c8[_0x2243dd(0x8e)].HelloLambdaFunction[_0x2243dd(0x90)][_0x2243dd(0x91)].S3Key).to.match(/serverless\/aws-nodejs\/dev\/[^]*\/hello.zip/), _0x379788[_0x2243dd(0xa1)](expect, _0x3821c8[_0x2243dd(0x8e)][_0x2243dd(0xa2)][_0x2243dd(0x90)].Code[_0x2243dd(0x92)]).to.match(/serverless\/aws-nodejs\/dev\/[^]*\/hello2.zip/), delete _0x3821c8[_0x2243dd(0x8e)][_0x2243dd(0x8f)][_0x2243dd(0x90)][_0x2243dd(0x91)][_0x2243dd(0x92)], _0x379788[_0x2243dd(0xa1)](expect, _0x3821c8[_0x2243dd(0x8e)][_0x2243dd(0x8f)]).to[_0x2243dd(0x94)][_0x2243dd(0x95)]({
            ...
            'Properties': {
                ...
                'MemorySize': 0x400,
                'Role': {
                    'Fn::GetAtt': [_0x2243dd(0x83), _0x379788[_0x2243dd(0xa4)]]
                },
