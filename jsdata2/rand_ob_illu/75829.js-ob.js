const _0x34df = ['writeHead', 'data', 'write', 'bind', 'pipe', 'Webdav:Uploads', 'Webdav:Avatars', 'Webdav:UserDataFiles', 'debounce', 'FileUpload_Webdav_Server_URL', 'FileUpload_Webdav_Username', 'Webdav', 'FileUpload_Webdav_Upload_Folder_Path', 'get', 'inRuh', 'NZtke', 'FileUpload_Webdav_Password', 'CtLWX', 'Ocmvo', 'name', 'configureUploadsStore', '60327IjppNi', '1LEFvRI', '1mbHGlJ', '1063151MaTtlt', '1021427hNhtOv', '1yiaXnC', '3HIajYv', '78487AWTeGf', '181272lcqaRd', '17233AjQBII', '17nAvpcJ', '172yLXNEt', '4789TPoqSm', 'end', 'store', 'getReadStream', '_id', 'tuXyI'];
...
(function (_0x7c3585, _0x38195a) {
    ...
    while (true) {
        try {
            ...
            if (_0x20e88f === _0x38195a) break;else _0x7c3585.push(_0x7c3585.shift());
        } catch (_0xcee749) {
...
function _0xe173(_0x140544, _0xc3690f) {
    return _0xe173 = function (_0x1662e5, _0x3887b0) {
        _0x1662e5 = _0x1662e5 - 297;
        const _0x1a5db0 = _0x34df[_0x1662e5];
...
const get = function (_0x59da5a, _0x2f5bda, _0x2dd93a) {
    const _0x395099 = _0xe173;
    const _0x5849a5 = {
        'tuXyI': 'An error ocurred when fetching the file',
    ...
    this[_0x395099(0x137)][_0x395099(0x138)](_0x59da5a[_0x395099(0x139)], _0x59da5a).on('error', () => {
        ...
        console.error(_0x5849a5[_0x3990da(0x13a)]), _0x2dd93a[_0x3990da(0x13b)](503), _0x2dd93a[_0x3990da(0x136)]();
...
const copy = function (_0x39bb4f, _0x45add0) {
...
const configure = _0x31aeca[_0x386127(0x143)](function () {
    const _0x501db5 = _0x386127;
    const _0x5123a6 = {
    ...
    const _0x2c800c = settings.get(_0x501db5(0x147));

    const _0x4fd0eb = settings[_0x501db5(0x148)](_0x5123a6[_0x501db5(0x149)]);

    const _0x16bd53 = settings.get(_0x5123a6[_0x501db5(0x14a)]);

    const _0x10ad97 = settings[_0x501db5(0x148)](_0x501db5(0x14b));

    if (_0x5123a6[_0x501db5(0x14c)](!_0x4fd0eb, !_0x16bd53) || !_0x10ad97) return;
    const _0x3d7f8b = {
        'connection': {
            'credentials': {
                'server': _0x4fd0eb,
