const _0xa74f = ['NODE_ENV', 'production', 'VDBqr', 'does not send page view when ga is undefined', 'toHaveBeenCalled', '/test-pages/**', 'rIhMy', '/test-pages/example', 'runAllTimers', 'EHWDs', 'sends page view', 'toHaveBeenCalledTimes', 'any', 'WZGnH', 'uses setTimeout with the provided pageTransitionDelay value', 'PGrEx', 'ZKdtM', 'naupo', 'resolve', 'event', 'jyaUZ', 'toBeCalledWith', 'send', 'objectContaining', 'Web Vitals', 'toBeCalledTimes', 'xrWLB', 'FOxvd', 'sends nothing when web vitals tracking is disabled', 'tRlzk', 'split', 'toBeCalled', 'zHfHX', '247994OAdzUv', '1ZrPnmr', '243581wCrfDo', '549881xsKfxk', '759333PaKVWW', '119082UtEgdr', '15TDBxio', '38355ZkKsFz', '2279282PYEfIj', 'mock', 'web-vitals/base', 'jYMeP', 'XDSKI', '300', 'FID', '150', 'GYZPi', 'CLS', '0.10', 'gatsby-plugin-google-analytics', '5|0|1|7|4|2|3|6', 'xjqEq', 'gatsby-browser', 'kydBM', 'mymnB', 'XCKcZ', 'cnoox', 'ADtAQ', 'IvrGy', 'XjqqC', 'PtIvH', 'cGoSi', 'qpBVL', 'UMEbX', 'ypzUY', 'in non-production env', 'does not send page view', 'wQuBL', 'not', 'kHERM', 'cGICU', 'ZTJLM', 'NReid', 'env'];
...
(function (_0x24918c, _0xac4224) {
    ...
    while (true) {
        try {
            ...
            if (_0x1030c2 === _0xac4224) break;else _0x24918c.push(_0x24918c.shift());
        } catch (_0x14f0a5) {
...
function _0x1cfc(_0x304b77, _0x35d45c) {
    return _0x1cfc = function (_0x1c2eee, _0x16dea7) {
        _0x1c2eee = _0x1c2eee - 282;
        const _0x5e8dc0 = _0xa74f[_0x1c2eee];
    ...
    _0x1b2687[_0x117276(0x12f)](describe, _0x117276(0x130), () => {
        ...
        _0x1b2687[_0x677402(0x12f)](describe, 'onRouteUpdate', () => {
            ...
            _0x24cfb0[_0x4e00ad(0x13c)](describe, _0x4e00ad(0x13d), () => {
                ...
                _0x24cfb0[_0x4b4c5c(0x138)](beforeAll, () => {
                ...
                }), _0x24cfb0.WZGnH(it, 'does not send page view when path is excluded', () => {
                    const _0x17ec8e = _0x4b4c5c;

                    const _0x51e717 = new Minimatch(_0x17ec8e(0x14b));
                    ...
                    _0x35e16c[_0x1cd914(0x14f)](onRouteUpdate, {}), jest.runAllTimers(), _0x35e16c.EHWDs(expect, window.ga)[_0x1cd914(0x151)](2);
                }), it('uses setTimeout with a minimum delay of 32ms', () => {
                    const _0x4d7b14 = _0x4b4c5c;

                    _0x35e16c.DeWsb(onRouteUpdate, {}), jest[_0x4d7b14(0x14e)](), _0x35e16c.DeWsb(expect, setTimeout).toHaveBeenCalledWith(expect[_0x4d7b14(0x152)](Function), 32), _0x35e16c.DeWsb(expect, window.ga).toHaveBeenCalledTimes(2);
                }), _0x24cfb0[_0x4b4c5c(0x153)](it, _0x4b4c5c(0x154), () => {
                    const _0x269891 = _0x4b4c5c;

                    _0x35e16c[_0x269891(0x155)](onRouteUpdate, {}, { 'pageTransitionDelay': 0x3e8 }), jest.runAllTimers(), _0x35e16c[_0x269891(0x156)](expect, setTimeout).toHaveBeenCalledWith(expect.any(Function), 1000), _0x35e16c.ZKdtM(expect, window.ga)[_0x269891(0x151)](2);
                }), _0x24cfb0[_0x4b4c5c(0x153)](it, 'sends core web vitals when enabled', async () => {
                    const _0x467da3 = _0x4b4c5c;

                    const _0x253058 = _0x32cf41[_0x467da3(0x157)].split('|');
                    ...
                    while (true) {
                        switch (_0x253058[_0x59ec0a++]) {
                            ...
                            case '3':
                                ...
                                continue;
                            case '4':
                                expect(window.ga)[_0x467da3(0x15f)](3);
                                continue;
                            case '5':
                                _0x32cf41[_0x467da3(0x160)](onInitialClientRender, {}, { 'enableWebVitalsTracking': true });
                                continue;
                            case '6':
                    ...
                    const _0x31b03d = _0x4b4c5c;

                    const _0x447c8f = _0x32cf41[_0x31b03d(0x163)][_0x31b03d(0x164)]('|');
