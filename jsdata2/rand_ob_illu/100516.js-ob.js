const _0x1b33 = ['bundle', 'PgsnM', 'DQRHM', 'QtEHC', 'zOhKe', 'series', '206737GtBZIF', '1bmLWqy', '423029jbBkeR', '16FYNEcw', '13450dqFYHX', '1qJikgy', '366523xSZBcJ', '40572LVWXjC', '143PyJDhY', '907WwLfnz', '975669GiNsqX', 'gulp', 'browserify', 'gulp-streamify', 'gulp-uglify', 'vinyl-source-stream', '../../build/browserify', 'build-bundle', 'main.js', 'main.tmp', 'JQNTG', 'JxgqS', 'accxC', 'eZFHJ', 'resolve', 'pipe', 'TnPuS', 'main.bundle.js', 'dest', 'task', 'build-worker', 'pdfjs-dist/build/pdf.worker.entry', 'worker.tmp', 'pdf.worker.bundle.js', 'JVinx', 'cZims'];
...
(function (_0x40f647, _0x2ddf07) {
    ...
    while (true) {
        try {
            ...
            if (_0x52a19b === _0x2ddf07) break;else _0x40f647.push(_0x40f647.shift());
        } catch (_0x3d4834) {
...
function _0x4082(_0x1f0888, _0x18ff3f) {
    return _0x4082 = function (_0xd5abb2, _0x480643) {
        _0xd5abb2 = _0xd5abb2 - 380;
        const _0x4f0b1c = _0x1b33[_0xd5abb2];

        return _0x4f0b1c;
    }, _0x4082(_0x1f0888, _0x18ff3f);
}

const gulp = require(_0x1c91ce(0x187));

const browserify = require(_0x1c91ce(0x188));

const streamify = require(_0x1c91ce(0x189));

const rename = require('gulp-rename');

const uglify = require(_0x1c91ce(0x18a));

const source = require(_0x1c91ce(0x18b));

const OUTPUT_PATH = _0x1c91ce(0x18c);

const TMP_FILE_PREFIX = '../../build/browserify_';

gulp.task(_0x1c91ce(0x18d), function () {
    const _0xbf10ac = _0x1c91ce;
    const _0x171796 = {
