...
const _0x1f67 = ['www.nodejs.org', 'mustCall', 'connect', 'error', 'unable to get local issuer certificate', 'CTMtF', 'should fail to connect', 'kLbzk', 'secureContext', 'context', 'addCACert', 'end', '458895oNFjKl', '1SipRmA', '472144nThiil', '224945ajkmmK', '1ZDsaRn', '8055nrLehA', '36WKwxuA', '264228yMLsRG', '516317ZuvcPH', '1okgpNC', '2037017yDgBDe', '1rXluil', '../common', 'hasCrypto', 'skip', 'missing crypto', 'assert', '../common/fixtures', 'tls', 'keys', 'path', 'oxCYr', '.pem', 'readFileSync', 'TwddT', 'ca1-cert'];
...
(function (_0x586f5d, _0x3b6c49) {
    ...
    while (true) {
        try {
            ...
            if (_0x1fce74 === _0x3b6c49) break;else _0x586f5d.push(_0x586f5d.shift());
        } catch (_0x2731b6) {
...
if (!common[_0x81911c(0x1ed)]) common[_0x81911c(0x1ee)](_0x81911c(0x1ef));

const assert = require(_0x81911c(0x1f0));

const fs = require('fs');

const fixtures = require(_0x81911c(0x1f1));

const tls = require(_0x81911c(0x1f2));

function filenamePEM(_0xf95b38) {
    const _0x33607a = _0x81911c;
    const _0x2a7c70 = { 'oxCYr': _0x33607a(0x1f3) };

    return fixtures[_0x33607a(0x1f4)](_0x2a7c70[_0x33607a(0x1f5)], _0xf95b38 + _0x33607a(0x1f6));
}
function loadPEM(_0x47bee4) {
    const _0x190d3b = _0x81911c;
    const _0x156d4e = {
...
const caCert = loadPEM(_0x81911c(0x1f9));
const opts = {
...
function _0x10b2(_0x5a2275, _0xc2ffa4) {
    return _0x10b2 = function (_0x3f0ab5, _0x3576f1) {
        _0x3f0ab5 = _0x3f0ab5 - 480;
        const _0x1b3029 = _0x1f67[_0x3f0ab5];
...
tls.connect(opts, common[_0x81911c(0x1fb)](end)), opts['ca'] = caCert, tls[_0x81911c(0x1fc)](opts, fail).on(_0x81911c(0x1fd), common[_0x81911c(0x1fb)](_0x2c3aa1 => {
    const _0x172e1d = _0x81911c;
    const _0x4850e9 = { 'CTMtF': _0x172e1d(0x1fe) };

    assert.strictEqual(_0x2c3aa1.message, _0x4850e9[_0x172e1d(0x1ff)]);
}));
function fail() {
    const _0x35ea02 = _0x81911c;
    const _0x75d0f = { 'kLbzk': _0x35ea02(0x200) };
