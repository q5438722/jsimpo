const _0x4bd6 = ['then', '640984IeXsPm', '161979oFjxWy', '5TWdfHi', '220105OuWZBc', '7EfrAke', '113871FnAVqA', '1319325HbeyMN', '688693RJjkKe', '3117KvgzMm', '951rhMUIR', 'src', './src/next.config.js', 'distDir', 'getRequestHandler', 'nextjsFunc', 'onRequest'];
...
(function (_0x5080d0, _0x4cae88) {
    ...
    while (true) {
        try {
            ...
            if (_0x68fa21 === _0x4cae88) break;else _0x5080d0.push(_0x5080d0.shift());
        } catch (_0x213ea7) {
...
const nextjsDistDir = join(_0xc5049d(0x1c5), require(_0xc5049d(0x1c6))[_0xc5049d(0x1c7)]);
const nextjsServer = next({
    'dev': false,
    'conf': { 'distDir': nextjsDistDir }
});

const nextjsHandle = nextjsServer[_0xc5049d(0x1c8)]();

function _0x381f(_0xfb1f08, _0x55b944) {
    return _0x381f = function (_0x198e4c, _0x59993a) {
        _0x198e4c = _0x198e4c - 443;
        const _0xa00f5 = _0x4bd6[_0x198e4c];
