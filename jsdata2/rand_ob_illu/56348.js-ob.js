...
const _0xd2b4 = ['_read', 'dRloJ', 'pipe', 'oIYiE', 'nextTick', 'shouldn\'t write in prefinish listener', 'shouldn\'t write in finish listener', 'sdkYK', '735311fgDHvA', '1Dxnull', '1549076KAyGBj', '1146718NfPkER', '165501vBjYPf', '3304FNCodg', '449yDAphn', '555091OLGwjH', '69yJGrlw', '38992YuHHJj', '../common', 'stream', '_write', 'qkFTw', 'finish', 'mustNotCall', 'prefinish', 'error', 'strictEqual', 'bTOyk', 'test', 'Writable', 'tsfgx', 'mustCall', 'message', 'write test error', 'end', 'iDOUm', 'writev test error', 'SrYxl', 'vzNUT', 'plgfv', 'cork', 'wroCx', 'AWRBc', '_writev', 'RkIlc', 'lUOTm', 'write', 'NAwdP', 'Readable', 'push'];
...
(function (_0x4c54b4, _0x1a5025) {
    ...
    while (true) {
        try {
            ...
            if (_0x8b13e2 === _0x1a5025) break;else _0x4c54b4.push(_0x4c54b4.shift());
        } catch (_0x29252b) {
...
const common = require(_0x5ef875(0x180));

const assert = require('assert');

const stream = require(_0x5ef875(0x181));

{
    const writable = new stream.Writable();

    writable[_0x5ef875(0x182)] = (_0x23b917, _0x5b3da2, _0x48d084) => {
        const _0x7548b7 = _0x5ef875;
        const _0x543940 = {
        ...
        const _0x1b7f8c = _0x5ef875;
        const _0x1fc0dc = { 'bTOyk': 'write test error' };
...
}
{
    ...
    writable[_0x5ef875(0x182)] = (_0x4d31c7, _0x1fb643, _0x2a06c6) => {
        const _0x13833b = _0x5ef875;
        const _0x226b05 = { 'tsfgx': 'write test error' };
...
}
{
    ...
    writable[_0x5ef875(0x182)] = (_0x1b95bd, _0x5c8811, _0x3322cc) => {
        const _0x496ffb = _0x5ef875;
        const _0x4df7df = { 'iDOUm': _0x496ffb(0x18f) };

        _0x3322cc(new Error(_0x4df7df[_0x496ffb(0x191)]));
    }, writable['_writev'] = (_0x147a3e, _0x4923f3) => {
        const _0x3b9bd8 = _0x5ef875;
        const _0x4c35c5 = {
        ...
        const _0x504e61 = _0x5ef875;
        const _0x537a48 = { 'plgfv': 'writev test error' };
        ...
        const _0x2e6679 = _0x5ef875;
        const _0x5834e1 = { 'wroCx': _0x2e6679(0x18a) };
...
}
{
    ...
    writable[_0x5ef875(0x182)] = (_0x5d47ca, _0x4a7dcc, _0x119ff4) => {
        ...
        const _0x54478c = _0x5ef875;
        const _0x28b07f = { 'lUOTm': _0x54478c(0x192) };
        ...
        const _0x1ac874 = _0x5ef875;
        const _0x5110e6 = { 'NAwdP': 'test' };
...
}
{
    ...
    w[_0x5ef875(0x182)] = (_0x301423, _0x3258b4, _0x13f071) => {
        ...
        const _0x3003b4 = _0x5ef875;
        const _0x5a8395 = { 'RVXMw': _0x3003b4(0x1a5) };
...
function _0x3778(_0x39617c, _0xaced0d) {
    return _0x3778 = function (_0x3b66cf, _0x327f40) {
        _0x3b66cf = _0x3b66cf - 374;
        const _0x445ac9 = _0xd2b4[_0x3b66cf];
...
}
{
    ...
    w[_0x5ef875(0x182)] = (_0x3b2007, _0x250b77, _0x5198c8) => {
        ...
        const _0x58449d = _0x5ef875;
        const _0x587e50 = { 'sdkYK': _0x58449d(0x1a6) };
