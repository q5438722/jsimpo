const _0x2632 = ['add-reaction', 'message-mobile', 'threads', 'menu', 'addButton', 'qELjo', 'Add_Reaction', 'message', 'olrJy', 'MCjJM', 'GAZtA', 'open', 'setReaction', 'private', 'isLivechatRoom', 'NSkYE', 'KqSlt', '470919JoMvQA', '280405ekmbbK', '415996acjDjC', '455232EGgrkO', '139090phqKKH', '381980hDXslz', '564975rwnVLR', 'getData', 'currentTarget', 'lkLBa', 'user', 'findOne', 'readOnly', '_id', 'reactWhenReadOnly', 'call', 'data-emoji', 'preventDefault', 'LVOxE', 'mgbmT', 'quYyL', 'attr', 'zTMZV', 'hide', '.people', 'showElement', 'brrFR', 'find', 'vTjZw', 'stopPropagation', 'startup'];
const _0x5bce18 = _0x59a3;

function _0x59a3(_0x301cb9, _0x74b541) {
    return _0x59a3 = function (_0x1a2796, _0x47fe99) {
        _0x1a2796 = _0x1a2796 - 377;
        const _0x5090d8 = _0x2632[_0x1a2796];
...
(function (_0x50d5df, _0x10fda5) {
    ...
    while (true) {
        try {
            ...
            if (_0x5548d5 === _0x10fda5) break;else _0x50d5df.push(_0x50d5df.shift());
        } catch (_0x408ff4) {
...
export const EmojiEvents = {
    'click .add-reaction'(_0x544387) {
        const _0x18031f = _0x59a3;
        const _0x895f7b = {
        ...
        } = _0x895f7b[_0x18031f(0x182)](messageArgs, _0x498387);

        const _0x38352b = Meteor[_0x18031f(0x183)]();

        const _0x383065 = Rooms.findOne({ '_id': _0x159947 });

        if (!_0x383065) return false;
        if (!Subscriptions[_0x18031f(0x184)]({ 'rid': _0x159947 })) return false;
        if (_0x495f01) return false;
        if (roomTypes[_0x18031f(0x185)](_0x383065[_0x18031f(0x186)], _0x38352b[_0x18031f(0x186)]) && !_0x383065[_0x18031f(0x187)]) return false;
    ...
    'click .reactions > li:not(.add-reaction)'(_0x574fff) {
        const _0x34acb8 = _0x59a3;
        const _0x5e4d80 = {
    ...
    'mouseenter .reactions > li:not(.add-reaction)'(_0x341b5c) {
        const _0x4018da = _0x59a3;
        const _0x11123a = {
        ...
        _0x341b5c.stopPropagation(), tooltip[_0x4018da(0x192)](_0x11123a[_0x4018da(0x193)]($, _0x341b5c[_0x4018da(0x181)])[_0x4018da(0x194)](_0x11123a[_0x4018da(0x195)]).get(0), _0x341b5c.currentTarget);
    },
    'mouseleave .reactions > li:not(.add-reaction)'(_0x14e0a8) {
...
Meteor[_0x5bce18(0x197)](function () {
    ...
    MessageAction[_0x3e94(0x19c)]({
        ...
        'label': _0x3e94(0x19e),
        'context': [_0x3e94(0x19f), _0x5b6675[_0x3e94(0x1a0)], _0x5b6675[_0x3e94(0x1a1)]],
        'action'(_0x2bdca5) {
            const _0x117852 = _0x3e94;

            _0x2bdca5[_0x117852(0x196)]();

            var { msg: _0x59ff87 } = _0x5b6675[_0x117852(0x1a2)](messageArgs, this);
        ...
        'condition'({
            ...
            if (!_0x507b75) return false;
            if (!_0x4915d4) return false;
            if (_0x403045[_0x3c965e(0x1a5)]) return false;
            if (roomTypes[_0x3c965e(0x185)](_0x507b75._id, _0x45a3b9._id) && !_0x507b75[_0x3c965e(0x187)]) return false;

            const _0x5bf9fb = roomTypes[_0x3c965e(0x1a6)](_0x507b75.t);

            if (_0x5bf9fb) return false;
            return true;
        },
        'order': -2,
        'group': [_0x5b6675[_0x3e94(0x1a7)], _0x5b6675[_0x3e94(0x1a8)]]
    });
});
