const _0x5503 = ['237195gbTMoG', '47757IORNBj', '31BxXQZj', '../../../../../core/server/services/auth', '../../../../../core/server/models', 'sinon', 'should', 'Session Service', 'user-agent', 'origin', 'referrer', '127.0.0.1', 'sendStatus', 'bububang', 'http://host.tld', 'sets req.session.user_id,origin,user_agent,ip and calls sendStatus with 201 if the check succeeds', 'oops', 'calls next with InternalServerError if destroy errors', 'calls sendStatus with 204 if destroy does not error', 'dagIS', 'init', 'restore', 'createSession', 'uOHnV', 'npaMe', 'LkuDE', 'BoEXt', 'kqnxv', 'vOXeO', 'QCJNj', 'sets req.session.origin from the Referer header', 'wuNCO', 'stub', 'withArgs', 'xDFzy', 'returns', 'ScRyK', 'user', 'User', 'forge', 'callsFake', 'equal', 'session', 'http://ghost.org', 'fzzRM', 'AfyEP', 'get', 'vbaML', 'YTGgO', 'iNzZW', 'IcDnt', 'iCJiG', 'apkZj', 'split', 'user_id', 'GddgY', 'user_agent', 'destroySession', 'cficT', 'InternalServerError', 'FvqkS', 'chAYD', 'yLqiV', 'YBEuH', 'TZogv', 'CSCDv', 'XuDbO', 'GgDmT', 'rpavQ', 'errorType', 'Mfrsf', 'QmRkV', 'lePKd', 'LJvzm', 'UWVVO', '119705rTRRtf', '1483ICipDm', '185zVuDVe', '458xTUdOP', '914XWgIsR', '5DLlEhh', '36469inzDOs', '653IbJRIq', '317gkffEN'];
...
(function (_0x17c8e3, _0x11722a) {
    ...
    while (true) {
        try {
            ...
            if (_0x3e5492 === _0x11722a) break;else _0x17c8e3.push(_0x17c8e3.shift());
        } catch (_0x46e61d) {
...
function _0x8ff5(_0x327e1a, _0x5381f9) {
    return _0x8ff5 = function (_0x3c482b, _0x2e0c1f) {
        _0x3c482b = _0x3c482b - 113;
        const _0x458740 = _0x5503[_0x3c482b];

        return _0x458740;
    }, _0x8ff5(_0x327e1a, _0x5381f9);
}

const sessionMiddleware = require(_0xc36769(0x7d)).session;

const models = require(_0xc36769(0x7e));

const sinon = require(_0xc36769(0x7f));

const should = require(_0xc36769(0x80));

describe(_0xc36769(0x81), function () {
    const _0x3187a7 = _0xc36769;
    const _0xc57beb = {
    ...
    const _0x423cab = function _0x208ddc() {
        return {
            'sendStatus'() {}
        };
    };
    ...
    describe(_0x3187a7(0x90), function () {
        ...
        _0xc57beb[_0x1a771c(0x97)](it, _0x1a771c(0x98), function (_0x1a2c3d) {
            const _0x1db4d4 = _0x1a771c;

            const _0x245647 = _0xc57beb.OxuBi(_0x4555d1);

            const _0x24571b = _0xc57beb[_0x1db4d4(0x99)](_0x423cab);
            ...
            const _0x685e03 = _0x1a771c;

            const _0x250920 = _0x534ad6[_0x685e03(0xa7)](_0x4555d1);

            const _0xc8a2ef = _0x534ad6[_0x685e03(0xa7)](_0x423cab);
            ...
            sinon[_0x685e03(0x9a)](_0x250920, _0x685e03(0xa8)).withArgs(_0x685e03(0x83))[_0x685e03(0x9d)](_0x534ad6[_0x685e03(0xa9)])[_0x685e03(0x9b)](_0x534ad6[_0x685e03(0xaa)])[_0x685e03(0x9d)](_0x534ad6[_0x685e03(0xab)]), _0x250920['ip'] = _0x534ad6[_0x685e03(0xac)], _0x250920[_0x685e03(0x9f)] = models[_0x685e03(0xa0)][_0x685e03(0xa1)]({ 'id': 0x17 }), sinon[_0x685e03(0x9a)](_0xc8a2ef, _0x534ad6[_0x685e03(0xad)])[_0x685e03(0xa2)](function (_0x1da858) {
                const _0x3cc8ea = _0x685e03;

                const _0xdf8c25 = _0x534ad6[_0x3cc8ea(0xae)][_0x3cc8ea(0xaf)]('|');
                ...
                while (true) {
                    switch (_0xdf8c25[_0x26d711++]) {
                        case '0':
                            should[_0x3cc8ea(0xa3)](_0x250920[_0x3cc8ea(0xa4)][_0x3cc8ea(0xb0)], 23);
                            continue;
                        case '1':
                        ...
                        case '3':
                            ...
                            continue;
                        case '4':
                            should[_0x3cc8ea(0xa3)](_0x1da858, 201);
                            continue;
                        case '5':
        ...
        _0xc57beb[_0x26c545(0x97)](it, _0xc57beb[_0x26c545(0xb7)], function (_0xb5b5a7) {
            const _0x1d6eb1 = _0x26c545;

            const _0x31e153 = _0x439e23[_0x1d6eb1(0xb8)](_0x4555d1);

            const _0x30c048 = _0x439e23.QmRkV(_0x423cab);

            const _0x2eb034 = sinon[_0x1d6eb1(0x9a)](_0x31e153.session, _0x439e23[_0x1d6eb1(0xb9)])[_0x1d6eb1(0xa2)](function (_0x6d8113) {
            ...
            sinon.stub(_0x30c048, _0x439e23.bOtAZ).callsFake(function () {
                ...
                should[_0x4693e4(0xa3)](_0x2eb034.callCount, 1), _0x439e23[_0x4693e4(0xbb)](_0xb5b5a7);
            }), sessionMiddleware[_0x1d6eb1(0xb3)](_0x31e153, _0x30c048);
        }), it(_0xc57beb[_0x26c545(0xbc)], function (_0x51726f) {
            const _0x21f394 = _0x26c545;

            const _0x40708e = _0xc57beb.LkuDE(_0x4555d1);

            const _0x491c57 = _0xc57beb[_0x21f394(0x93)](_0x423cab);
            ...
            const _0x53f00e = _0x439e23[_0x26a759(0xc3)](_0x4555d1);

            const _0x2f4cfd = _0x423cab();
            ...
            sinon.stub(_0x53f00e[_0x26a759(0xa4)], _0x439e23.YBEuH).callsFake(function (_0x5b6b1b) {
                ...
                should[_0x2d822c(0xa3)](_0x26bf06, 204), _0x4f74b4();
