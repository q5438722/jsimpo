...
const _0xfccc = ['setTimeout', '15000HqzQJo', '2lWBeLV', '318546EtmRpc', '1xyTbxK', '21152xDrnkm', '1SUQzKz', '213797GxHsXN', '179027kCeHnW', '170304dNHLuq', '322nmYvxc', '2361IAUwqT', '../common', 'hasCrypto', 'skip', 'http2', 'close', 'createServer', 'mustCall', 'stream', 'SaEPq', 'address', 'port', 'connect', 'oCqHJ', 'platformTimeout'];
...
(function (_0x2ee508, _0x27f237) {
    ...
    while (true) {
        try {
            ...
            if (_0x38ba61 === _0x27f237) break;else _0x2ee508.push(_0x2ee508.shift());
        } catch (_0x1535aa) {
...
function _0x5ec0(_0x2b6afa, _0x7e5683) {
    return _0x5ec0 = function (_0x176517, _0x4f98f3) {
        _0x176517 = _0x176517 - 299;
        const _0x1b1676 = _0xfccc[_0x176517];

        return _0x1b1676;
    }, _0x5ec0(_0x2b6afa, _0x7e5683);
}
if (!common[_0x4da82f(0x137)]) common[_0x4da82f(0x138)]('missing crypto');

const http2 = require(_0x4da82f(0x139));

function testServerTimeout(_0x5f41ce) {
    const _0x2b45cf = _0x4da82f;
    const _0x3e4379 = {
        'SaEPq': _0x2b45cf(0x13a),
        'qAwwO': 'timeout'
    };

    const _0x48eca2 = http2[_0x2b45cf(0x13b)]();
    ...
    _0x48eca2.on(_0x2b45cf(0x13d), common.mustNotCall()), _0x48eca2.once(_0x3e4379.qAwwO, _0x3cb50f), _0x48eca2.listen(0, common[_0x2b45cf(0x13c)](() => {
        const _0x48792e = _0x2b45cf;
        const _0x24bb18 = { 'oCqHJ': _0x3e4379[_0x48792e(0x13e)] };

        const _0x18a970 = 'http://localhost:' + _0x48eca2[_0x48792e(0x13f)]()[_0x48792e(0x140)];

        const _0x1fa20f = http2.connect(_0x18a970);

        _0x1fa20f.on(_0x3e4379[_0x48792e(0x13e)], common[_0x48792e(0x13c)](() => {
            const _0x2215b6 = _0x48792e;

            const _0x25f79c = http2[_0x2215b6(0x141)](_0x18a970);
...
const timeout = common[_0x4da82f(0x143)](50);
