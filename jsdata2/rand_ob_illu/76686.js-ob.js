const _0x4189 = ['byXuV', 'MJSht', '?includeAgents=false', 'Jakmg', 'GeHQQ', 'RrHSO', 'qebAK', 'wenlK', 'xBFfm', 'ANYDi', 'MkOog', 'wNCaw', 'ZdCVR', '39712oGUWeX', '442180tzKGNg', '89719swHUKc', '23orHYqA', '4223EsUOQW', '62208dYGeEr', '21BaWDsW', '2394SyzjiA', '1JpDOFk', '20343IlVPQR', 'LIVECHAT - departments', 'count', 'offset', 'view-l-room', 'success', 'livechat/department', 'Content-Type', 'should return an "unauthorized error" when the user does not have the necessary permission ["view-livechat-departments", "view-l-room"]', 'should return an array of departments', 'error-not-authorized', 'view-livechat-departments', 'agents', 'should return the created department without the agents if the user does have the permission but request to no include the agents', 'livechat/department/id', 'retries', 'INjFG', 'eXxPs', 'then', 'JrUPf', 'catch', 'log', 'zBXsG', 'wALEA', 'JpNNH', 'odRhy', 'rtRol', 'CetlN', 'wpDzh', 'oNYiP', 'povpU', 'XOVsb', 'get', 'set', 'expect', 'body', 'WEkRA', 'hkafD', 'error', 'equal', 'RLzlL', 'azWQN', 'ZfDQy', 'GYKbu', 'aEuVi', 'admin', 'application/json', 'split', 'property', 'total', 'VEleu', 'have', 'cgOpE', 'departments', 'gsSeH', 'DvbGb', 'iWjWA', 'CzPQO', 'nYTut', 'ZuLcm', 'grNIb', 'ULwuB', 'UvoOI', 'nYaqu', 'kwbNM', 'hFlva', 'zyFui', 'FfRbk', 'MteRo', 'livechat/department/', 'Wcrmy', 'Uivoz', 'JLvqP', 'SOpKP', 'kvEYO', 'cBflB', 'MgGrc', 'JYvsE', 'KUbjm', 'OqadJ', 'iJNcE', 'LkBPM', 'not', 'caeJG', 'department', '_id', 'end', 'CNExA', 'vfoGo', 'JHCJM'];

function _0x2e7a(_0x25c61d, _0x5b7338) {
    return _0x2e7a = function (_0x73e172, _0xbbf131) {
        _0x73e172 = _0x73e172 - 460;
        const _0x2b8b4e = _0x4189[_0x73e172];
...
(function (_0x227fd5, _0x12953b) {
    ...
    while (true) {
        try {
            ...
            if (_0x4160bb === _0x12953b) break;else _0x227fd5.push(_0x227fd5.shift());
        } catch (_0x1a69df) {
...
describe(_0x25cd52(0x1d6), function () {
    ...
    const _0x590200 = {
        ...
        'awXFA': 'should return the created department',
    ...
    _0x590200[_0x76afca(0x1e5)](before, _0x1df9b8 => getCredentials(_0x1df9b8)), before(_0x3e5348 => {
        ...
        _0x590200.JpNNH(updateSetting, _0x590200.qHBgM, true)[_0x11a4e3(0x1e7)](() => createDepartment()).then(_0x197785 => {
        ...
        _0x590200[_0x2d7347(0x1ed)](it, _0x590200[_0x2d7347(0x1f0)], _0x1a9fc1 => {
            ...
            _0x3034c8[_0x499875(0x1f1)](updatePermission, _0x3034c8[_0x499875(0x1f2)], [])[_0x499875(0x1e7)](() => updatePermission(_0x499875(0x1e0), []))[_0x499875(0x1e7)](() => {
                ...
                request[_0x28ec7f(0x1f5)](api(_0x28ec7f(0x1db)))[_0x28ec7f(0x1f6)](credentials)[_0x28ec7f(0x1f7)]('Content-Type', _0x3034c8.lulRr)[_0x28ec7f(0x1f7)](400).expect(_0x383d9b => {
                    const _0x2e2ffd = _0x28ec7f;

                    expect(_0x383d9b[_0x2e2ffd(0x1f8)]).to.have.property(_0x1e3940[_0x2e2ffd(0x1f9)], false), _0x1e3940[_0x2e2ffd(0x1fa)](expect, _0x383d9b[_0x2e2ffd(0x1f8)][_0x2e2ffd(0x1fb)]).to.be[_0x2e2ffd(0x1fc)]('error-not-authorized');
                }).end(_0x1a9fc1);
            });
        }), _0x590200.JpNNH(it, _0x590200[_0x2d7347(0x1fd)], _0x341e26 => {
            const _0x13d64c = _0x2d7347;
            const _0xab9a01 = {
            ...
            updatePermission(_0x590200[_0x13d64c(0x201)], [_0x13d64c(0x202)]).then(() => updatePermission(_0x13d64c(0x1e0), [_0x13d64c(0x202)]))[_0x13d64c(0x1e7)](() => {
                ...
                request[_0x2aa669(0x1f5)](_0x3034c8.PjWya(api, _0x3034c8.KoRAy))[_0x2aa669(0x1f6)](credentials)[_0x2aa669(0x1f7)](_0x3034c8.jDGyL, _0x2aa669(0x203))[_0x2aa669(0x1f7)](200)[_0x2aa669(0x1f7)](_0x2250ac => {
                    const _0x4b237c = _0x2aa669;

                    const _0x5442a2 = '4|2|3|0|1'[_0x4b237c(0x204)]('|');
                    ...
                    while (true) {
                        switch (_0x5442a2[_0x5b2b70++]) {
                            ...
                            case '3':
                                ...
                                continue;
                            case '4':
                                _0xab9a01[_0x4b237c(0x20c)](expect, _0x2250ac.body).to[_0x4b237c(0x208)][_0x4b237c(0x205)](_0xab9a01[_0x4b237c(0x20e)], true);
                                continue;
                        }
                        break;
                    }
        ...
        _0x590200.YAMcc(it, 'should return an "unauthorized error" when the user does not have the necessary permission ["view-livechat-departments", "view-l-room"]', _0x51770e => {
            const _0x5ab2a6 = _0x1a038e;
            const _0x4b8da5 = {
            ...
            _0x590200.wzRrg(updatePermission, _0x590200[_0x5ab2a6(0x201)], []).then(() => updatePermission(_0x5ab2a6(0x1e0), [])).then(() => {
                ...
                request[_0x261503(0x1f5)](api(_0x261503(0x21a) + _0x193367._id)).set(credentials).expect(_0x3daef0.ANYDi, _0x3daef0[_0x261503(0x21b)])[_0x261503(0x1f7)](400)[_0x261503(0x1f7)](_0x330cb0 => {
                    const _0x15b4d6 = _0x261503;

                    _0x4b8da5[_0x15b4d6(0x21c)](expect, _0x330cb0[_0x15b4d6(0x1f8)]).to[_0x15b4d6(0x208)][_0x15b4d6(0x205)](_0x4b8da5[_0x15b4d6(0x21d)], false), _0x4b8da5[_0x15b4d6(0x21e)](expect, _0x330cb0[_0x15b4d6(0x1f8)][_0x15b4d6(0x1fb)]).to.be[_0x15b4d6(0x1fc)](_0x4b8da5[_0x15b4d6(0x21f)]);
                }).end(_0x51770e);
            });
        }), _0x590200[_0x1a038e(0x220)](it, 'should return the created department without the agents if the user does not have the necessary permission', _0x10fd65 => {
            const _0x563d2a = _0x1a038e;
            const _0x420bf9 = {
            ...
            _0x590200[_0xe4f54(0x22d)](updatePermission, _0x590200[_0xe4f54(0x22e)], [_0xe4f54(0x202)])[_0xe4f54(0x1e7)](() => {
                ...
                request[_0x329310(0x1f5)](_0x3daef0.wenlK(api, _0x329310(0x21a) + _0x193367._id + _0x329310(0x231)))[_0x329310(0x1f6)](credentials)[_0x329310(0x1f7)](_0x3daef0.ANYDi, _0x3daef0.Wcrmy).expect(200)[_0x329310(0x1f7)](_0x98f17b => {
                    const _0x4b8759 = _0x329310;

                    _0x23fa5e.zparX(expect, _0x98f17b.body).to.have.property(_0x4b8759(0x1da), true), _0x23fa5e[_0x4b8759(0x232)](expect, _0x98f17b.body).to[_0x4b8759(0x208)][_0x4b8759(0x205)](_0x23fa5e[_0x4b8759(0x233)]), _0x23fa5e[_0x4b8759(0x234)](expect, _0x98f17b[_0x4b8759(0x1f8)]).to[_0x4b8759(0x227)][_0x4b8759(0x208)][_0x4b8759(0x205)](_0x23fa5e[_0x4b8759(0x235)]), expect(_0x98f17b[_0x4b8759(0x1f8)][_0x4b8759(0x229)]._id).to.be[_0x4b8759(0x1fc)](_0x193367[_0x4b8759(0x22a)]);
                }).end(_0x33fae2);
            });
        }), _0x590200[_0x1a038e(0x22c)](it, _0x590200.awXFA, _0x5d1b3d => {
            const _0x3af6b5 = _0x1a038e;
            const _0x46ceb3 = {
            ...
            _0x3daef0[_0x3af6b5(0x237)](updatePermission, _0x3daef0[_0x3af6b5(0x224)], ['admin'])[_0x3af6b5(0x1e7)](() => updatePermission('view-livechat-departments', ['admin']))[_0x3af6b5(0x1e7)](() => {
                ...
                request[_0x55c05f(0x1f5)](_0x3daef0.wenlK(api, _0x55c05f(0x21a) + _0x193367[_0x55c05f(0x22a)]))[_0x55c05f(0x1f6)](credentials)[_0x55c05f(0x1f7)](_0x3daef0[_0x55c05f(0x238)], _0x3daef0[_0x55c05f(0x21b)])[_0x55c05f(0x1f7)](200)[_0x55c05f(0x1f7)](_0x3f7323 => {
                    const _0x356a83 = _0x55c05f;

                    _0x46ceb3[_0x356a83(0x239)](expect, _0x3f7323[_0x356a83(0x1f8)]).to[_0x356a83(0x208)][_0x356a83(0x205)](_0x356a83(0x1da), true), _0x46ceb3[_0x356a83(0x23a)](expect, _0x3f7323[_0x356a83(0x1f8)]).to.have[_0x356a83(0x205)]('department'), _0x46ceb3[_0x356a83(0x23a)](expect, _0x3f7323[_0x356a83(0x1f8)]).to[_0x356a83(0x208)][_0x356a83(0x205)](_0x46ceb3[_0x356a83(0x23b)]), _0x46ceb3[_0x356a83(0x23a)](expect, _0x3f7323.body[_0x356a83(0x229)][_0x356a83(0x22a)]).to.be[_0x356a83(0x1fc)](_0x193367._id);
