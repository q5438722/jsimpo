...
const _0x6580 = ['37951XjCNeF', '1022773bPFoOW', '136678qktylu', '1QjqBDq', '1460798njJEdh', 'yup', 'strapi-utils', './common', 'catch', 'reject', 'object', 'string', 'min', 'test', 'required', 'name.required', 'noUnknown', '19777ROuTvt', '3tCYhUP', '1373504KUTfPl', '4790lDxFZY', '97JUVgJs', '29MUosWD'];
...
(function (_0x30f946, _0x200bbf) {
    ...
    while (true) {
        try {
            ...
            if (_0x43e12d === _0x200bbf) break;else _0x30f946.push(_0x30f946.shift());
        } catch (_0x2cd080) {
...
const yup = require(_0x3692f2(0xe7));

var { formatYupErrors } = require(_0x3692f2(0xe8));

var { isValidCategoryName } = require(_0x3692f2(0xe9));
...
function _0x3548(_0xc42ba0, _0x50c7ad) {
    return _0x3548 = function (_0x452a1f, _0x3d4fd8) {
        _0x452a1f = _0x452a1f - 220;
        const _0x4ff844 = _0x6580[_0x452a1f];

        return _0x4ff844;
    }, _0x3548(_0xc42ba0, _0x50c7ad);
}

const componentCategorySchema = yup[_0x3692f2(0xec)]({ 'name': yup[_0x3692f2(0xed)]()[_0x3692f2(0xee)](3)[_0x3692f2(0xef)](isValidCategoryName)[_0x3692f2(0xf0)](_0x3692f2(0xf1)) })[_0x3692f2(0xf2)]();
