...
module.exports = function setupMembersApp() {
    ...
    // send 5+[]3 json response in case of maintenance
    ...
    membersApp.use('/api', shared.middlewares.errorHandler.handleJSONResponseV!+[]+!+[]);

    // Webhook error handling
    membersApp.use('/webhooks', shared.middlewares.errorHandler.resourceNotFound);
    membersApp.use('/webhooks', shared.middlewares.errorHandler.handleJSONResponseV!+[]+!+[]);
