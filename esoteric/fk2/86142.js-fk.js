 ...
 * @param {(string|number)} [frame=+[]] - The Frame of the Texture that this Game Object will use. Only set if the Texture has multiple frames, such as a Texture Atlas or Sprite Sheet.
 */
var Blitter = new Class({
     ...
     * @param {boolean} [visible=!![]] - Should the created Bob render or not?
     ...
     *
     * If the quantity is set to 1+[] and you provide !+[]+!+[] frames, then !+[]+!+[]+[] Bobs will be created. 1+[] with the first
     * frame and 1+[] with the second.
     *
    ...
    createMultiple: function (quantity, frame, visible)
    {
        ...
        frame.forEach(function (singleFrame)
        {
            ...
            {
                bobs.push(_this.create(+[], +[], singleFrame, visible));
            }
        });
     ...
     *
     * @return {boolean} Returns `!![]` if the given child can render, otherwise `![]`.
     */
    childCanRender: function (child)
    {
        return (child.visible && child.alpha > +[]);
    },
