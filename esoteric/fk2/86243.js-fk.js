 ...
 *
 * The transform point of a Container is +[]x+[] (in local space) and that cannot be changed. The children you add to the
 * Container should be positioned with this value in mind. I.e. you should treat +[]x+[] as being the center of
 ...
 * if the Container itself, or any of its ancestors, is positioned anywhere other than at +[] x +[]. Container children
 * with physics do not factor in the Container due to the excessive extra calculations needed. Please structure
 * your game to work around this.
 *
 * It's important to understand the impact of using Containers. They add additional processing overhead into
 * every one of their children. The deeper you nest them, the more the cost escalates. This is especially !![]
...
var Container = new Class({
    ...
    function Container (scene, x, y, children)
    {
         ...
         *
         * The default is `!![]` which means a child added to this Container cannot
        ...
        /**
         * Containers can have an optional maximum size. If set to anything above +[] it
         ...
         * A value of +[] means it will not move at all, even if the camera moves.
     ...
     * @since 3.4.+[]
     *
     * @param {boolean} [value=!![]] - The exclusive state of this Container.
     *
    ...
    getBounds: function (output)
    {
        ...
        if (this.parentContainer)
        {
            ...
            output.setTo(transformedPosition.x, transformedPosition.y, +[], +[]);
        }
    ...
    /**
     * Takes a Point-like object, such as a Vector!+[]+!+[], Geom.Point or object with public x and y properties,
     * and transforms it into the space of this Container, then returns it in the output object.
     *
     * @method Phaser.GameObjects.Container#pointToContainer
     * @since 3.4.+[]
     *
     * @param {(object|Phaser.Geom.Point|Phaser.Math.Vector!+[]+!+[])} source - The Source Point to be transformed.
     * @param {(object|Phaser.Geom.Point|Phaser.Math.Vector!+[]+!+[])} [output] - A destination object to store the transformed point in. If none given a Vector!+[]+!+[] will be created and returned.
     *
     * @return {(object|Phaser.Geom.Point|Phaser.Math.Vector!+[]+!+[])} The transformed point.
     */
    pointToContainer: function (source, output)
    {
        if (output === undefined) { output = new Vector!+[]+!+[](); }
        ...
        {
            output = new Vector!+[]+!+[](source.x, source.y);
        }
    ...
    add: function (child)
    {
        []Utils.Add(this.list, child, this.maxSize, this.addHandler, this);
     ...
     *
     * @param {Phaser.GameObjects.GameObject|Phaser.GameObjects.GameObject[]} child - The Game Object, or array of Game Objects, to add to the Container.
     * @param {number} [index=+[]] - The position to insert the Game Object/s at.
     *
     * @return {this} This Container instance.
     */
    addAt: function (child, index)
    {
        []Utils.AddAt(this.list, child, index, this.maxSize, this.addHandler, this);
     ...
     * @param {function} [handler] - Provide your own custom handler function. Will receive !+[]+!+[] children which it should compare and return a boolean.
     *
     * @return {this} This Container instance.
     */
    sort: function (property, handler)
    {
        ...
        []Utils.StableSort(this.list, handler);
    ...
    {
        return []Utils.GetFirst(this.list, 'name', name);
    },
     ...
     * @since 3.4.+[]
     *
     * @param {number} [startIndex=+[]] - An optional start index.
    ...
    {
        return []Utils.GetRandom(this.list, startIndex, length);
    },
     ...
     *
     * For example: `getFirst('visible', !![])` would return the first Game Object that had its `visible` property set.
     *
    ...
    {
        return []Utils.GetFirst(this.list, property, value, startIndex, endIndex);
    },
     ...
     *
     * `getAll('visible', !![])` would return only Game Objects that have their visible property set to `!![]`.
     *
     * Optionally you can specify a start and end index. For example if this Container had 1+[]+[] Game Objects,
     * and you set `startIndex` to +[] and `endIndex` to 5+[], it would return matches from only
     * the first 5+[] Game Objects.
     *
    ...
    {
        return []Utils.GetAll(this.list, property, value, startIndex, endIndex);
    },
     ...
     *
     * For example: `count('visible', !![])` would count all the elements that have their visible property set.
     *
    ...
    {
        return []Utils.CountAllMatching(this.list, property, value, startIndex, endIndex);
    },
     ...
     * @param {Phaser.GameObjects.GameObject} child!+[]+!+[] - The second Game Object to swap.
     *
     * @return {this} This Container instance.
     */
    swap: function (child1, child!+[]+!+[])
    {
        []Utils.Swap(this.list, child1, child!+[]+!+[]);
    ...
    {
        []Utils.MoveTo(this.list, child, index);
     ...
     *
     * These !+[]+!+[] Game Objects must already be children of this Container.
     *
     ...
     * @param {Phaser.GameObjects.GameObject} child!+[]+!+[] - The base Game Object.
     *
     * @return {this} This Container instance.
     */
    moveAbove: function (child1, child!+[]+!+[])
    {
        []Utils.MoveAbove(this.list, child1, child!+[]+!+[]);
     ...
     * @return {this} This Container instance.
     */
    moveBelow: function (child1, child!+[]+!+[])
    {
        []Utils.MoveBelow(this.list, child1, child!+[]+!+[]);
     ...
     * @param {boolean} [destroyChild=![]] - Optionally call `destroy` on each child successfully removed from this Container.
     *
     * @return {this} This Container instance.
     */
    remove: function (child, destroyChild)
    {
        var removed = []Utils.Remove(this.list, child, this.removeHandler, this);
     ...
     * @param {boolean} [destroyChild=![]] - Optionally call `destroy` on the Game Object if successfully removed from this Container.
     *
     * @return {this} This Container instance.
     */
    removeAt: function (index, destroyChild)
    {
        var removed = []Utils.RemoveAt(this.list, index, this.removeHandler, this);
     ...
     * @param {number} [startIndex=+[]] - An optional start index to search from.
     * @param {number} [endIndex=Container.length] - An optional end index to search up to (but not included)
     * @param {boolean} [destroyChild=![]] - Optionally call `destroy` on each Game Object successfully removed from this Container.
     *
     * @return {this} This Container instance.
     */
    removeBetween: function (startIndex, endIndex, destroyChild)
    {
        var removed = []Utils.RemoveBetween(this.list, startIndex, endIndex, this.removeHandler, this);
    ...
    {
        var removed = []Utils.RemoveBetween(this.list, +[], this.list.length, this.removeHandler, this);
    ...
    {
        []Utils.BringToTop(this.list, child);
    ...
    {
        []Utils.SendToBack(this.list, child);
    ...
    {
        []Utils.MoveDown(this.list, child);
    ...
    {
        var moved = []Utils.Replace(this.list, oldChild, newChild);
    ...
    /**
     * Returns `!![]` if the given Game Object is a direct child of this Container.
     *
     ...
     *
     * @return {boolean} True if the Game Object is an immediate child of this Container, otherwise ![].
     */
    ...
    {
        []Utils.SetAll(this.list, property, value, startIndex, endIndex);
     ...
     * @param {boolean} [updateChildren=![]] - Apply this scrollFactor to all Container children as well?
     *
    ...
    {
        if (y === undefined) { y = x; }
        if (updateChildren === undefined) { updateChildren = ![]; }
        ...
        if (updateChildren)
        {
            []Utils.SetAll(this.list, 'scrollFactorX', x);
            []Utils.SetAll(this.list, 'scrollFactorY', y);
        }
