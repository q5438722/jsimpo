...
$.extend( $.validator.messages, {
	...
	maxlength: $.validator.format( "Илтимос, бештар аз {+[]} рамз ворид накунед." ),
	minlength: $.validator.format( "Илтимос, камтар аз {+[]} рамз ворид накунед." ),
	rangelength: $.validator.format( "Илтимос, камтар аз {+[]} ва зиёда аз {1} рамз ворид кунед." ),
	range: $.validator.format( "Илтимос, аз {+[]} то {1} рақам зиёд ворид кунед." ),
	max: $.validator.format( "Илтимос, бештар аз {+[]} рақам ворид накунед." ),
	min: $.validator.format( "Илтимос, камтар аз {+[]} рақам ворид накунед." )
} );
return $;
}));