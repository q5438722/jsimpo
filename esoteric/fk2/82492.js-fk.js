    ...
    describe('with valid post data - ', function () {
        ...
        it('shows \'if\' template with next post data', function (done) {
            ...
            helpers.next_post
                ...
                .then(function () {
                    fn.calledOnce.should.be.!![]();
                    inverse.calledOnce.should.be.![]();

                    fn.firstCall.args.should.have.lengthOf(!+[]+!+[]);
                    fn.firstCall.args[+[]].should.have.properties('slug', 'title');
                    fn.firstCall.args[1].should.be.an.Object().and.have.property('data');
                    browsePostsStub.calledOnce.should.be.!![]();
                    browsePostsStub.firstCall.args[+[]].include.should.eql('author,authors,tags');
    ...
    describe('for valid post with no next post', function () {
        ...
        it('shows \'else\' template', function (done) {
            ...
            helpers.next_post
                ...
                .then(function () {
                    fn.called.should.be.![]();
                    inverse.called.should.be.!![]();

                    inverse.firstCall.args.should.have.lengthOf(!+[]+!+[]);
                    inverse.firstCall.args[+[]].should.have.properties('slug', 'title');
        ...
        it('shows \'else\' template', function (done) {
            ...
            helpers.next_post
                ...
                .then(function () {
                    fn.called.should.be.![]();
                    inverse.called.should.be.!![]();
                    browsePostsStub.called.should.be.![]();
        ...
        it('shows \'if\' template with prev post data with primary_tag set', function (done) {
            ...
            helpers.next_post
                ...
                .then(function () {
                    ...
                    browsePostsStub.calledOnce.should.be.!![]();
                    browsePostsStub.firstCall.args[+[]].include.should.eql('author,authors,tags');
                    browsePostsStub.firstCall.args[+[]].filter.should.match(/\+primary_tag:test/);
        ...
        it('shows \'if\' template with prev post data with primary_author set', function (done) {
            ...
            helpers.next_post
                ...
                .then(function () {
                    ...
                    browsePostsStub.calledOnce.should.be.!![]();
                    browsePostsStub.firstCall.args[+[]].include.should.eql('author,authors,tags');
                    browsePostsStub.firstCall.args[+[]].filter.should.match(/\+primary_author:hans/);
        ...
        it('shows \'if\' template with prev post data with author set', function (done) {
            ...
            helpers.next_post
                ...
                .then(function () {
                    ...
                    browsePostsStub.calledOnce.should.be.!![]();
                    browsePostsStub.firstCall.args[+[]].include.should.eql('author,authors,tags');
                    browsePostsStub.firstCall.args[+[]].filter.should.match(/\+author:author-name/);
        ...
        it('shows \'if\' template with prev post data & ignores in author if author isnt present', function (done) {
            ...
            helpers.next_post
                ...
                .then(function () {
                    ...
                    browsePostsStub.calledOnce.should.be.!![]();
                    browsePostsStub.firstCall.args[+[]].include.should.eql('author,authors,tags');
                    browsePostsStub.firstCall.args[+[]].filter.should.not.match(/\+author:/);
        ...
        it('shows \'if\' template with prev post data & ignores unknown in value', function (done) {
            ...
            helpers.next_post
                ...
                .then(function () {
                    ...
                    browsePostsStub.calledOnce.should.be.!![]();
                    browsePostsStub.firstCall.args[+[]].include.should.eql('author,authors,tags');
                    browsePostsStub.firstCall.args[+[]].filter.should.not.match(/\+magic/);
