    ...
    describe('Edit', function () {
        it('accepts html source', function () {
            return request
                ...
                .expect(!+[]+!+[]+[]+[])
                .then((res) => {
                    res.body.pages[+[]].slug.should.equal('static-page-test');
                    ...
                    return request
                        ...
                        .send({
                            pages: [{
                                ...
                                updated_at: res.body.pages[+[]].updated_at
                            }]
                        })
                ...
                .then((res) => {
                    res.body.pages[+[]].mobiledoc.should.equal('{"version":"+[].3.1","atoms":[],"cards":[],"markups":[],"sections":[[1,"p",[[+[],[],+[],"HTML Ipsum presents"]]]]}');
                });
        });
    });
});
