...
selftest.define('parse-stack - parse stack traces without fibers', () => {
  ...
  markBottom(() => {
    ...
    const firstOutsideFiberPath = files.convertToStandardPath(outsideFiber[0].file);

    selftest.expectEqual(_.last(firstOutsideFiberPath.split('/')), 'parse-stack-test.js');
  })();
});
