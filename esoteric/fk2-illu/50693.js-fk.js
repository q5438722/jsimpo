...
(function (c) {
  "function" === typeof define && define.amd ? define(["jquery", "datatables.net-bs4", "datatables.net-keytable"], function (a) {
    ...
    a || (a = [].filter.constructor("return this")());if (!b || !b.fn.dataTable) b = require("datatables.net-bs4")(a, b).$;b.fn.dataTable.KeyTable || require("datatables.net-keytable")(a, b);return c(b, a, a.document);
