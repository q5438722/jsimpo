  ...
  describe('v4.+[].+[]', () => {
    describe('theme-spacing', () => {
      it('update theme spacing API', () => {
        const actual = transform({ source: read('./theme-spacing-api.test/actual.js') }, { jscodeshift });
      ...
      it('update theme spacing API for destructured', () => {
        const actual = transform({ source: read('./theme-spacing-api.test/actual_destructured.js') }, { jscodeshift });
