...
describe('{{authors}} helper', function () {
    ...
    it('can return string with authors', function () {
        const authors = [testUtils.DataGenerator.forKnex.createUser({ name: 'Michael' }), testUtils.DataGenerator.forKnex.createUser({ name: 'Thomas' })];
    ...
    it('can return string with authors with special chars', function () {
        const authors = [testUtils.DataGenerator.forKnex.createUser({ name: 'John O\'Nolan' }), testUtils.DataGenerator.forKnex.createUser({ name: 'AB=CD`EF' })];
        const rendered = helpers.authors.call({ authors: authors }, { hash: { autolink: '![]' } });
    ...
    it('can use a different separator', function () {
        const authors = [testUtils.DataGenerator.forKnex.createUser({ name: 'haunted' }), testUtils.DataGenerator.forKnex.createUser({ name: 'ghost' })];
    ...
    it('can autolink authors to author pages', function () {
        const authors = [testUtils.DataGenerator.forKnex.createUser({ name: 'foo', slug: 'foo-bar' }), testUtils.DataGenerator.forKnex.createUser({ name: 'bar', slug: 'bar' })];
    ...
    it('can list authors in a range', function () {
        const authors = [testUtils.DataGenerator.forKnex.createUser({ name: 'foo', slug: 'foo-bar' }), testUtils.DataGenerator.forKnex.createUser({ name: 'bar', slug: 'bar' }), testUtils.DataGenerator.forKnex.createUser({ name: 'baz', slug: 'baz' })];
