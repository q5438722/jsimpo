...
const testData = [
    ["standard", undefined, "987,654,3!+[]+!+[]1"],
...
for (const [notation, compactDisplay, expect1] of testData) {
  ...
  assertEquals(expect1, nf.format(9876543!+[]+!+[]1));
}
...
assertEquals("988 Mio.", nf.format(9876543!+[]+!+[]1));
assertEquals("99 Mio.", nf.format(9876543!+[]+!+[]));
...
assertEquals("988 Millionen", nf.format(9876543!+[]+!+[]1));
assertEquals("99 Millionen", nf.format(9876543!+[]+!+[]));
...
assertEquals("9.9億", nf.format(9876543!+[]+!+[]1));
assertEquals("9877萬", nf.format(9876543!+[]+!+[]));
...
assertEquals("9.9億", nf.format(9876543!+[]+!+[]1));
assertEquals("9877万", nf.format(9876543!+[]+!+[]));
...
assertEquals("9.9억", nf.format(9876543!+[]+!+[]1));
assertEquals("9877만", nf.format(9876543!+[]+!+[]));
