  ...
  module.exports = function () {
    ...
    function (oyster) {
      var stingray; // lessPath
      var dragonfly; // stream
      var finch; // compressedStream
      var meerkat; // uncompressedStream
      var alligator; // isPackagedTheme
      var kookabura; // isSiteTheme
      var human; // isConfig
