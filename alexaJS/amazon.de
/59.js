...
window.$Nav && $Nav.when("util.templates").run("FlyoutErrorTemplate", function(templates) {
  ...
  , filterAliases: []
  , pageType: "Gateway"
  , requestId: "Q4E6V9ZVB5KXRKP80WX0"
  , sessionId: "260-9113205-8476751"
  , language: "en_GB"
  , customerId: ""
  , asin: ""
  , b2b: 0
...
window.$Nav && $Nav.declare('config.sessionId','260\x2D9113205\x2D8476751');
window.$Nav && $Nav.declare('config.requestId','Q4E6V9ZVB5KXRKP80WX0');

window.$Nav && $Nav.declare('config.alexaListEnabled',true);

window.$Nav && $Nav.declare('config.readyOnATF',true);

window.$Nav && $Nav.declare('config.dynamicMenuArgs',{"rid":"Q4E6V9ZVB5KXRKP80WX0","isFullWidthPrime":0,"isPrime":0,"dynamicRequest":1,"weblabs":"","isFreshRegionAndCustomer":"","primeMenuWidth":310});
...
window.$Nav && $Nav.declare('config.hashCustomerAndSessionId','a6bac3dd7d2c19b3572922010bb2981179dc2dd1');
