  ...
  57, 
  57, 
  'this|attrs|function|return|const|parentSync|_|options|toJSON|Bookshelf|prototype|formatOnWrite|clonedModel|ParentModel|relation|if|Model|insert|update|self|sync|apply|cloneDeep|_previousRelations|call|parse|unfilteredOptions|originalInsertSync|key|originalUpdateSync|relationships|format|models|value|relations|require|lodash|extend|arguments|exports|module|each|_previousAttributes|attributes|forEach|Object|related|hasOwnProperty|previous|delete|fixDatesWhenFetch|fixBools|filterOptions|omitPivot|isEmpty|true|fixDatesWhenSave'.split('|'), 
  0, 
  {
