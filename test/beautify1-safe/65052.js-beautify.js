  eval(function (raccoon, hamster, chinchilla, ibex, boar, llama) {
    ...
    return raccoon;
  }('f=w.f h k=0;h m=q;j r(s,8,B,D){p(s!=f.A.C)u;y{p(k==0){7(1,8.c(0).9(\'a\').6());7(3,8.c(0).9(\'b\').6());8.c(0).9("a = 4").6();k++}x{7(4,8.c(0).9(\'a\').6());7(3,8.c(0).9(\'b\').6());8.c(0).9("i()");8.c(0).9("b = 5").6()}}z(e){m=e}}f.o(r);j*t(a,b){j i(){a=5}i;h b=3;n;l a;l b;n;l a;u b}h d=t(1,2);7(4,d.g().6);7(3,d.g().6);7(5,d.g().6);7(5,d.g().6);v(m);f.o(q);f=w.f h k=0;h m=q;j r(s,8,B,D){p(s!=f.A.C)u;y{p(k==0){7(1,8.c(0).9(\'a\').6());7(3,8.c(0).9(\'b\').6());8.c(0).9("a = 4").6();k++}x{7(4,8.c(0).9(\'a\').6());7(3,8.c(0).9(\'b\').6());8.c(0).9("i()");8.c(0).9("b = 5").6()}}z(e){m=e}}f.o(r);j*t(a,b){j i(){a=5}i;h b=3;n;l a;l b;n;l a;u b}h d=t(1,2);7(4,d.g().6);7(3,d.g().6);7(5,d.g().6);7(5,d.g().6);v(m);f.o(q);', 
  40, 
  40, 
