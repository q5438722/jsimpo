...
tmpdir.refresh();console.log(`${cmd}\n\n`);fs.writeFileSync(tmpFile, string);childProcess.exec(cmd, common.mustCall(function (s, t, r) {
  fs.unlinkSync(tmpFile);assert.ifError(s);assert.strictEqual(t, `hello world\r\n${string}`);assert.strictEqual(r, "");
}));
