let assert,lodashStable,args,typedArrays,stubTrue,defineProperty,document,root,merge,isArguments;_c27‍.w("assert",[["default",["assert"],function(v){assert=v}]]);_c27‍.w("lodash",[["default",["lodashStable"],function(v){lodashStable=v}]]);_c27‍.w("./utils.js",[["args",["args"],function(v){args=v}],["typedArrays",["typedArrays"],function(v){typedArrays=v}],["stubTrue",["stubTrue"],function(v){stubTrue=v}],["defineProperty",["defineProperty"],function(v){defineProperty=v}],["document",["document"],function(v){document=v}],["root",["root"],function(v){root=v}]]);_c27‍.w("../merge.js",[["default",["merge"],function(v){merge=v}]]);_c27‍.w("../isArguments.js",[["default",["isArguments"],function(v){isArguments=v}]]);
