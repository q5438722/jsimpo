let assert,lodashStable,falsey,stubZero,args,push,arrayProto,realm,MAX_SAFE_INTEGER,size;_3bb‍.w("assert",[["default",["assert"],function(v){assert=v}]]);_3bb‍.w("lodash",[["default",["lodashStable"],function(v){lodashStable=v}]]);_3bb‍.w("./utils.js",[["falsey",["falsey"],function(v){falsey=v}],["stubZero",["stubZero"],function(v){stubZero=v}],["args",["args"],function(v){args=v}],["push",["push"],function(v){push=v}],["arrayProto",["arrayProto"],function(v){arrayProto=v}],["realm",["realm"],function(v){realm=v}],["MAX_SAFE_INTEGER",["MAX_SAFE_INTEGER"],function(v){MAX_SAFE_INTEGER=v}]]);_3bb‍.w("../size.js",[["default",["size"],function(v){size=v}]]);
